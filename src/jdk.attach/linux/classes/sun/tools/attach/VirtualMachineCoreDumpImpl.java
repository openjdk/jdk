...
public class VirtualMachineCoreDumpImpl extends VirtualMachineCoreDump {
    ...
    protected String helperName(String jdkLibDir) {
        return jdkLibDir + File.separator + "revivalhelper";
    }

    protected void setEnv(Map<String, String> env, String jdkLibDir) {
        env.put("LD_USE_LOAD_BIAS", "1"); // Required by OS to respect shared object load addresses
        env.put("LD_PRELOAD", jdkLibDir + File.separator + "librevival_support.so");
    }
}
