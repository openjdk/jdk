...
void LIR_Assembler::emit_compare_and_swap(LIR_OpCompareAndSwap* op) {
  Register addr = op->addr()->is_single_cpu() ?
                  op->addr()->as_register() :
                  op->addr()->as_register_lo();

  Register newval = op->new_value()->is_single_cpu() ?
                    op->new_value()->as_register() :
                    op->new_value()->as_register_lo();

  Register cmpval = op->cmp_value()->is_single_cpu() ?
                    op->cmp_value()->as_register() :
