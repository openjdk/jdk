...
protected:
  ...
  void set_char_at(int offset, char c) { MACOS_AARCH64_ONLY(thread_wx_enable_write()); *addr_at(offset) = (u_char)c; }
  void set_int_at(int offset, jint i) { MACOS_AARCH64_ONLY(thread_wx_enable_write()); *(jint*)addr_at(offset) = i; }
  void set_uint_at(int offset, jint i) { MACOS_AARCH64_ONLY(thread_wx_enable_write()); *(juint*)addr_at(offset) = i; }
  void set_ptr_at(int offset, address ptr) { MACOS_AARCH64_ONLY(thread_wx_enable_write()); *(address*)addr_at(offset) = ptr; }
  void set_oop_at(int offset, oop o) { MACOS_AARCH64_ONLY(thread_wx_enable_write()); *(oop*)addr_at(offset) = o; }
