...
bool AOTPDConfig::verify(stringStream& failure_msg) const {
  ...
  VERIFY_VM_FLAG_NOT_SET(AvoidUnalignedAccesses)
  VERIFY_VM_FLAG_SAME(UseSIMDForMemoryOps)
  VERIFY_VM_FLAG_SAME(UseSIMDForArrayEquals)
  VERIFY_VM_FLAG_SAME(UseBlockZeroing)
  VERIFY_VM_FLAG_SAME(UseSVE)
  VERIFY_VM_FLAG_SAME(UseLSE)
