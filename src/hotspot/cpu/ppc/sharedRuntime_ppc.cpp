...
# endif
  ...
  __ li(r_temp_2, 0);
  __ stw(r_temp_2, in_bytes(JNIHandleBlock::top_offset_in_bytes()), r_temp_1);
...
static void push_skeleton_frames(MacroAssembler* masm, bool deopt,
 ...
 // _number_of_frames is of type int (deoptimization.hpp)
  __ lwa(number_of_frames_reg,
             in_bytes(Deoptimization::UnrollBlock::number_of_frames_offset_in_bytes()),
             unroll_block_reg);
  __ ld(pcs_reg,
            in_bytes(Deoptimization::UnrollBlock::frame_pcs_offset_in_bytes()),
            unroll_block_reg);
  __ ld(frame_sizes_reg,
            in_bytes(Deoptimization::UnrollBlock::frame_sizes_offset_in_bytes()),
            unroll_block_reg);
  ...
  __ lwa(R11_scratch1,
             in_bytes(Deoptimization::UnrollBlock::caller_adjustment_offset_in_bytes()),
             unroll_block_reg);
...
void SharedRuntime::generate_deopt_blob() {
  ...
  __ lwz(exec_mode_reg, in_bytes(Deoptimization::UnrollBlock::unpack_kind_offset_in_bytes()), unroll_block_reg);
...
#ifdef ASSERT
  __ lwz(R22_tmp2, in_bytes(Deoptimization::UnrollBlock::unpack_kind_offset_in_bytes()), unroll_block_reg);
