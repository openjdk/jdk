...
void TemplateInterpreterGenerator::generate_fixed_frame(bool native_call, Register Rsize_of_parameters, Register Rsize_of_locals) {
  ...
  __ addi(Rtop_frame_size, Rtop_frame_size, frame::native_abi_reg_args_size + frame::ijava_state_size);

  // Cut back area between esp and max_stack.
  __ addi(Rparent_frame_resize, Rparent_frame_resize, frame::native_abi_minframe_size - Interpreter::stackElementSize);
