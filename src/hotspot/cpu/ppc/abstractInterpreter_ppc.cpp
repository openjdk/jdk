...
int AbstractInterpreter::size_top_interpreter_activation(Method* method) {
  ...
  const int abi_scratch = frame::native_abi_reg_args_size;
...
int AbstractInterpreter::size_activation(int max_stack,
  ...
  const int abi_scratch = is_top_frame ? (frame::native_abi_reg_args_size / Interpreter::stackElementSize) :
                                         (frame::native_abi_minframe_size / Interpreter::stackElementSize);
  const int size =
    max_stack                                                +
...
void AbstractInterpreter::layout_activation(Method* method,
  ...
  intptr_t* locals_base  = (caller->is_interpreted_frame()) ?
    ...
    caller->sp() + method->max_locals() - 1 + (frame::native_abi_minframe_size / Interpreter::stackElementSize);
  ...
  intptr_t* sender_sp    = caller->sp() + (frame::native_abi_minframe_size - frame::native_abi_reg_args_size) / Interpreter::stackElementSize;
  intptr_t* top_frame_sp = is_top_frame ? sp : sp + (frame::native_abi_minframe_size - frame::native_abi_reg_args_size) / Interpreter::stackElementSize;
