...
void TemplateTable::generate_vtable_call(Register Rrecv_klass, Register Rindex, Register Rret, Register Rtemp) {
  ...
  // Load target.
  __ addi(Rrecv_klass, Rrecv_klass, in_bytes(base + vtableEntry::method_offset_in_bytes()));
...
void TemplateTable::monitorenter() {
                    ...
                    reached_limit   = CCR6;
  {
    ...
    __ addi(Rcurrent_obj_addr, R26_monitor, in_bytes(BasicObjectLock::obj_offset_in_bytes()));

    __ ld(Rlimit, 0, R1_SP);
    __ addi(Rlimit, Rlimit, - (frame::ijava_state_size + frame::interpreter_frame_monitor_size_in_bytes() - in_bytes(BasicObjectLock::obj_offset_in_bytes()))); // Monitor base
  ...
  __ addi(Rcurrent_monitor, Rcurrent_obj_addr, -(frame::interpreter_frame_monitor_size() * wordSize) - in_bytes(BasicObjectLock::obj_offset_in_bytes()));
  __ addi(Rcurrent_obj_addr, Rcurrent_obj_addr, - frame::interpreter_frame_monitor_size() * wordSize);
  __ b(Lfound);
...
void TemplateTable::monitorexit() {
  ...
  // Find the corresponding slot in the monitors stack section.
  {
    ...
    __ addi(Rcurrent_obj_addr, R26_monitor, in_bytes(BasicObjectLock::obj_offset_in_bytes()));
    __ addi(Rlimit, Rlimit, in_bytes(BasicObjectLock::obj_offset_in_bytes()));
    __ ld(Rcurrent_obj, 0, Rcurrent_obj_addr);
    __ addi(Rcurrent_obj_addr, Rcurrent_obj_addr, frame::interpreter_frame_monitor_size() * wordSize);
  ...
  __ addi(Rcurrent_monitor, Rcurrent_obj_addr,
          -(frame::interpreter_frame_monitor_size() * wordSize) - in_bytes(BasicObjectLock::obj_offset_in_bytes()));
