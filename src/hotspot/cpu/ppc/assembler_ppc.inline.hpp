...
inline void Assembler::lwz(  Register d, Address &a) { lwz(d, a.disp(), a.base()); }
...
inline void Assembler::lwa(  Register d, Address &a) { lwa(d, a.disp(), a.base()); }
...
inline void Assembler::lhz(  Register d, Address &a) { lhz(d, a.disp(), a.base()); }
...
inline void Assembler::lha(  Register d, Address &a) { lha(d, a.disp(), a.base()); }
...
inline void Assembler::lbz(  Register d, Address &a) { lbz(d, a.disp(), a.base()); }
...
inline void Assembler::ld(   Register d, Address &a) { ld(d, a.disp(), a.base()); }
...
inline void Assembler::stw(  Register d, Address &a) { stw(d, a.disp(), a.base()); }
...
inline void Assembler::sth(  Register d, Address &a) { sth(d, a.disp(), a.base()); }
...
inline void Assembler::stb(  Register d, Address &a) { stb(d, a.disp(), a.base()); }
...
inline void Assembler::std(  Register d, Address &a) { std(d, a.disp(), a.base()); }
