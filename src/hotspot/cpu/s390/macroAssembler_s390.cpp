...
void MacroAssembler::compare_klass_ptr(Register Rop1, int64_t disp, Register Rbase, bool maybenullptr) {
  ...
  if (UseCompressedClassPointers) {
    ...
    if (base == nullptr) {
      ...
      if (maybenullptr) {       // null ptr must be preserved!
        z_ltgr(Z_R0, current);
        z_bre(done);
        current = Z_R0;
      }
...
void MacroAssembler::compare_heap_oop(Register Rop1, Address mem, bool maybenullptr) {
...
void MacroAssembler::oop_encoder(Register Rdst, Register Rsrc, bool maybenullptr,
...
void MacroAssembler::oop_decoder(Register Rdst, Register Rsrc, bool maybenullptr, Register Rbase, int pow2_offset) {
