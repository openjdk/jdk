...
class MacroAssembler: public Assembler {
 ...
 public:
  ...
  void compare_heap_oop(Register Rop1, Address mem, bool maybenullptr);
  void compare_klass_ptr(Register Rop1, int64_t disp, Register Rbase, bool maybenullptr);
 ...
 public:
  ...
  void oop_encoder(Register Rdst, Register Rsrc, bool maybenullptr,
                   Register Rbase = Z_R1, int pow2_offset = -1, bool only32bitValid = false);
  void oop_decoder(Register Rdst, Register Rsrc, bool maybenullptr,
