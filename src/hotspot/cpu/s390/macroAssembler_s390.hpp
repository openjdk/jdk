...
class MacroAssembler: public Assembler {
 ...
 public:
  ...
  void asm_assert(bool check_equal, const char* msg, int id) NOT_DEBUG_RETURN;
  void asm_assert_low(const char *msg, int id) NOT_DEBUG_RETURN;
  void asm_assert_high(const char *msg, int id) NOT_DEBUG_RETURN;
  ...
  void asm_assert_static(bool check_equal, const char* msg, int id) NOT_DEBUG_RETURN;

 private:
  // Emit assertions.
  void asm_assert_mems_zero(bool check_equal, bool allow_relocation, int size, int64_t mem_offset,
                            Register mem_base, const char* msg, int id) NOT_DEBUG_RETURN;
 ...
 public:
  ...
  void asm_assert_frame_size(Register expected_size, Register tmp, const char* msg, int id) NOT_DEBUG_RETURN;
