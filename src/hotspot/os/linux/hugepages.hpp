...
public:
  ...
  struct Configuration {
    size_t pagesize;
    size_t nr_hugepages;
    size_t nr_overcommit_hugepages;
    Configuration* next;
  };
...
private:
  ...
  // informations for all hugepages supported on the system.
  // Most systems just support 1 or 2. There are outliers like ia64
  // which supports 8.
...
public:
  ...
  const Configuration* configurations() const;
...
public:
  ...
  static bool supports_thp()                    { return thp_mode() != THPMode::never; }
