...
class nmethod : public CompiledMethod {
 ...
 private:
  ...
  volatile uint64_t _stack_traversal_mark;
...
public:
  ...
  // Sweeper support
  uint64_t stack_traversal_mark()                 { return _stack_traversal_mark; }
  void     set_stack_traversal_mark(uint64_t l)   { _stack_traversal_mark = l; }
