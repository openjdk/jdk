...
class ICStub: public Stub {
 ...
 protected:
  ...
  // from_destination_address looks up Stub* address from code entry address,
  // which gets a bit complicated with stub and code entry alignment. Setting code entry
