...
GrowableArray<CodeHeap*>* CodeCache::_heaps = new(mtCode) GrowableArray<CodeHeap*>(mtCode, static_cast<int>(CodeBlobType::All));
GrowableArray<CodeHeap*>* CodeCache::_compiled_heaps = new(mtCode) GrowableArray<CodeHeap*>(mtCode, static_cast<int>(CodeBlobType::All));
GrowableArray<CodeHeap*>* CodeCache::_nmethod_heaps = new(mtCode) GrowableArray<CodeHeap*>(mtCode, static_cast<int>(CodeBlobType::All));
GrowableArray<CodeHeap*>* CodeCache::_allocable_heaps = new(mtCode) GrowableArray<CodeHeap*>(mtCode, static_cast<int>(CodeBlobType::All));
...
static void add_to_old_table(CompiledMethod* c) {
  if (old_compiled_method_table == NULL) {
    old_compiled_method_table = new (mtCode) GrowableArray<CompiledMethod*>(mtCode, 100);
  }
