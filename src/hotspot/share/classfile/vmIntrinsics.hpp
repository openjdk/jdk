...
#define VM_INTRINSICS_DO(do_intrinsic, do_class, do_name, do_signature, do_alias)                                       \
  ...
  do_intrinsic(_hashCodeL,                java_lang_StringLatin1,hashCode_name, hashCode_string_signature,       F_S)   \
  do_intrinsic(_hashCodeU,                java_lang_StringUTF16, hashCode_name, hashCode_string_signature,       F_S)   \
   do_signature(hashCode_string_signature,                       "([B)I")                                               \
                                                                                                                        \
