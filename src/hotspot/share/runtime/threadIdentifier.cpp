...
static volatile int64_t next_thread_id = 5; // starting at 5, excluding the primordial thread id, deflated and anonymous

int64_t ThreadIdentifier::unsafe_next_id() {
