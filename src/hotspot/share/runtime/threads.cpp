...
jint Threads::create_vm(JavaVMInitArgs* args, bool* canTryAgain) {
  ...
  // Once mutexes and main_thread are ready, we can use NmtVirtualMemoryLocker and NmtMemTagLocker.
  NmtVirtualMemoryLocker::set_safe_to_use();
  NmtMemTagLocker::set_safe_to_use();
