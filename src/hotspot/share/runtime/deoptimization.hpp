 ...
 public:
  ...
  class UnrollBlock : public CHeapObj<mtCompiler> {
   ...
   public:
    ...
    static ByteSize size_of_deoptimized_frame_offset_in_bytes() { return byte_offset_of(UnrollBlock, _size_of_deoptimized_frame); }
    static ByteSize caller_adjustment_offset_in_bytes()         { return byte_offset_of(UnrollBlock, _caller_adjustment);         }
    static ByteSize number_of_frames_offset_in_bytes()          { return byte_offset_of(UnrollBlock, _number_of_frames);          }
    static ByteSize frame_sizes_offset_in_bytes()               { return byte_offset_of(UnrollBlock, _frame_sizes);               }
    static ByteSize total_frame_sizes_offset_in_bytes()         { return byte_offset_of(UnrollBlock, _total_frame_sizes);         }
    static ByteSize frame_pcs_offset_in_bytes()                 { return byte_offset_of(UnrollBlock, _frame_pcs);                 }
    static ByteSize counter_temp_offset_in_bytes()              { return byte_offset_of(UnrollBlock, _counter_temp);              }
    static ByteSize initial_info_offset_in_bytes()              { return byte_offset_of(UnrollBlock, _initial_info);              }
    static ByteSize unpack_kind_offset_in_bytes()               { return byte_offset_of(UnrollBlock, _unpack_kind);               }
    static ByteSize sender_sp_temp_offset_in_bytes()            { return byte_offset_of(UnrollBlock, _sender_sp_temp);            }
