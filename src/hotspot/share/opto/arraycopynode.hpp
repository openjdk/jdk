...
private:
  ...
  bool finish_transform(PhaseGVN *phase, bool can_reshape,
                        Node* ctl, Node *mem);
  static bool may_modify_helper(const TypeOopPtr* t_oop, Node* n, PhaseGVN* phase, CallNode* &call);
public:
...
public:
  ...
  static bool may_modify(const TypeOopPtr* t_oop, MemBarNode* mb, PhaseGVN* phase, ArrayCopyNode* &ac);

  static int get_partial_inline_vector_lane_count(BasicType type, int const_len);

  bool modifies(intptr_t offset_lo, intptr_t offset_hi, PhaseGVN* phase, bool must_modify) const;
