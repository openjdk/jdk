...
protected:
  ...
  virtual Node* find_previous_arraycopy(PhaseGVN* phase, Node* ld_alloc, Node*& mem, bool can_see_stored_value) const { return nullptr; }
  ArrayCopyNode* find_array_copy_clone(PhaseGVN* phase, Node* ld_alloc, Node* mem) const;
...
public:
  ...
  Node* can_see_stored_value(Node* st, PhaseGVN* phase) const;
...
protected:
  ...
  virtual Node* find_previous_arraycopy(PhaseGVN* phase, Node* ld_alloc, Node*& mem, bool can_see_stored_value) const;
public:
...
public:
  ...
  bool value_never_loaded(PhaseGVN* phase) const;
...
public:
  ...
  static bool step_through(Node** np, uint instance_id, PhaseGVN* phase);
};
...
public:
  ...
  bool stores_are_sane(PhaseGVN* phase);
#endif //ASSERT
  ...
  Node* find_captured_store(intptr_t start, int size_in_bytes, PhaseGVN* phase);
 ...
 private:
  ...
  static intptr_t get_store_offset(Node* st, PhaseGVN* phase);
