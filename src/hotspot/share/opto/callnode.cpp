...
//
bool CallNode::may_modify(const TypeOopPtr* t_oop, PhaseGVN* phase) {
...
Node *AllocateArrayNode::make_ideal_length(const TypeOopPtr* oop_type, PhaseGVN* phase, bool allow_new_nodes) {
...
bool CallNode::may_modify_arraycopy_helper(const TypeOopPtr* dest_t, const TypeOopPtr* t_oop, PhaseGVN* phase) {
