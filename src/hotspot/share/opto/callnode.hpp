...
protected:
  bool may_modify_arraycopy_helper(const TypeOopPtr* dest_t, const TypeOopPtr* t_oop, PhaseGVN* phase);
...
public:
  ...
  virtual bool        may_modify(const TypeOopPtr* t_oop, PhaseGVN* phase);
...
public:
  ...
  virtual bool        may_modify(const TypeOopPtr* t_oop, PhaseGVN* phase) { return false;}
  ...
  static AllocateNode* Ideal_allocation(Node* ptr, PhaseGVN* phase);
  ...
  static Node* Ideal_klass(Node* ptr, PhaseGVN* phase) {
...
public:
  ...
  Node* make_ideal_length(const TypeOopPtr* ary_type, PhaseGVN* phase, bool can_create = true);

  // Pattern-match a possible usage of AllocateArrayNode.
  // Return null if no allocation is recognized.
  static AllocateArrayNode* Ideal_array_allocation(Node* ptr, PhaseGVN* phase) {
    AllocateNode* allo = Ideal_allocation(ptr, phase);
