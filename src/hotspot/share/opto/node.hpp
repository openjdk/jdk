...
class OpaqueAutoVectorizationMultiversioningNode;
...
//----------------- Other Node Properties
  ...
  enum NodeClasses {
    ...
    DEFINE_CLASS_ID(Opaque1,  Node, 16)
      ...
      DEFINE_CLASS_ID(OpaqueAutoVectorizationMultiversioning, Opaque1, 2)
...
public:
  ...
  DEFINE_CLASS_QUERY(OpaqueAutoVectorizationMultiversioning)
