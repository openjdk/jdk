...
void ScalarVTransformBuilder::build() {
  ...
  // TODO: // // Connect all vtnodes with their inputs. Possibly create vtnodes for input
  // TODO: // // nodes that are outside the loop.
  // TODO: // VectorSet vtn_memory_dependencies; // Shared, but cleared for every vtnode.
  // TODO: // build_inputs_for_scalar_vtnodes(vtn_memory_dependencies);
...
//void ScalarVTransformBuilder::build_inputs_for_scalar_vtnodes(VectorSet& vtn_memory_dependencies) {
//  for (uint i = 0; i < _vloop.lpt()->_body.size(); i++) {
//    Node* n = _vloop.lpt()->_body.at(i);
...
//}
//
//void ScalarVTransformBuilder::init_req_with_scalar(Node* n, VTransformNode* vtn, const int index) {
...
//}
//
//void ScalarVTransformBuilder::init_all_req_with_scalars(Node* n, VTransformNode* vtn) {
