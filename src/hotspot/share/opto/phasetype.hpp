...
#define COMPILER_PHASES(flags) \
  ...
  flags(AUTO_VECTORIZATION2_AFTER_ADJUST_LIMIT, "AutoVectorization 2, After Adjusting Pre-Loop Limit") \
  flags(AUTO_VECTORIZATION3_AFTER_APPLY,        "AutoVectorization 3, After Apply") \
