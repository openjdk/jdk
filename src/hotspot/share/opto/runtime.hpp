...
class OptoRuntime : public AllStatic {
 ...
 private:
  ...
  static void new_instance_C(Klass* instance_klass, JavaThread* current /* TRAPS */);

  // Allocate storage for a objArray or typeArray
  static void new_array_C(Klass* array_klass, int len, JavaThread* current /* TRAPS */);
  static void new_array_nozero_C(Klass* array_klass, int len, JavaThread* current /* TRAPS */);

  // Allocate storage for a multi-dimensional arrays
  // Note: needs to be fixed for arbitrary number of dimensions
  static void multianewarray2_C(Klass* klass, int len1, int len2, JavaThread* current /* TRAPS */);
  static void multianewarray3_C(Klass* klass, int len1, int len2, int len3, JavaThread* current /* TRAPS */);
  static void multianewarray4_C(Klass* klass, int len1, int len2, int len3, int len4, JavaThread* current /* TRAPS */);
  static void multianewarray5_C(Klass* klass, int len1, int len2, int len3, int len4, int len5, JavaThread* current /* TRAPS */);
  static void multianewarrayN_C(Klass* klass, arrayOopDesc* dims, JavaThread* current /* TRAPS */);
...
public:
  ...
  static void monitor_notify_C(oopDesc* obj, JavaThread* current /* TRAPS */);
  static void monitor_notifyAll_C(oopDesc* obj, JavaThread* current /* TRAPS */);
...
private:
  ...
  static void register_finalizer(oopDesc* obj, JavaThread* current /* TRAPS */);
