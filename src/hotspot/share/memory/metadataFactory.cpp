...
void MetadataFactory::free_metadata(ClassLoaderData* loader_data, MethodData* md) {
  if (md != NULL) {
    ...
    md->~MethodData(); // MethodData needs to call destructor
    loader_data->metaspace_non_null()->deallocate((MetaWord*)md, size, false);
  }
}
