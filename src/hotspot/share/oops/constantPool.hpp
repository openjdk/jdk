...
class ConstantPool : public Metadata {
 ...
 public:
  ...
  static ByteSize tags_offset_in_bytes()         { return byte_offset_of(ConstantPool, _tags); }
  static ByteSize cache_offset_in_bytes()        { return byte_offset_of(ConstantPool, _cache); }
  static ByteSize pool_holder_offset_in_bytes()  { return byte_offset_of(ConstantPool, _pool_holder); }
  static ByteSize resolved_klasses_offset_in_bytes()    { return byte_offset_of(ConstantPool, _resolved_klasses); }
