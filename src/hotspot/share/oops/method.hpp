...
#undef M_STATUS_GET_SET
  ...
  // for code generation
  static ByteSize method_data_offset_in_bytes()  { return byte_offset_of(Method, _method_data); }
  static ByteSize intrinsic_id_offset_in_bytes() { return byte_offset_of(Method, _intrinsic_id); }
