...
class FieldClosure: public StackObj {
  ValueKlass* _flat_field_klass;
  int _flat_field_offset; // in bytes
public:
  FieldClosure(ValueKlass* flat_field_klass = nullptr, int flat_field_offset = 0)
  ...
  ValueKlass* flat_field_klass() const { return _flat_field_klass; }
