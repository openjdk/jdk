...
class InstanceKlass: public Klass {
 ...
 public:
  ...
  int java_fields_count()               const { return FieldInfoStream::num_java_fields(fieldinfo_stream()); }
...
void set_fields_status(Array<FieldStatus>* array) {
  _fields_status = array;
}
