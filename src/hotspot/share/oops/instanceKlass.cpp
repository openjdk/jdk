...
#endif
  NOT_PRODUCT(_verify_count(0) COMMA)
  NOT_PRODUCT(_shared_class_load_count(0) COMMA)  _methods(nullptr),
  _default_methods(nullptr),
  _local_interfaces(nullptr),
  _transitive_interfaces(nullptr),
  _method_ordering(nullptr),
  _default_vtable_indices(nullptr),
...
#endif
  NOT_PRODUCT(_verify_count(0) COMMA)
  NOT_PRODUCT(_shared_class_load_count(0) COMMA)
  _methods(nullptr),
  _default_methods(nullptr),
  _local_interfaces(nullptr),
  _transitive_interfaces(nullptr),
