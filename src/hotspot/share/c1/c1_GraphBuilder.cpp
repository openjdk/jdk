...
void GraphBuilder::print_inlining(ciMethod* callee, const char* msg, bool success) {
  ...
  CompileTask::print_inlining_ul(callee, scope()->level(), bci(), Inlining::kind(success), msg);

  if (!compilation()->directive()->PrintInliningOption) {
    return;
  }
  CompileTask::print_inlining_tty(callee, scope()->level(), bci(), Inlining::kind(success), msg);
