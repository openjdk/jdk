...
JRT_ENTRY(void, Runtime1::new_instance(JavaThread* current /* TRAPS */, Klass* klass))
...
JRT_ENTRY(void, Runtime1::new_type_array(JavaThread* current /* TRAPS */, Klass* klass, jint length))
...
JRT_ENTRY(void, Runtime1::new_object_array(JavaThread* current /* TRAPS */, Klass* array_klass, jint length))
...
JRT_ENTRY(void, Runtime1::new_multi_array(JavaThread* current /* TRAPS */, Klass* klass, int rank, jint* dims))
...
JRT_ENTRY(void, Runtime1::throw_array_store_exception(JavaThread* current /* TRAPS */, oopDesc* obj))
...
JRT_ENTRY(void, Runtime1::throw_range_check_exception(JavaThread* current /* TRAPS */, int index, arrayOopDesc* a))
...
JRT_ENTRY(void, Runtime1::throw_index_exception(JavaThread* current /* TRAPS */, int index))
...
JRT_ENTRY(void, Runtime1::throw_div0_exception(JavaThread* current /* TRAPS */))
...
JRT_ENTRY(void, Runtime1::throw_null_pointer_exception(JavaThread* current /* TRAPS */))
  NOT_PRODUCT(_throw_null_pointer_exception_count++;)
  SharedRuntime::throw_and_post_jvmti_exception(current, vmSymbols::java_lang_NullPointerException());
JRT_END


JRT_ENTRY(void, Runtime1::throw_class_cast_exception(JavaThread* current /* TRAPS */, oopDesc* object))
...
JRT_ENTRY(void, Runtime1::throw_incompatible_class_change_error(JavaThread* current /* TRAPS */))
...
JRT_ENTRY(void, Runtime1::patch_code(JavaThread* current /* TRAPS */, Runtime1::StubID stub_id ))
