...
ByteSize FrameMap::sp_offset_for_monitor_lock(int index) const {
  ...
  return sp_offset_for_monitor_base(index) + BasicObjectLock::lock_offset_in_bytes();
}

ByteSize FrameMap::sp_offset_for_monitor_object(int index) const {
  check_monitor_index(index);
  return sp_offset_for_monitor_base(index) + BasicObjectLock::obj_offset_in_bytes();
}
