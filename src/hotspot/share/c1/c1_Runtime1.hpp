...
class Runtime1: public AllStatic {
 ...
 private:
  ...
  static void new_instance    (JavaThread* current /* TRAPS */, Klass* klass);
  static void new_type_array  (JavaThread* current /* TRAPS */, Klass* klass, jint length);
  static void new_object_array(JavaThread* current /* TRAPS */, Klass* klass, jint length);
  static void new_multi_array (JavaThread* current /* TRAPS */, Klass* klass, int rank, jint* dims);
  ...
  static void throw_range_check_exception(JavaThread* current /* TRAPS */, int index, arrayOopDesc* a);
  static void throw_index_exception(JavaThread* current /* TRAPS */, int index);
  static void throw_div0_exception(JavaThread* current /* TRAPS */);
  static void throw_null_pointer_exception(JavaThread* current /* TRAPS */);
  static void throw_class_cast_exception(JavaThread* current /* TRAPS */, oopDesc* object);
  static void throw_incompatible_class_change_error(JavaThread* current /* TRAPS */);
  static void throw_array_store_exception(JavaThread* current /* TRAPS */, oopDesc* object);
  ...
  static void patch_code(JavaThread* current /* TRAPS */, StubID stub_id);
