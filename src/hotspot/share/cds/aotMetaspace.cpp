...
//  and CDS)
//
// If USE_COMPRESSED_CLASS_POINTERS_ALWAYS_TRUE is disabled, only one address space will be
//  reserved:
//
// +-- Base address             End
// |                            |
...
//  by the platform.
//
// If USE_COMPRESSED_CLASS_POINTERS_ALWAYS_TRUE=1, the range encompassing both spaces will be
...
//      class_space_rs if USE_COMPRESSED_CLASS_POINTERS_ALWAYS_TRUE is true.
...
//      granularity.
//    - class_space_rs: If USE_COMPRESSED_CLASS_POINTERS_ALWAYS_TRUE=1, class_space_rs will
...
//      covers both spaces.
//      If USE_COMPRESSED_CLASS_POINTERS_ALWAYS_TRUE=0, class_space_rs remains unreserved.
