...
NO_TRANSITION(jboolean, jfr_set_throttle(JNIEnv* env, jobject jvm, jlong event_type_id, jint rate_per_second))
  JfrEventThrottler::for_event(static_cast<JfrEventId>(event_type_id))->configure(rate_per_second);
  return JNI_TRUE;
NO_TRANSITION_END
