...
jlong JNICALL jfr_stacktrace_id(JNIEnv* env, jclass jvm, jint skip, jlong start_frame_id);
...
jlong JNICALL jfr_un_register_stack_filter(JNIEnv* env, jlong start_filter_id);
