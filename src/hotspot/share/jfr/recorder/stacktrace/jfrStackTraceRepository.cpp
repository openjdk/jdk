...
traceid JfrStackTraceRepository::record(Thread* current_thread, int skip /* 0 */, long stack_filter_id /* 0 */) {
...
traceid JfrStackTraceRepository::record(JavaThread* current_thread, int skip, long stack_filter_id, JfrStackFrame *frames, u4 max_frames) {
