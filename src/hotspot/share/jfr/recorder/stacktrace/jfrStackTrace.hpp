...
class JfrStackTrace : public JfrCHeapObj {
 ...
 private:
  ...
  bool record(JavaThread* current_thread, int skip, long stack_frame_id);
  bool record(JavaThread* current_thread, const frame& frame, int skip, long stack_frame_id);
