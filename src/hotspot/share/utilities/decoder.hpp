...
public:
  ...
  virtual bool get_source_info(address pc, char* buf, size_t buflen, int* line, bool is_pc_after_call) { return false; }
...
public:
  ...
  static bool get_source_info(address pc, char* buf, size_t buflen, int* line, bool is_pc_after_call = false);
