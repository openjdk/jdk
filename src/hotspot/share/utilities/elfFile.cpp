...
// Parsing header as specified in section 6.1.2 of the DWARF spec 4.
...
// Parsing header as specified in section 6.2.4 of DWARF spec 4. We do not read the file_names field, yet.
