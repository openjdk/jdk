...
private:
  ...
  static const size_t buffer_size_bytes = buffer_length * sizeof(ZStoreBarrierEntry);

  ZStoreBarrierEntry _buffer[buffer_length];
  ...
  zaddress_unsafe    _base_pointers[buffer_length];
