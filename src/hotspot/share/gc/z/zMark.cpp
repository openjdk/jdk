...
void ZMark::prepare_work() {
  assert(_nworkers == workers()->nconcurrent(), "Invalid number of workers");
...
bool ZMark::try_mark_object(ZMarkCache* cache, zaddress addr, bool finalizable) {
