...
#ifndef SHARE_GC_SHARED_OBJECTCOUNTAFTERGCEVENTSENDER_HPP
#define SHARE_GC_SHARED_OBJECTCOUNTAFTERGCEVENTSENDER_HPP
...
class ObjectCountAfterGCEventSender : public AllStatic {
