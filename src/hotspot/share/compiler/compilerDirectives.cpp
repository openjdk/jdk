...
#define init_default_cc(name, type, dvalue, cc_flag) { type v; if (!_modified[name##Index] && /* CMH CompilerOracle::has_option_value(method, #cc_flag, v) && */ v != this->name##Option) { set.cloned()->name##Option = v; } }
