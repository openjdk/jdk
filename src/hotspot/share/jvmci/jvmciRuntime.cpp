...
void JVMCINMethodData::invalidate_nmethod_mirror(nmethod* nm, int statusReason) {
  ...
  if (nm == current) {
    if (nm->is_unloading()) {
      ...
      HotSpotJVMCI::InstalledCode::set_statusReason(jvmciEnv, nmethod_mirror, statusReason);
