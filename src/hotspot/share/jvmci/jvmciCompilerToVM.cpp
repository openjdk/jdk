...
C2V_VMENTRY_NULL(jobjectArray, getNonInitializerMethods, (JNIEnv* env, jobject, ARGUMENT_PAIR(klass)))
  Klass* klass = UNPACK_PAIR(Klass, klass);
  if (klass == nullptr) {
    JVMCI_THROW_NULL(NullPointerException);
  }
...
JNINativeMethod CompilerToVM::methods[] = {
  ...
  {CC "getNonInitializerMethods",                     CC "(" HS_KLASS2 ")[" RESOLVED_METHOD,                                                FN_PTR(getNonInitializerMethods)},
