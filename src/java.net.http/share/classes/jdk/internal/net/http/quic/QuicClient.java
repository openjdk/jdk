...
public final class QuicClient implements QuicInstance, AutoCloseable {
     ...
     * id generated by this client. The byte buffer is expected to have
     ...
     *         a connection id generated by this client, {@code null}
     *         otherwise.
     */
    @Override
    public QuicConnectionId unsafeConnectionIdFor(ByteBuffer buffer) {
        return idFactory().unsafeConnectionIdFor(buffer);
    }
