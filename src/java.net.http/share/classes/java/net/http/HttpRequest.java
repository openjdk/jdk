...
public abstract class HttpRequest {
    ...
    public interface Builder {
         ...
         *
         * @implSpec
         * When a timeout value is present, an {@link HttpClient}
         * implementation should apply it over the duration measured from the
         * instant the request execution starts to, <em>at least</em>, the
         * instant an {@link HttpResponse} is constructed. This duration
         * includes obtaining a connection for transport and retrieving the
         * response headers.
         *
         * @implNote
         * When a timeout value is present, the JDK built-in implementation of
         * the {@link HttpClient} applies it over the duration measured from
         * the instant the request execution starts to <b>the instant the
         * response body is consumed</b>, if present. This is implemented by
         * stopping the timer after the response body subscriber completion.
         *
