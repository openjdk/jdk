...
public abstract class HttpClient {
    ...
    public interface Builder {
         ...
         *
         * @spec https://www.rfc-editor.org/info/rfc6454 RFC 6454: The Web Origin Concept
     ...
     * method.
     *
     * @spec https://www.rfc-editor.org/info/rfc7231 RFC 7231: Hypertext Transfer Protocol (HTTP/1.1): Semantics and Content
