...
final class CompilerToVM {
    ...
    /**
     * Gets the appendix object (if any) associated with the entry for the {@code rawIndex}.
     *
     * @param rawIndex if negative, is treated as an encoded indy index for INVONEDYNAMIC;
