...
public interface ConstantPool {
    ...
    interface BootstrapMethodInvocation {
         ...
         * CONSTANTAdd_InvokeDynamic_info} pool entry, then this method ensures the
         * invoke dynamic is resolved. This can be used to compile time resolve the
         * invoke dynamic. If the bootstrap method is for a
