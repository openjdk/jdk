...
public class ThreadInfo {
     ...
     * executing native code. This method returns {@code true} when the thread
     * is executing a native method, or native code invoked using a {@linkplain
     * java.lang.invoke.MethodHandle method handle} obtained from the
     * {@linkplain java.lang.foreign.Linker native linker}.
     * A thread is not considered to be executing native code, and thus returns
     * {@code false}, when executing virtual machine support code or compiled
     * native code generated by the virtual machine.
     *
