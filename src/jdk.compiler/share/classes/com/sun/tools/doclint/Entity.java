...
/**
 * Table of entities defined in HTML 5.
 *
 * <p> Derived from the
 * <a href="https://www.w3.org/TR/html52/syntax.html#named-character-references">Named character references</a>
 * section of the HTML 5.2 spec.
 *
 * HTML 5 introduces character entities that do not end with a semicolon,
 * as well as entities with dual code points. These entities are not
 * currently supported by this class (see JDK-8223868).
 *
