...
import static jdk.jpackage.cli.PackageTypeGroup.ALL_PACKAGE_TYPES;
import static jdk.jpackage.cli.PackageTypeGroup.APP_IMAGE;
import static jdk.jpackage.cli.PackageTypeGroup.NATIVE_PACKAGE;
...
public enum StandardOption implements Option {
    ...
    ADD_LAUNCHER(build().name("add-launcher").valueConverter(new ValueConverter<AdditionalLauncher>() {
        @Override
        public jdk.jpackage.cli.AdditionalLauncher convert(String value) {
        ...
        @Override
        public Class<? extends jdk.jpackage.cli.AdditionalLauncher> valueType() {
