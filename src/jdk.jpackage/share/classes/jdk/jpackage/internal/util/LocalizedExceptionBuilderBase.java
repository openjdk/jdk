...
public abstract class LocalizedExceptionBuilderBase<U extends LocalizedExceptionBuilderBase<U>> {

    protected LocalizedExceptionBuilderBase(StringBundle l18n) {
        this.l18n = l18n;
    }
    ...
    final public U format(boolean v) {
        noFormat = !v;
        return thiz();
    }

    final public U noformat() {
        return format(false);
    }

    final public U message(String msgId, Object... args) {
        msg = formatString(msgId, args);
        return thiz();
    }

    final public U cause(Throwable v) {
        cause = v;
        return thiz();
    }

    final public U causeAndMessage(Throwable t) {
