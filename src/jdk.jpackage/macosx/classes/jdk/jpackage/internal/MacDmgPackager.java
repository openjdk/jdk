...
record MacDmgPackager(BuildEnv env, MacDmgPackage pkg, Path outputDir,
    ...
    private void buildDMG() throws IOException {
        ...
        hdiutil("attach",
                ...
                hdiUtilVerbosityFlag,
                "-mountroot", protoDMG.getParent().toString()).executeExpectSuccess();
    ...
    private void detachVolume(Path mountedVolume) throws IOException {
        Objects.requireNonNull(mountedVolume);
