...
public class MacPkgBundler extends MacBaseInstallerBundler {
    ...
    private void prepareDistributionXMLFile(Map<String, ? super Object> params)
        ...
        IOUtils.createXml(f, xml -> {
            ...
            addPackageToInstallerGuiScript(xml, appId,
                    getPackages_AppPackage(params).getFileName().toString(),
                    VERSION.fetchFrom(params));
            if (withServicesPkg(params)) {
                String servicesId = getServicesIdentifier(params);
                pkgIds.add(servicesId);
                addPackageToInstallerGuiScript(xml, servicesId,
                        getPackages_ServicesPackage(params).getFileName().toString(),
                        VERSION.fetchFrom(params));
            }
