...
final class LinuxPackageBuilder {
    ...
    LinuxPackage create() throws ConfigException {
        ...
        if (create(tmpPkg).isInstallDirInUsrTree()) {
            ...
            relativeInstalledLayout = tmpPkg.appImageLayout().resolveAt(tmpPkg.relativeInstallDir()).emptyRootDirectory();
        }
        ...
        return create(pkgBuilder
                ...
                .installedPackageLayout(relativeInstalledLayout.resolveAt(Path.of("/")).emptyRootDirectory())
                .create());
    }
