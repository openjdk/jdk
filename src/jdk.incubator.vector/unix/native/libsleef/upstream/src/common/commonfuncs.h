...
static INLINE CONST vdouble  vd3getx_vd_vd3(vdouble3 v) { return v.x; }
static INLINE CONST vdouble  vd3gety_vd_vd3(vdouble3 v) { return v.y; }
static INLINE CONST vdouble  vd3getz_vd_vd3(vdouble3 v) { return v.z; }
static INLINE CONST vdouble3 vd3setxyz_vd3_vd_vd_vd(vdouble x, vdouble y, vdouble z)  {
  vdouble3 v = { x, y, z };
  return v;
}
static INLINE CONST vdouble3 vd3setx_vd3_vd3_vd(vdouble3 v, vdouble d) { v.x = d; return v; }
static INLINE CONST vdouble3 vd3sety_vd3_vd3_vd(vdouble3 v, vdouble d) { v.y = d; return v; }
static INLINE CONST vdouble3 vd3setz_vd3_vd3_vd(vdouble3 v, vdouble d) { v.z = d; return v; }
...
static INLINE CONST vmask tdxgete_vm_tdx(tdx t) { return t.e; }
static INLINE CONST vdouble3 tdxgetd3_vd3_tdx(tdx t) { return t.d3; }
static INLINE CONST vdouble tdxgetd3x_vd_tdx(tdx t) { return t.d3.x; }
static INLINE CONST vdouble tdxgetd3y_vd_tdx(tdx t) { return t.d3.y; }
static INLINE CONST vdouble tdxgetd3z_vd_tdx(tdx t) { return t.d3.z; }
static INLINE CONST tdx tdxsete_tdx_tdx_vm(tdx t, vmask e) { t.e = e; return t; }
static INLINE CONST tdx tdxsetd3_tdx_tdx_vd3(tdx t, vdouble3 d3) { t.d3 = d3; return t; }
static INLINE CONST tdx tdxsetx_tdx_tdx_vd(tdx t, vdouble x) { t.d3.x = x; return t; }
static INLINE CONST tdx tdxsety_tdx_tdx_vd(tdx t, vdouble y) { t.d3.y = y; return t; }
static INLINE CONST tdx tdxsetz_tdx_tdx_vd(tdx t, vdouble z) { t.d3.z = z; return t; }
static INLINE CONST tdx tdxsetxyz_tdx_tdx_vd_vd_vd(tdx t, vdouble x, vdouble y, vdouble z) {
  t.d3 = (vdouble3) { x, y, z };
  return t;
}

static INLINE CONST tdx tdxseted3_tdx_vm_vd3(vmask e, vdouble3 d3) { return (tdx) { e, d3 }; }
static INLINE CONST tdx tdxsetexyz_tdx_vm_vd_vd_vd(vmask e, vdouble x, vdouble y, vdouble z) {
  return (tdx) { e, (vdouble3) { x, y, z } };
}

static INLINE CONST vmask vqgetx_vm_vq(vquad v) { return v.x; }
static INLINE CONST vmask vqgety_vm_vq(vquad v) { return v.y; }
static INLINE CONST vquad vqsetxy_vq_vm_vm(vmask x, vmask y) { return (vquad) { x, y }; }
static INLINE CONST vquad vqsetx_vq_vq_vm(vquad v, vmask x) { v.x = x; return v; }
static INLINE CONST vquad vqsety_vq_vq_vm(vquad v, vmask y) { v.y = y; return v; }
...
static INLINE CONST vdouble digetd_vd_di(di_t d) { return d.d; }
static INLINE CONST vint digeti_vi_di(di_t d) { return d.i; }
static INLINE CONST di_t disetdi_di_vd_vi(vdouble d, vint i) {
  di_t r = { d, i };
  return r;
}
...
static INLINE CONST vdouble2 ddigetdd_vd2_ddi(ddi_t d) { return d.dd; }
static INLINE CONST vint ddigeti_vi_ddi(ddi_t d) { return d.i; }
static INLINE CONST ddi_t ddisetddi_ddi_vd2_vi(vdouble2 v, vint i) {
  ddi_t r = { v, i };
  return r;
}
static INLINE CONST ddi_t ddisetdd_ddi_ddi_vd2(ddi_t ddi, vdouble2 v) {
  ddi.dd = v;
  return ddi;
}
...
static INLINE CONST vdouble3 tdigettd_vd3_tdi(tdi_t d) { return d.td; }
static INLINE CONST vdouble tdigetx_vd_tdi(tdi_t d) { return d.td.x; }
static INLINE CONST vint tdigeti_vi_tdi(tdi_t d) { return d.i; }
static INLINE CONST tdi_t tdisettdi_tdi_vd3_vi(vdouble3 v, vint i) {
  tdi_t r = { v, i };
  return r;
}
#endif
...
static INLINE CONST vdouble vtoward0_vd_vd(vdouble x) { // returns nextafter(x, 0)
...
static INLINE CONST vdouble vtruncate2_vd_vd(vdouble x) {
...
static INLINE CONST vdouble vpow2i_vd_vm(vmask q) {
