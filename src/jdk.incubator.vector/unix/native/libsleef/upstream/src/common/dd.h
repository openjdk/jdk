...
static INLINE CONST vdouble  vd2getx_vd_vd2(vdouble2 v) { return v.x; }
static INLINE CONST vdouble  vd2gety_vd_vd2(vdouble2 v) { return v.y; }
static INLINE CONST vdouble2 vd2setxy_vd2_vd_vd(vdouble x, vdouble y)  { vdouble2 v; v.x = x; v.y = y; return v; }
static INLINE CONST vdouble2 vd2setx_vd2_vd2_vd(vdouble2 v, vdouble d) { v.x = d; return v; }
static INLINE CONST vdouble2 vd2sety_vd2_vd2_vd(vdouble2 v, vdouble d) { v.y = d; return v; }
#endif
...
static INLINE CONST vdouble2 ddmla_vd2_vd2_vd2_vd2(vdouble2 x, vdouble2 y, vdouble2 z) {
