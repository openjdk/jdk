...
final class FloatVector64 extends FloatVector {
    ...
    public int laneHelper(int i) {
        return (int) VectorSupport.extract(
                     VCLASS, VECTOR_LANE_TYPE_FLOAT, VLENGTH,
                     this, i,
                     (vec, ix) -> {
    ...
    static final class FloatMask64 extends AbstractMask<Float> {
        ...
        FloatMask64 indexPartiallyInUpperRange(long offset, long limit) {
            return (FloatMask64) VectorSupport.indexPartiallyInUpperRange(
                FloatMask64.class, VECTOR_LANE_TYPE_FLOAT, VLENGTH, offset, limit,
        ...
        public FloatMask64 compress() {
            return (FloatMask64)VectorSupport.compressExpandOp(VectorSupport.VECTOR_OP_MASK_COMPRESS,
                FloatVector64.class, FloatMask64.class, VECTOR_LANE_TYPE_FLOAT, VLENGTH, null, this,
        ...
        public FloatMask64 and(VectorMask<Float> mask) {
            ...
            return VectorSupport.binaryOp(VECTOR_OP_AND, FloatMask64.class, null, VECTOR_LANE_TYPE_INT, VLENGTH,
                                          this, m, null,
        ...
        public FloatMask64 or(VectorMask<Float> mask) {
            Objects.requireNonNull(mask);
            FloatMask64 m = (FloatMask64)mask;
            return VectorSupport.binaryOp(VECTOR_OP_OR, FloatMask64.class, null, VECTOR_LANE_TYPE_INT, VLENGTH,
                                          this, m, null,
                                          (m1, m2, vm) -> m1.bOp(m2, (i, a, b) -> a | b));
        }
        ...
        public FloatMask64 xor(VectorMask<Float> mask) {
            Objects.requireNonNull(mask);
            FloatMask64 m = (FloatMask64)mask;
            return VectorSupport.binaryOp(VECTOR_OP_XOR, FloatMask64.class, null, VECTOR_LANE_TYPE_INT, VLENGTH,
                                          this, m, null,
                                          (m1, m2, vm) -> m1.bOp(m2, (i, a, b) -> a ^ b));
        }
        ...
        public int trueCount() {
            return (int) VectorSupport.maskReductionCoerced(VECTOR_OP_MASK_TRUECOUNT, FloatMask64.class, VECTOR_LANE_TYPE_INT,
                                                            VLENGTH, this,
        ...
        public int firstTrue() {
            return (int) VectorSupport.maskReductionCoerced(VECTOR_OP_MASK_FIRSTTRUE, FloatMask64.class, VECTOR_LANE_TYPE_INT,
                                                            VLENGTH, this,
        ...
        @ForceInline
        public int lastTrue() {
            return (int) VectorSupport.maskReductionCoerced(VECTOR_OP_MASK_LASTTRUE, FloatMask64.class, VECTOR_LANE_TYPE_INT,
                                                            VLENGTH, this,
        ...
        public long toLong() {
            ...
            return VectorSupport.maskReductionCoerced(VECTOR_OP_MASK_TOLONG, FloatMask64.class, VECTOR_LANE_TYPE_INT,
                                                      VLENGTH, this,
        ...
        public boolean laneIsSet(int i) {
            ...
            return VectorSupport.extract(FloatMask64.class, VECTOR_LANE_TYPE_FLOAT, VLENGTH,
        ...
        public boolean anyTrue() {
            return VectorSupport.test(BT_ne, FloatMask64.class, VECTOR_LANE_TYPE_INT, VLENGTH,
        ...
        public boolean allTrue() {
            return VectorSupport.test(BT_overflow, FloatMask64.class, VECTOR_LANE_TYPE_INT, VLENGTH,
                                      this, vspecies().maskAll(true),
        ...
        static FloatMask64 maskAll(boolean bit) {
            return VectorSupport.fromBitsCoerced(FloatMask64.class, VECTOR_LANE_TYPE_INT, VLENGTH,
