    ...
    static final class LongMaskMax extends AbstractMask<Long> {
        ...
        LongMaskMax indexPartiallyInUpperRange(long offset, long limit) {
            return (LongMaskMax) VectorSupport.indexPartiallyInUpperRange(
                LongMaskMax.class, VECTOR_LANE_TYPE_LONG, VLENGTH, offset, limit,
        ...
        public LongMaskMax compress() {
            return (LongMaskMax)VectorSupport.compressExpandOp(VectorSupport.VECTOR_OP_MASK_COMPRESS,
                LongVectorMax.class, LongMaskMax.class, VECTOR_LANE_TYPE_LONG, VLENGTH, null, this,
        ...
        public LongMaskMax and(VectorMask<Long> mask) {
            ...
            return VectorSupport.binaryOp(VECTOR_OP_AND, LongMaskMax.class, null, VECTOR_LANE_TYPE_LONG, VLENGTH,
                                          this, m, null,
        ...
        public LongMaskMax or(VectorMask<Long> mask) {
            Objects.requireNonNull(mask);
            LongMaskMax m = (LongMaskMax)mask;
            return VectorSupport.binaryOp(VECTOR_OP_OR, LongMaskMax.class, null, VECTOR_LANE_TYPE_LONG, VLENGTH,
                                          this, m, null,
                                          (m1, m2, vm) -> m1.bOp(m2, (i, a, b) -> a | b));
        }
        ...
        public LongMaskMax xor(VectorMask<Long> mask) {
            Objects.requireNonNull(mask);
            LongMaskMax m = (LongMaskMax)mask;
            return VectorSupport.binaryOp(VECTOR_OP_XOR, LongMaskMax.class, null, VECTOR_LANE_TYPE_LONG, VLENGTH,
                                          this, m, null,
                                          (m1, m2, vm) -> m1.bOp(m2, (i, a, b) -> a ^ b));
        }
        ...
        public int trueCount() {
            return (int) VectorSupport.maskReductionCoerced(VECTOR_OP_MASK_TRUECOUNT, LongMaskMax.class, VECTOR_LANE_TYPE_LONG,
                                                            VLENGTH, this,
        ...
        public int firstTrue() {
            return (int) VectorSupport.maskReductionCoerced(VECTOR_OP_MASK_FIRSTTRUE, LongMaskMax.class, VECTOR_LANE_TYPE_LONG,
                                                            VLENGTH, this,
        ...
        @ForceInline
        public int lastTrue() {
            return (int) VectorSupport.maskReductionCoerced(VECTOR_OP_MASK_LASTTRUE, LongMaskMax.class, VECTOR_LANE_TYPE_LONG,
                                                            VLENGTH, this,
        ...
        public long toLong() {
            ...
            return VectorSupport.maskReductionCoerced(VECTOR_OP_MASK_TOLONG, LongMaskMax.class, VECTOR_LANE_TYPE_LONG,
                                                      VLENGTH, this,
        ...
        public boolean laneIsSet(int i) {
            ...
            return VectorSupport.extract(LongMaskMax.class, VECTOR_LANE_TYPE_LONG, VLENGTH,
        ...
        public boolean anyTrue() {
            return VectorSupport.test(BT_ne, LongMaskMax.class, VECTOR_LANE_TYPE_LONG, VLENGTH,
        ...
        public boolean allTrue() {
            return VectorSupport.test(BT_overflow, LongMaskMax.class, VECTOR_LANE_TYPE_LONG, VLENGTH,
                                      this, vspecies().maskAll(true),
        ...
        static LongMaskMax maskAll(boolean bit) {
            return VectorSupport.fromBitsCoerced(LongMaskMax.class, VECTOR_LANE_TYPE_LONG, VLENGTH,
