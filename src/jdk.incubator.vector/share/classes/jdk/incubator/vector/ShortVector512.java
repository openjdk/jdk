...
final class ShortVector512 extends ShortVector {
    ...
    @ForceInline
    final @Override
    ShortVector512 sOp(FSnOp f) {
        return (ShortVector512) super.sOpTemplate(f);  // specialize
    }

    @ForceInline
    final @Override
    ShortVector512 sOp(VectorMask<Short> m, FSnOp f) {
        return (ShortVector512)
            super.sOpTemplate((ShortMask512)m, f);  // specialize
    }
    ...
    static final class ShortMask512 extends AbstractMask<Short> {
        ...
        ShortMask512 indexPartiallyInUpperRange(long offset, long limit) {
            return (ShortMask512) VectorSupport.indexPartiallyInUpperRange(
                ShortMask512.class, VECTOR_LANE_TYPE_SHORT, VLENGTH, offset, limit,
        ...
        public ShortMask512 compress() {
            return (ShortMask512)VectorSupport.compressExpandOp(VectorSupport.VECTOR_OP_MASK_COMPRESS,
                ShortVector512.class, ShortMask512.class, VECTOR_LANE_TYPE_SHORT, VLENGTH, null, this,
        ...
        public ShortMask512 and(VectorMask<Short> mask) {
            ...
            return VectorSupport.binaryOp(VECTOR_OP_AND, ShortMask512.class, null, VECTOR_LANE_TYPE_SHORT, VLENGTH,
                                          this, m, null,
        ...
        public ShortMask512 or(VectorMask<Short> mask) {
            Objects.requireNonNull(mask);
            ShortMask512 m = (ShortMask512)mask;
            return VectorSupport.binaryOp(VECTOR_OP_OR, ShortMask512.class, null, VECTOR_LANE_TYPE_SHORT, VLENGTH,
                                          this, m, null,
                                          (m1, m2, vm) -> m1.bOp(m2, (i, a, b) -> a | b));
        }
        ...
        public ShortMask512 xor(VectorMask<Short> mask) {
            Objects.requireNonNull(mask);
            ShortMask512 m = (ShortMask512)mask;
            return VectorSupport.binaryOp(VECTOR_OP_XOR, ShortMask512.class, null, VECTOR_LANE_TYPE_SHORT, VLENGTH,
                                          this, m, null,
                                          (m1, m2, vm) -> m1.bOp(m2, (i, a, b) -> a ^ b));
        }
        ...
        public int trueCount() {
            return (int) VectorSupport.maskReductionCoerced(VECTOR_OP_MASK_TRUECOUNT, ShortMask512.class, VECTOR_LANE_TYPE_SHORT,
                                                            VLENGTH, this,
        ...
        public int firstTrue() {
            return (int) VectorSupport.maskReductionCoerced(VECTOR_OP_MASK_FIRSTTRUE, ShortMask512.class, VECTOR_LANE_TYPE_SHORT,
                                                            VLENGTH, this,
        ...
        @ForceInline
        public int lastTrue() {
            return (int) VectorSupport.maskReductionCoerced(VECTOR_OP_MASK_LASTTRUE, ShortMask512.class, VECTOR_LANE_TYPE_SHORT,
                                                            VLENGTH, this,
        ...
        public long toLong() {
            ...
            return VectorSupport.maskReductionCoerced(VECTOR_OP_MASK_TOLONG, ShortMask512.class, VECTOR_LANE_TYPE_SHORT,
                                                      VLENGTH, this,
        ...
        public boolean laneIsSet(int i) {
            ...
            return VectorSupport.extract(ShortMask512.class, VECTOR_LANE_TYPE_SHORT, VLENGTH,
        ...
        public boolean anyTrue() {
            return VectorSupport.test(BT_ne, ShortMask512.class, VECTOR_LANE_TYPE_SHORT, VLENGTH,
        ...
        public boolean allTrue() {
            return VectorSupport.test(BT_overflow, ShortMask512.class, VECTOR_LANE_TYPE_SHORT, VLENGTH,
                                      this, vspecies().maskAll(true),
        ...
        static ShortMask512 maskAll(boolean bit) {
            return VectorSupport.fromBitsCoerced(ShortMask512.class, VECTOR_LANE_TYPE_SHORT, VLENGTH,
