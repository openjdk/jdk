...
final class Float16Vector512 extends Float16Vector {
    ...
    public short laneHelper(int i) {
        return (short) VectorSupport.extract(
                     VCLASS, VECTOR_LANE_TYPE_FLOAT16, VLENGTH,
                     this, i,
                     (vec, ix) -> {
    ...
    static final class Float16Mask512 extends AbstractMask<Float16> {
        ...
        Float16Mask512 indexPartiallyInUpperRange(long offset, long limit) {
            return (Float16Mask512) VectorSupport.indexPartiallyInUpperRange(
                Float16Mask512.class, VECTOR_LANE_TYPE_FLOAT16, VLENGTH, offset, limit,
        ...
        public Float16Mask512 compress() {
            return (Float16Mask512)VectorSupport.compressExpandOp(VectorSupport.VECTOR_OP_MASK_COMPRESS,
                Float16Vector512.class, Float16Mask512.class, VECTOR_LANE_TYPE_FLOAT16, VLENGTH, null, this,
        ...
        public Float16Mask512 and(VectorMask<Float16> mask) {
            ...
            return VectorSupport.binaryOp(VECTOR_OP_AND, Float16Mask512.class, null, VECTOR_LANE_TYPE_SHORT, VLENGTH,
                                          this, m, null,
        ...
        public Float16Mask512 or(VectorMask<Float16> mask) {
            Objects.requireNonNull(mask);
            Float16Mask512 m = (Float16Mask512)mask;
            return VectorSupport.binaryOp(VECTOR_OP_OR, Float16Mask512.class, null, VECTOR_LANE_TYPE_SHORT, VLENGTH,
                                          this, m, null,
                                          (m1, m2, vm) -> m1.bOp(m2, (i, a, b) -> a | b));
        }
        ...
        public Float16Mask512 xor(VectorMask<Float16> mask) {
            Objects.requireNonNull(mask);
            Float16Mask512 m = (Float16Mask512)mask;
            return VectorSupport.binaryOp(VECTOR_OP_XOR, Float16Mask512.class, null, VECTOR_LANE_TYPE_SHORT, VLENGTH,
                                          this, m, null,
                                          (m1, m2, vm) -> m1.bOp(m2, (i, a, b) -> a ^ b));
        }
        ...
        public int trueCount() {
            return (int) VectorSupport.maskReductionCoerced(VECTOR_OP_MASK_TRUECOUNT, Float16Mask512.class, VECTOR_LANE_TYPE_SHORT,
                                                            VLENGTH, this,
        ...
        public int firstTrue() {
            return (int) VectorSupport.maskReductionCoerced(VECTOR_OP_MASK_FIRSTTRUE, Float16Mask512.class, VECTOR_LANE_TYPE_SHORT,
                                                            VLENGTH, this,
        ...
        @ForceInline
        public int lastTrue() {
            return (int) VectorSupport.maskReductionCoerced(VECTOR_OP_MASK_LASTTRUE, Float16Mask512.class, VECTOR_LANE_TYPE_SHORT,
                                                            VLENGTH, this,
        ...
        public long toLong() {
            ...
            return VectorSupport.maskReductionCoerced(VECTOR_OP_MASK_TOLONG, Float16Mask512.class, VECTOR_LANE_TYPE_SHORT,
                                                      VLENGTH, this,
        ...
        public boolean laneIsSet(int i) {
            ...
            return VectorSupport.extract(Float16Mask512.class, VECTOR_LANE_TYPE_FLOAT16, VLENGTH,
        ...
        public boolean anyTrue() {
            return VectorSupport.test(BT_ne, Float16Mask512.class, VECTOR_LANE_TYPE_SHORT, VLENGTH,
        ...
        public boolean allTrue() {
            return VectorSupport.test(BT_overflow, Float16Mask512.class, VECTOR_LANE_TYPE_SHORT, VLENGTH,
                                      this, vspecies().maskAll(true),
        ...
        static Float16Mask512 maskAll(boolean bit) {
            return VectorSupport.fromBitsCoerced(Float16Mask512.class, VECTOR_LANE_TYPE_SHORT, VLENGTH,
