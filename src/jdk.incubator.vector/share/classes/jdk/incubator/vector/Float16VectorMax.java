    ...
    static final class Float16MaskMax extends AbstractMask<Float16> {
        ...
        Float16MaskMax indexPartiallyInUpperRange(long offset, long limit) {
            return (Float16MaskMax) VectorSupport.indexPartiallyInUpperRange(
                Float16MaskMax.class, VECTOR_LANE_TYPE_FLOAT16, VLENGTH, offset, limit,
        ...
        public Float16MaskMax compress() {
            return (Float16MaskMax)VectorSupport.compressExpandOp(VectorSupport.VECTOR_OP_MASK_COMPRESS,
                Float16VectorMax.class, Float16MaskMax.class, VECTOR_LANE_TYPE_FLOAT16, VLENGTH, null, this,
        ...
        public Float16MaskMax and(VectorMask<Float16> mask) {
            ...
            return VectorSupport.binaryOp(VECTOR_OP_AND, Float16MaskMax.class, null, VECTOR_LANE_TYPE_SHORT, VLENGTH,
                                          this, m, null,
        ...
        public Float16MaskMax or(VectorMask<Float16> mask) {
            Objects.requireNonNull(mask);
            Float16MaskMax m = (Float16MaskMax)mask;
            return VectorSupport.binaryOp(VECTOR_OP_OR, Float16MaskMax.class, null, VECTOR_LANE_TYPE_SHORT, VLENGTH,
                                          this, m, null,
                                          (m1, m2, vm) -> m1.bOp(m2, (i, a, b) -> a | b));
        }
        ...
        public Float16MaskMax xor(VectorMask<Float16> mask) {
            Objects.requireNonNull(mask);
            Float16MaskMax m = (Float16MaskMax)mask;
            return VectorSupport.binaryOp(VECTOR_OP_XOR, Float16MaskMax.class, null, VECTOR_LANE_TYPE_SHORT, VLENGTH,
                                          this, m, null,
                                          (m1, m2, vm) -> m1.bOp(m2, (i, a, b) -> a ^ b));
        }
        ...
        public int trueCount() {
            return (int) VectorSupport.maskReductionCoerced(VECTOR_OP_MASK_TRUECOUNT, Float16MaskMax.class, VECTOR_LANE_TYPE_SHORT,
                                                            VLENGTH, this,
        ...
        public int firstTrue() {
            return (int) VectorSupport.maskReductionCoerced(VECTOR_OP_MASK_FIRSTTRUE, Float16MaskMax.class, VECTOR_LANE_TYPE_SHORT,
                                                            VLENGTH, this,
        ...
        @ForceInline
        public int lastTrue() {
            return (int) VectorSupport.maskReductionCoerced(VECTOR_OP_MASK_LASTTRUE, Float16MaskMax.class, VECTOR_LANE_TYPE_SHORT,
                                                            VLENGTH, this,
        ...
        public long toLong() {
            ...
            return VectorSupport.maskReductionCoerced(VECTOR_OP_MASK_TOLONG, Float16MaskMax.class, VECTOR_LANE_TYPE_SHORT,
                                                      VLENGTH, this,
        ...
        public boolean laneIsSet(int i) {
            ...
            return VectorSupport.extract(Float16MaskMax.class, VECTOR_LANE_TYPE_FLOAT16, VLENGTH,
        ...
        public boolean anyTrue() {
            return VectorSupport.test(BT_ne, Float16MaskMax.class, VECTOR_LANE_TYPE_SHORT, VLENGTH,
        ...
        public boolean allTrue() {
            return VectorSupport.test(BT_overflow, Float16MaskMax.class, VECTOR_LANE_TYPE_SHORT, VLENGTH,
                                      this, vspecies().maskAll(true),
        ...
        static Float16MaskMax maskAll(boolean bit) {
            return VectorSupport.fromBitsCoerced(Float16MaskMax.class, VECTOR_LANE_TYPE_SHORT, VLENGTH,
