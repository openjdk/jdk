...
final class LongVector128 extends LongVector {
    ...
    @ForceInline
    final @Override
    LongVector128 sOp(FSnOp f) {
        return (LongVector128) super.sOpTemplate(f);  // specialize
    }

    @ForceInline
    final @Override
    LongVector128 sOp(VectorMask<Long> m, FSnOp f) {
        return (LongVector128)
            super.sOpTemplate((LongMask128)m, f);  // specialize
    }
    ...
    static final class LongMask128 extends AbstractMask<Long> {
        ...
        LongMask128 indexPartiallyInUpperRange(long offset, long limit) {
            return (LongMask128) VectorSupport.indexPartiallyInUpperRange(
                LongMask128.class, VECTOR_LANE_TYPE_LONG, VLENGTH, offset, limit,
        ...
        public LongMask128 compress() {
            return (LongMask128)VectorSupport.compressExpandOp(VectorSupport.VECTOR_OP_MASK_COMPRESS,
                LongVector128.class, LongMask128.class, VECTOR_LANE_TYPE_LONG, VLENGTH, null, this,
        ...
        public LongMask128 and(VectorMask<Long> mask) {
            ...
            return VectorSupport.binaryOp(VECTOR_OP_AND, LongMask128.class, null, VECTOR_LANE_TYPE_LONG, VLENGTH,
                                          this, m, null,
        ...
        public LongMask128 or(VectorMask<Long> mask) {
            Objects.requireNonNull(mask);
            LongMask128 m = (LongMask128)mask;
            return VectorSupport.binaryOp(VECTOR_OP_OR, LongMask128.class, null, VECTOR_LANE_TYPE_LONG, VLENGTH,
                                          this, m, null,
                                          (m1, m2, vm) -> m1.bOp(m2, (i, a, b) -> a | b));
        }
        ...
        public LongMask128 xor(VectorMask<Long> mask) {
            Objects.requireNonNull(mask);
            LongMask128 m = (LongMask128)mask;
            return VectorSupport.binaryOp(VECTOR_OP_XOR, LongMask128.class, null, VECTOR_LANE_TYPE_LONG, VLENGTH,
                                          this, m, null,
                                          (m1, m2, vm) -> m1.bOp(m2, (i, a, b) -> a ^ b));
        }
        ...
        public int trueCount() {
            return (int) VectorSupport.maskReductionCoerced(VECTOR_OP_MASK_TRUECOUNT, LongMask128.class, VECTOR_LANE_TYPE_LONG,
                                                            VLENGTH, this,
        ...
        public int firstTrue() {
            return (int) VectorSupport.maskReductionCoerced(VECTOR_OP_MASK_FIRSTTRUE, LongMask128.class, VECTOR_LANE_TYPE_LONG,
                                                            VLENGTH, this,
        ...
        @ForceInline
        public int lastTrue() {
            return (int) VectorSupport.maskReductionCoerced(VECTOR_OP_MASK_LASTTRUE, LongMask128.class, VECTOR_LANE_TYPE_LONG,
                                                            VLENGTH, this,
        ...
        public long toLong() {
            ...
            return VectorSupport.maskReductionCoerced(VECTOR_OP_MASK_TOLONG, LongMask128.class, VECTOR_LANE_TYPE_LONG,
                                                      VLENGTH, this,
        ...
        public boolean laneIsSet(int i) {
            ...
            return VectorSupport.extract(LongMask128.class, VECTOR_LANE_TYPE_LONG, VLENGTH,
        ...
        public boolean anyTrue() {
            return VectorSupport.test(BT_ne, LongMask128.class, VECTOR_LANE_TYPE_LONG, VLENGTH,
        ...
        public boolean allTrue() {
            return VectorSupport.test(BT_overflow, LongMask128.class, VECTOR_LANE_TYPE_LONG, VLENGTH,
                                      this, vspecies().maskAll(true),
        ...
        static LongMask128 maskAll(boolean bit) {
            return VectorSupport.fromBitsCoerced(LongMask128.class, VECTOR_LANE_TYPE_LONG, VLENGTH,
