    ...
    static final class FloatMaskMax extends AbstractMask<Float> {
        ...
        FloatMaskMax indexPartiallyInUpperRange(long offset, long limit) {
            return (FloatMaskMax) VectorSupport.indexPartiallyInUpperRange(
                FloatMaskMax.class, VECTOR_LANE_TYPE_FLOAT, VLENGTH, offset, limit,
        ...
        public FloatMaskMax compress() {
            return (FloatMaskMax)VectorSupport.compressExpandOp(VectorSupport.VECTOR_OP_MASK_COMPRESS,
                FloatVectorMax.class, FloatMaskMax.class, VECTOR_LANE_TYPE_FLOAT, VLENGTH, null, this,
        ...
        public FloatMaskMax and(VectorMask<Float> mask) {
            ...
            return VectorSupport.binaryOp(VECTOR_OP_AND, FloatMaskMax.class, null, VECTOR_LANE_TYPE_INT, VLENGTH,
                                          this, m, null,
        ...
        public FloatMaskMax or(VectorMask<Float> mask) {
            Objects.requireNonNull(mask);
            FloatMaskMax m = (FloatMaskMax)mask;
            return VectorSupport.binaryOp(VECTOR_OP_OR, FloatMaskMax.class, null, VECTOR_LANE_TYPE_INT, VLENGTH,
                                          this, m, null,
                                          (m1, m2, vm) -> m1.bOp(m2, (i, a, b) -> a | b));
        }
        ...
        public FloatMaskMax xor(VectorMask<Float> mask) {
            Objects.requireNonNull(mask);
            FloatMaskMax m = (FloatMaskMax)mask;
            return VectorSupport.binaryOp(VECTOR_OP_XOR, FloatMaskMax.class, null, VECTOR_LANE_TYPE_INT, VLENGTH,
                                          this, m, null,
                                          (m1, m2, vm) -> m1.bOp(m2, (i, a, b) -> a ^ b));
        }
        ...
        public int trueCount() {
            return (int) VectorSupport.maskReductionCoerced(VECTOR_OP_MASK_TRUECOUNT, FloatMaskMax.class, VECTOR_LANE_TYPE_INT,
                                                            VLENGTH, this,
        ...
        public int firstTrue() {
            return (int) VectorSupport.maskReductionCoerced(VECTOR_OP_MASK_FIRSTTRUE, FloatMaskMax.class, VECTOR_LANE_TYPE_INT,
                                                            VLENGTH, this,
        ...
        @ForceInline
        public int lastTrue() {
            return (int) VectorSupport.maskReductionCoerced(VECTOR_OP_MASK_LASTTRUE, FloatMaskMax.class, VECTOR_LANE_TYPE_INT,
                                                            VLENGTH, this,
        ...
        public long toLong() {
            ...
            return VectorSupport.maskReductionCoerced(VECTOR_OP_MASK_TOLONG, FloatMaskMax.class, VECTOR_LANE_TYPE_INT,
                                                      VLENGTH, this,
        ...
        public boolean laneIsSet(int i) {
            ...
            return VectorSupport.extract(FloatMaskMax.class, VECTOR_LANE_TYPE_FLOAT, VLENGTH,
        ...
        public boolean anyTrue() {
            return VectorSupport.test(BT_ne, FloatMaskMax.class, VECTOR_LANE_TYPE_INT, VLENGTH,
        ...
        public boolean allTrue() {
            return VectorSupport.test(BT_overflow, FloatMaskMax.class, VECTOR_LANE_TYPE_INT, VLENGTH,
                                      this, vspecies().maskAll(true),
        ...
        static FloatMaskMax maskAll(boolean bit) {
            return VectorSupport.fromBitsCoerced(FloatMaskMax.class, VECTOR_LANE_TYPE_INT, VLENGTH,
