    ...
    static final class ShortMask256 extends AbstractMask<Short> {
        ...
        ShortMask256 indexPartiallyInUpperRange(long offset, long limit) {
            return (ShortMask256) VectorSupport.indexPartiallyInUpperRange(
                ShortMask256.class, VECTOR_LANE_TYPE_SHORT, VLENGTH, offset, limit,
        ...
        public ShortMask256 compress() {
            return (ShortMask256)VectorSupport.compressExpandOp(VectorSupport.VECTOR_OP_MASK_COMPRESS,
                ShortVector256.class, ShortMask256.class, VECTOR_LANE_TYPE_SHORT, VLENGTH, null, this,
        ...
        public ShortMask256 and(VectorMask<Short> mask) {
            ...
            return VectorSupport.binaryOp(VECTOR_OP_AND, ShortMask256.class, null, VECTOR_LANE_TYPE_SHORT, VLENGTH,
                                          this, m, null,
        ...
        public ShortMask256 or(VectorMask<Short> mask) {
            Objects.requireNonNull(mask);
            ShortMask256 m = (ShortMask256)mask;
            return VectorSupport.binaryOp(VECTOR_OP_OR, ShortMask256.class, null, VECTOR_LANE_TYPE_SHORT, VLENGTH,
                                          this, m, null,
                                          (m1, m2, vm) -> m1.bOp(m2, (i, a, b) -> a | b));
        }
        ...
        public ShortMask256 xor(VectorMask<Short> mask) {
            Objects.requireNonNull(mask);
            ShortMask256 m = (ShortMask256)mask;
            return VectorSupport.binaryOp(VECTOR_OP_XOR, ShortMask256.class, null, VECTOR_LANE_TYPE_SHORT, VLENGTH,
                                          this, m, null,
                                          (m1, m2, vm) -> m1.bOp(m2, (i, a, b) -> a ^ b));
        }
        ...
        public int trueCount() {
            return (int) VectorSupport.maskReductionCoerced(VECTOR_OP_MASK_TRUECOUNT, ShortMask256.class, VECTOR_LANE_TYPE_SHORT,
                                                            VLENGTH, this,
        ...
        public int firstTrue() {
            return (int) VectorSupport.maskReductionCoerced(VECTOR_OP_MASK_FIRSTTRUE, ShortMask256.class, VECTOR_LANE_TYPE_SHORT,
                                                            VLENGTH, this,
        ...
        @ForceInline
        public int lastTrue() {
            return (int) VectorSupport.maskReductionCoerced(VECTOR_OP_MASK_LASTTRUE, ShortMask256.class, VECTOR_LANE_TYPE_SHORT,
                                                            VLENGTH, this,
        ...
        public long toLong() {
            ...
            return VectorSupport.maskReductionCoerced(VECTOR_OP_MASK_TOLONG, ShortMask256.class, VECTOR_LANE_TYPE_SHORT,
                                                      VLENGTH, this,
        ...
        public boolean laneIsSet(int i) {
            ...
            return VectorSupport.extract(ShortMask256.class, VECTOR_LANE_TYPE_SHORT, VLENGTH,
        ...
        public boolean anyTrue() {
            return VectorSupport.test(BT_ne, ShortMask256.class, VECTOR_LANE_TYPE_SHORT, VLENGTH,
        ...
        public boolean allTrue() {
            return VectorSupport.test(BT_overflow, ShortMask256.class, VECTOR_LANE_TYPE_SHORT, VLENGTH,
                                      this, vspecies().maskAll(true),
        ...
        static ShortMask256 maskAll(boolean bit) {
            return VectorSupport.fromBitsCoerced(ShortMask256.class, VECTOR_LANE_TYPE_SHORT, VLENGTH,
