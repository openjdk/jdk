    ...
    static final class ByteMask256 extends AbstractMask<Byte> {
        ...
        ByteMask256 indexPartiallyInUpperRange(long offset, long limit) {
            return (ByteMask256) VectorSupport.indexPartiallyInUpperRange(
                ByteMask256.class, VECTOR_LANE_TYPE_BYTE, VLENGTH, offset, limit,
        ...
        public ByteMask256 compress() {
            return (ByteMask256)VectorSupport.compressExpandOp(VectorSupport.VECTOR_OP_MASK_COMPRESS,
                ByteVector256.class, ByteMask256.class, VECTOR_LANE_TYPE_BYTE, VLENGTH, null, this,
        ...
        public ByteMask256 and(VectorMask<Byte> mask) {
            ...
            return VectorSupport.binaryOp(VECTOR_OP_AND, ByteMask256.class, null, VECTOR_LANE_TYPE_BYTE, VLENGTH,
                                          this, m, null,
        ...
        public ByteMask256 or(VectorMask<Byte> mask) {
            Objects.requireNonNull(mask);
            ByteMask256 m = (ByteMask256)mask;
            return VectorSupport.binaryOp(VECTOR_OP_OR, ByteMask256.class, null, VECTOR_LANE_TYPE_BYTE, VLENGTH,
                                          this, m, null,
                                          (m1, m2, vm) -> m1.bOp(m2, (i, a, b) -> a | b));
        }
        ...
        public ByteMask256 xor(VectorMask<Byte> mask) {
            Objects.requireNonNull(mask);
            ByteMask256 m = (ByteMask256)mask;
            return VectorSupport.binaryOp(VECTOR_OP_XOR, ByteMask256.class, null, VECTOR_LANE_TYPE_BYTE, VLENGTH,
                                          this, m, null,
                                          (m1, m2, vm) -> m1.bOp(m2, (i, a, b) -> a ^ b));
        }
        ...
        public int trueCount() {
            return (int) VectorSupport.maskReductionCoerced(VECTOR_OP_MASK_TRUECOUNT, ByteMask256.class, VECTOR_LANE_TYPE_BYTE,
                                                            VLENGTH, this,
        ...
        public int firstTrue() {
            return (int) VectorSupport.maskReductionCoerced(VECTOR_OP_MASK_FIRSTTRUE, ByteMask256.class, VECTOR_LANE_TYPE_BYTE,
                                                            VLENGTH, this,
        ...
        @ForceInline
        public int lastTrue() {
            return (int) VectorSupport.maskReductionCoerced(VECTOR_OP_MASK_LASTTRUE, ByteMask256.class, VECTOR_LANE_TYPE_BYTE,
                                                            VLENGTH, this,
        ...
        public long toLong() {
            ...
            return VectorSupport.maskReductionCoerced(VECTOR_OP_MASK_TOLONG, ByteMask256.class, VECTOR_LANE_TYPE_BYTE,
                                                      VLENGTH, this,
        ...
        public boolean laneIsSet(int i) {
            ...
            return VectorSupport.extract(ByteMask256.class, VECTOR_LANE_TYPE_BYTE, VLENGTH,
        ...
        public boolean anyTrue() {
            return VectorSupport.test(BT_ne, ByteMask256.class, VECTOR_LANE_TYPE_BYTE, VLENGTH,
        ...
        public boolean allTrue() {
            return VectorSupport.test(BT_overflow, ByteMask256.class, VECTOR_LANE_TYPE_BYTE, VLENGTH,
                                      this, vspecies().maskAll(true),
        ...
        static ByteMask256 maskAll(boolean bit) {
            return VectorSupport.fromBitsCoerced(ByteMask256.class, VECTOR_LANE_TYPE_BYTE, VLENGTH,
