...
final class FloatVector256 extends FloatVector {
    ...
    @ForceInline
    final @Override
    FloatVector256 sOp(FSnOp f) {
        return (FloatVector256) super.sOpTemplate(f);  // specialize
    }

    @ForceInline
    final @Override
    FloatVector256 sOp(VectorMask<Float> m, FSnOp f) {
        return (FloatVector256)
            super.sOpTemplate((FloatMask256)m, f);  // specialize
    }
    ...
    static final class FloatMask256 extends AbstractMask<Float> {
        ...
        FloatMask256 indexPartiallyInUpperRange(long offset, long limit) {
            return (FloatMask256) VectorSupport.indexPartiallyInUpperRange(
                FloatMask256.class, VECTOR_LANE_TYPE_FLOAT, VLENGTH, offset, limit,
        ...
        public FloatMask256 compress() {
            return (FloatMask256)VectorSupport.compressExpandOp(VectorSupport.VECTOR_OP_MASK_COMPRESS,
                FloatVector256.class, FloatMask256.class, VECTOR_LANE_TYPE_FLOAT, VLENGTH, null, this,
        ...
        public FloatMask256 and(VectorMask<Float> mask) {
            ...
            return VectorSupport.binaryOp(VECTOR_OP_AND, FloatMask256.class, null, VECTOR_LANE_TYPE_INT, VLENGTH,
                                          this, m, null,
        ...
        public FloatMask256 or(VectorMask<Float> mask) {
            Objects.requireNonNull(mask);
            FloatMask256 m = (FloatMask256)mask;
            return VectorSupport.binaryOp(VECTOR_OP_OR, FloatMask256.class, null, VECTOR_LANE_TYPE_INT, VLENGTH,
                                          this, m, null,
                                          (m1, m2, vm) -> m1.bOp(m2, (i, a, b) -> a | b));
        }
        ...
        public FloatMask256 xor(VectorMask<Float> mask) {
            Objects.requireNonNull(mask);
            FloatMask256 m = (FloatMask256)mask;
            return VectorSupport.binaryOp(VECTOR_OP_XOR, FloatMask256.class, null, VECTOR_LANE_TYPE_INT, VLENGTH,
                                          this, m, null,
                                          (m1, m2, vm) -> m1.bOp(m2, (i, a, b) -> a ^ b));
        }
        ...
        public int trueCount() {
            return (int) VectorSupport.maskReductionCoerced(VECTOR_OP_MASK_TRUECOUNT, FloatMask256.class, VECTOR_LANE_TYPE_INT,
                                                            VLENGTH, this,
        ...
        public int firstTrue() {
            return (int) VectorSupport.maskReductionCoerced(VECTOR_OP_MASK_FIRSTTRUE, FloatMask256.class, VECTOR_LANE_TYPE_INT,
                                                            VLENGTH, this,
        ...
        @ForceInline
        public int lastTrue() {
            return (int) VectorSupport.maskReductionCoerced(VECTOR_OP_MASK_LASTTRUE, FloatMask256.class, VECTOR_LANE_TYPE_INT,
                                                            VLENGTH, this,
        ...
        public long toLong() {
            ...
            return VectorSupport.maskReductionCoerced(VECTOR_OP_MASK_TOLONG, FloatMask256.class, VECTOR_LANE_TYPE_INT,
                                                      VLENGTH, this,
        ...
        public boolean laneIsSet(int i) {
            ...
            return VectorSupport.extract(FloatMask256.class, VECTOR_LANE_TYPE_FLOAT, VLENGTH,
        ...
        public boolean anyTrue() {
            return VectorSupport.test(BT_ne, FloatMask256.class, VECTOR_LANE_TYPE_INT, VLENGTH,
        ...
        public boolean allTrue() {
            return VectorSupport.test(BT_overflow, FloatMask256.class, VECTOR_LANE_TYPE_INT, VLENGTH,
                                      this, vspecies().maskAll(true),
        ...
        static FloatMask256 maskAll(boolean bit) {
            return VectorSupport.fromBitsCoerced(FloatMask256.class, VECTOR_LANE_TYPE_INT, VLENGTH,
