...
public abstract class ByteVector extends AbstractVector<Byte> {
    ...
    public static ByteVector zero(VectorSpecies<Byte> species) {
        ...
        return VectorSupport.fromBitsCoerced(vsp.vectorType(), VECTOR_LANE_TYPE_BYTE, species.length(),
    ...
    ByteVector lanewiseTemplate(VectorOperators.Unary op) {
        ...
        return VectorSupport.unaryOp(
            opc, getClass(), null, VECTOR_LANE_TYPE_BYTE, length(),
            this, null,
    ...
    ByteVector lanewiseTemplate(VectorOperators.Unary op,
        ...
        int opc = opCode(op);
        return VectorSupport.unaryOp(
            opc, getClass(), maskClass, VECTOR_LANE_TYPE_BYTE, length(),
            this, m,
            UN_IMPL.find(op, opc, ByteVector::unaryOperations));
    }
    ...
    M compareTemplate(Class<M> maskType, Comparison op, Vector<Byte> v) {
        ...
        return VectorSupport.compare(
            opc, getClass(), maskType, VECTOR_LANE_TYPE_BYTE, length(),
            this, that, null,
            (cond, v0, v1, m1) -> {
                AbstractMask<Byte> m
    ...
    blendTemplate(Class<M> maskType, ByteVector v, M m) {
        ...
        return VectorSupport.blend(
            getClass(), maskType, VECTOR_LANE_TYPE_BYTE, length(),
            this, v, m,
    ...
    final ByteVector addIndexTemplate(int scale) {
        ...
        return VectorSupport.indexVector(
            getClass(), VECTOR_LANE_TYPE_BYTE, length(),
            this, scale, vsp,
            (v, scale_, s)
            -> {
    ...
    ByteVector rearrangeTemplate(Class<S> shuffletype, S shuffle) {
        ...
        return VectorSupport.rearrangeOp(
            getClass(), shuffletype, null, VECTOR_LANE_TYPE_BYTE, length(),
            this, shuffle, null,
            (v1, s_, m_) -> v1.sOp((i, a) -> {
    ...
    ByteVector rearrangeTemplate(Class<S> shuffletype,
        ...
        m.check(masktype, this);
        return VectorSupport.rearrangeOp(
                   getClass(), shuffletype, masktype, VECTOR_LANE_TYPE_BYTE, length(),
                   this, shuffle, m,
                   (v1, s_, m_) -> v1.sOp((i, a) -> {
                        int ei = Integer.remainderUnsigned(s_.laneSource(i), v1.length());
    ...
    ByteVector compressTemplate(Class<M> masktype, M m) {
      ...
      return (ByteVector) VectorSupport.compressExpandOp(VectorSupport.VECTOR_OP_COMPRESS, getClass(), masktype,
                                                        VECTOR_LANE_TYPE_BYTE, length(), this, m,
    ...
    final ByteVector selectFromTemplate(ByteVector v) {
        return (ByteVector)VectorSupport.selectFromOp(getClass(), null, VECTOR_LANE_TYPE_BYTE,
                                                        length(), this, v, null,
                                                        (v1, v2, _m) ->
    ...
    ByteVector selectFromTemplate(ByteVector v,
        ...
        m.check(masktype, this);
        return (ByteVector)VectorSupport.selectFromOp(getClass(), masktype, VECTOR_LANE_TYPE_BYTE,
                                                        length(), this, v, m,
                                                        (v1, v2, _m) ->
    ...
    final ByteVector selectFromTemplate(ByteVector v1, ByteVector v2) {
        return VectorSupport.selectFromTwoVectorOp(getClass(), VECTOR_LANE_TYPE_BYTE, length(), this, v1, v2,
    ...
    ByteVector fromArray(VectorSpecies<Byte> species,
        ...
        return VectorSupport.loadWithMap(
            vectorType, null, VECTOR_LANE_TYPE_BYTE, vsp.laneCount(),
    ...
    void intoArray(byte[] a, int offset) {
        ...
        ByteSpecies vsp = vspecies();
        VectorSupport.store(
            vsp.vectorType(), VECTOR_LANE_TYPE_BYTE, vsp.laneCount(),
    ...
    ByteVector fromArray0Template(Class<M> maskClass, byte[] a, int offset, M m, int offsetInRange) {
        ...
        return VectorSupport.loadMasked(
            vsp.vectorType(), maskClass, VECTOR_LANE_TYPE_BYTE, vsp.laneCount(),
    ...
    ByteVector fromArray0Template(Class<M> maskClass, byte[] a, int offset,
        ...
        return VectorSupport.loadWithMap(
            vectorType, maskClass, VECTOR_LANE_TYPE_BYTE, vsp.laneCount(),
            lsp.vectorType(), lsp.length(),
        ...
        final ByteVector broadcastBits(long bits) {
            return (ByteVector)
                VectorSupport.fromBitsCoerced(
                    vectorType, VECTOR_LANE_TYPE_BYTE, laneCount,
