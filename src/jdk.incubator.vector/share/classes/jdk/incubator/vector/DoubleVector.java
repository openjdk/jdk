...
public abstract class DoubleVector extends AbstractVector<Double> {
    ...
    /*package-private*/
    abstract
    DoubleVector sOp(FSnOp f);
    @ForceInline
    final
    DoubleVector sOpTemplate(FSnOp f) {
        double[] vec = vec();
        double[] res = new double[length()];
        for (int i = 0; i < res.length; i++) {
            res[i] = f.apply(i, vec[i]);
    ...
    /*package-private*/
    abstract
    DoubleVector sOp(VectorMask<Double> m,
                             FSnOp f);
    @ForceInline
    final
    DoubleVector sOpTemplate(VectorMask<Double> m,
                                     FSnOp f) {
        if (m == null) {
    ...
    public static DoubleVector zero(VectorSpecies<Double> species) {
        ...
        return VectorSupport.fromBitsCoerced(vsp.vectorType(), VECTOR_LANE_TYPE_DOUBLE, species.length(),
    ...
    DoubleVector lanewiseTemplate(VectorOperators.Unary op) {
        ...
        return VectorSupport.unaryOp(
            opc, getClass(), null, VECTOR_LANE_TYPE_DOUBLE, length(),
            this, null,
    ...
    DoubleVector lanewiseTemplate(VectorOperators.Unary op,
        ...
        int opc = opCode(op);
        return VectorSupport.unaryOp(
            opc, getClass(), maskClass, VECTOR_LANE_TYPE_DOUBLE, length(),
            this, m,
            UN_IMPL.find(op, opc, DoubleVector::unaryOperations));
    }
    ...
    M compareTemplate(Class<M> maskType, Comparison op, Vector<Double> v) {
        ...
        return VectorSupport.compare(
            opc, getClass(), maskType, VECTOR_LANE_TYPE_DOUBLE, length(),
            this, that, null,
            (cond, v0, v1, m1) -> {
    ...
    blendTemplate(Class<M> maskType, DoubleVector v, M m) {
        ...
        return VectorSupport.blend(
            getClass(), maskType, VECTOR_LANE_TYPE_DOUBLE, length(),
            this, v, m,
    ...
    final DoubleVector addIndexTemplate(int scale) {
        ...
        return VectorSupport.indexVector(
            getClass(), VECTOR_LANE_TYPE_DOUBLE, length(),
            this, scale, vsp,
            (v, scale_, s)
            -> {
    ...
    DoubleVector rearrangeTemplate(Class<S> shuffletype, S shuffle) {
        ...
        return VectorSupport.rearrangeOp(
            getClass(), shuffletype, null, VECTOR_LANE_TYPE_DOUBLE, length(),
            this, shuffle, null,
            (v1, s_, m_) -> v1.sOp((i, a) -> {
    ...
    DoubleVector rearrangeTemplate(Class<S> shuffletype,
        ...
        m.check(masktype, this);
        return VectorSupport.rearrangeOp(
                   getClass(), shuffletype, masktype, VECTOR_LANE_TYPE_DOUBLE, length(),
                   this, shuffle, m,
                   (v1, s_, m_) -> v1.sOp((i, a) -> {
                        int ei = Integer.remainderUnsigned(s_.laneSource(i), v1.length());
    ...
    DoubleVector compressTemplate(Class<M> masktype, M m) {
      ...
      return (DoubleVector) VectorSupport.compressExpandOp(VectorSupport.VECTOR_OP_COMPRESS, getClass(), masktype,
                                                        VECTOR_LANE_TYPE_DOUBLE, length(), this, m,
    ...
    final DoubleVector selectFromTemplate(DoubleVector v) {
        return (DoubleVector)VectorSupport.selectFromOp(getClass(), null, VECTOR_LANE_TYPE_DOUBLE,
                                                        length(), this, v, null,
                                                        (v1, v2, _m) ->
    ...
    DoubleVector selectFromTemplate(DoubleVector v,
        ...
        m.check(masktype, this);
        return (DoubleVector)VectorSupport.selectFromOp(getClass(), masktype, VECTOR_LANE_TYPE_DOUBLE,
                                                        length(), this, v, m,
                                                        (v1, v2, _m) ->
    ...
    final DoubleVector selectFromTemplate(DoubleVector v1, DoubleVector v2) {
        return VectorSupport.selectFromTwoVectorOp(getClass(), VECTOR_LANE_TYPE_DOUBLE, length(), this, v1, v2,
    ...
    DoubleVector fromArray(VectorSpecies<Double> species,
        ...
        return VectorSupport.loadWithMap(
            vectorType, null, VECTOR_LANE_TYPE_DOUBLE, vsp.laneCount(),
    ...
    void intoArray(double[] a, int offset) {
        ...
        DoubleSpecies vsp = vspecies();
        VectorSupport.store(
            vsp.vectorType(), VECTOR_LANE_TYPE_DOUBLE, vsp.laneCount(),
    ...
    void intoArray(double[] a, int offset,
        ...
        VectorSupport.storeWithMap(
            vsp.vectorType(), null, VECTOR_LANE_TYPE_DOUBLE, vsp.laneCount(),
            isp.vectorType(), isp.length(),
    ...
    DoubleVector fromArray0Template(Class<M> maskClass, double[] a, int offset, M m, int offsetInRange) {
        ...
        return VectorSupport.loadMasked(
            vsp.vectorType(), maskClass, VECTOR_LANE_TYPE_DOUBLE, vsp.laneCount(),
    ...
    DoubleVector fromArray0Template(Class<M> maskClass, double[] a, int offset,
        ...
        return VectorSupport.loadWithMap(
            vectorType, maskClass, VECTOR_LANE_TYPE_DOUBLE, vsp.laneCount(),
            isp.vectorType(), isp.length(),
    ...
    static final class DoubleSpecies extends AbstractSpecies<Double> {
        ...
        final int laneBasicType() {
            return VECTOR_LANE_TYPE_DOUBLE;
        }
        ...
        final DoubleVector broadcastBits(long bits) {
            return (DoubleVector)
                VectorSupport.fromBitsCoerced(
                    vectorType, VECTOR_LANE_TYPE_DOUBLE, laneCount,
