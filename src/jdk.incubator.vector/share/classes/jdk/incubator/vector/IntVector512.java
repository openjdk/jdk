...
final class IntVector512 extends IntVector {
    ...
    @ForceInline
    final @Override
    IntVector512 sOp(FSnOp f) {
        return (IntVector512) super.sOpTemplate(f);  // specialize
    }

    @ForceInline
    final @Override
    IntVector512 sOp(VectorMask<Integer> m, FSnOp f) {
        return (IntVector512)
            super.sOpTemplate((IntMask512)m, f);  // specialize
    }
    ...
    static final class IntMask512 extends AbstractMask<Integer> {
        ...
        IntMask512 indexPartiallyInUpperRange(long offset, long limit) {
            return (IntMask512) VectorSupport.indexPartiallyInUpperRange(
                IntMask512.class, VECTOR_LANE_TYPE_INT, VLENGTH, offset, limit,
        ...
        public IntMask512 compress() {
            return (IntMask512)VectorSupport.compressExpandOp(VectorSupport.VECTOR_OP_MASK_COMPRESS,
                IntVector512.class, IntMask512.class, VECTOR_LANE_TYPE_INT, VLENGTH, null, this,
        ...
        public IntMask512 and(VectorMask<Integer> mask) {
            ...
            return VectorSupport.binaryOp(VECTOR_OP_AND, IntMask512.class, null, VECTOR_LANE_TYPE_INT, VLENGTH,
                                          this, m, null,
        ...
        public IntMask512 or(VectorMask<Integer> mask) {
            Objects.requireNonNull(mask);
            IntMask512 m = (IntMask512)mask;
            return VectorSupport.binaryOp(VECTOR_OP_OR, IntMask512.class, null, VECTOR_LANE_TYPE_INT, VLENGTH,
                                          this, m, null,
                                          (m1, m2, vm) -> m1.bOp(m2, (i, a, b) -> a | b));
        }
        ...
        public IntMask512 xor(VectorMask<Integer> mask) {
            Objects.requireNonNull(mask);
            IntMask512 m = (IntMask512)mask;
            return VectorSupport.binaryOp(VECTOR_OP_XOR, IntMask512.class, null, VECTOR_LANE_TYPE_INT, VLENGTH,
                                          this, m, null,
                                          (m1, m2, vm) -> m1.bOp(m2, (i, a, b) -> a ^ b));
        }
        ...
        public int trueCount() {
            return (int) VectorSupport.maskReductionCoerced(VECTOR_OP_MASK_TRUECOUNT, IntMask512.class, VECTOR_LANE_TYPE_INT,
                                                            VLENGTH, this,
        ...
        public int firstTrue() {
            return (int) VectorSupport.maskReductionCoerced(VECTOR_OP_MASK_FIRSTTRUE, IntMask512.class, VECTOR_LANE_TYPE_INT,
                                                            VLENGTH, this,
        ...
        @ForceInline
        public int lastTrue() {
            return (int) VectorSupport.maskReductionCoerced(VECTOR_OP_MASK_LASTTRUE, IntMask512.class, VECTOR_LANE_TYPE_INT,
                                                            VLENGTH, this,
        ...
        public long toLong() {
            ...
            return VectorSupport.maskReductionCoerced(VECTOR_OP_MASK_TOLONG, IntMask512.class, VECTOR_LANE_TYPE_INT,
                                                      VLENGTH, this,
        ...
        public boolean laneIsSet(int i) {
            ...
            return VectorSupport.extract(IntMask512.class, VECTOR_LANE_TYPE_INT, VLENGTH,
        ...
        public boolean anyTrue() {
            return VectorSupport.test(BT_ne, IntMask512.class, VECTOR_LANE_TYPE_INT, VLENGTH,
        ...
        public boolean allTrue() {
            return VectorSupport.test(BT_overflow, IntMask512.class, VECTOR_LANE_TYPE_INT, VLENGTH,
                                      this, vspecies().maskAll(true),
        ...
        static IntMask512 maskAll(boolean bit) {
            return VectorSupport.fromBitsCoerced(IntMask512.class, VECTOR_LANE_TYPE_INT, VLENGTH,
