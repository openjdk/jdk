...
final class ByteVector512 extends ByteVector {
    ...
    @ForceInline
    final @Override
    ByteVector512 sOp(FSnOp f) {
        return (ByteVector512) super.sOpTemplate(f);  // specialize
    }

    @ForceInline
    final @Override
    ByteVector512 sOp(VectorMask<Byte> m, FSnOp f) {
        return (ByteVector512)
            super.sOpTemplate((ByteMask512)m, f);  // specialize
    }
    ...
    static final class ByteMask512 extends AbstractMask<Byte> {
        ...
        ByteMask512 indexPartiallyInUpperRange(long offset, long limit) {
            return (ByteMask512) VectorSupport.indexPartiallyInUpperRange(
                ByteMask512.class, VECTOR_LANE_TYPE_BYTE, VLENGTH, offset, limit,
        ...
        public ByteMask512 compress() {
            return (ByteMask512)VectorSupport.compressExpandOp(VectorSupport.VECTOR_OP_MASK_COMPRESS,
                ByteVector512.class, ByteMask512.class, VECTOR_LANE_TYPE_BYTE, VLENGTH, null, this,
        ...
        public ByteMask512 and(VectorMask<Byte> mask) {
            ...
            return VectorSupport.binaryOp(VECTOR_OP_AND, ByteMask512.class, null, VECTOR_LANE_TYPE_BYTE, VLENGTH,
                                          this, m, null,
        ...
        public ByteMask512 or(VectorMask<Byte> mask) {
            Objects.requireNonNull(mask);
            ByteMask512 m = (ByteMask512)mask;
            return VectorSupport.binaryOp(VECTOR_OP_OR, ByteMask512.class, null, VECTOR_LANE_TYPE_BYTE, VLENGTH,
                                          this, m, null,
                                          (m1, m2, vm) -> m1.bOp(m2, (i, a, b) -> a | b));
        }
        ...
        public ByteMask512 xor(VectorMask<Byte> mask) {
            Objects.requireNonNull(mask);
            ByteMask512 m = (ByteMask512)mask;
            return VectorSupport.binaryOp(VECTOR_OP_XOR, ByteMask512.class, null, VECTOR_LANE_TYPE_BYTE, VLENGTH,
                                          this, m, null,
                                          (m1, m2, vm) -> m1.bOp(m2, (i, a, b) -> a ^ b));
        }
        ...
        public int trueCount() {
            return (int) VectorSupport.maskReductionCoerced(VECTOR_OP_MASK_TRUECOUNT, ByteMask512.class, VECTOR_LANE_TYPE_BYTE,
                                                            VLENGTH, this,
        ...
        public int firstTrue() {
            return (int) VectorSupport.maskReductionCoerced(VECTOR_OP_MASK_FIRSTTRUE, ByteMask512.class, VECTOR_LANE_TYPE_BYTE,
                                                            VLENGTH, this,
        ...
        @ForceInline
        public int lastTrue() {
            return (int) VectorSupport.maskReductionCoerced(VECTOR_OP_MASK_LASTTRUE, ByteMask512.class, VECTOR_LANE_TYPE_BYTE,
                                                            VLENGTH, this,
        ...
        public long toLong() {
            ...
            return VectorSupport.maskReductionCoerced(VECTOR_OP_MASK_TOLONG, ByteMask512.class, VECTOR_LANE_TYPE_BYTE,
                                                      VLENGTH, this,
        ...
        public boolean laneIsSet(int i) {
            ...
            return VectorSupport.extract(ByteMask512.class, VECTOR_LANE_TYPE_BYTE, VLENGTH,
        ...
        public boolean anyTrue() {
            return VectorSupport.test(BT_ne, ByteMask512.class, VECTOR_LANE_TYPE_BYTE, VLENGTH,
        ...
        public boolean allTrue() {
            return VectorSupport.test(BT_overflow, ByteMask512.class, VECTOR_LANE_TYPE_BYTE, VLENGTH,
                                      this, vspecies().maskAll(true),
        ...
        static ByteMask512 maskAll(boolean bit) {
            return VectorSupport.fromBitsCoerced(ByteMask512.class, VECTOR_LANE_TYPE_BYTE, VLENGTH,
