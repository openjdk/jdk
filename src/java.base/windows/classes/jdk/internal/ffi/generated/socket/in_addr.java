...
// Generated by jextract from modified structure definition
// to match other platforms. Binary form is kept the same,
// only union views are removed.
...
public final class in_addr {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            BindingUtils.C_LONG.withName("s_addr")
    ).withName("in_addr");
