...
public final class AESCrypt extends SymmetricCipher {
    ...
    void init(boolean decrypting, String algorithm, byte[] key)
        ...
        if (!Arrays.equals(prevKey, key)) {
            ...
            invExpandedKey = invGenRKeys(expandedKey, rounds, key, nk);
    ...
    private static byte invMix(byte s, byte mix) {
        switch(mix) {
            // Utilize lookup tables for for multiplication with constants to
    ...
    private int[] invGenRKeys(int[] w, int r, byte[] key, int nk) {
        int len = WB;
        int[] wM = new int[len];
