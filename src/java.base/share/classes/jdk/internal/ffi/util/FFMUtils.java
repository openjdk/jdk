...
public final class FFMUtils {
    ...
    // TODO: Anonymous class is used instead of lambda since the class can
    //  possibly be used early in the boot sequence.
    public static final SegmentAllocator SEGMENTS_ALLOCATOR = new SegmentAllocator() {
        @Override
