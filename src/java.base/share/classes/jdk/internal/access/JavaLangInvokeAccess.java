...
public interface JavaLangInvokeAccess {
    ...
    /**
     * Returns a method handle which gets the default read object method for
     * serialization.
     *
     * This method should only be used by ReflectionFactory::defaultReadObjectForSerialization.
     */
    MethodHandle defaultReadObjectForSerialization(Class<?> cl);

    /**
     * Returns a method handle which gets the default write object method for
     * serialization.
     *
     * This method should only be used by ReflectionFactory::defaultWriteObjectForSerialization.
     */
    MethodHandle defaultWriteObjectForSerialization(Class<?> cl);
}
