...
/**
 * This interface models the read operations of a {@linkplain BitSet}.
 *
 * @since 22
 */
// Todo: Come up with a better name.
public sealed interface BitSetReadOps
        extends Cloneable
        permits BitSet, BitSet.OfImmutable {
     ...
     * @since  1.4
     */
    BitSetReadOps get(int fromIndex, int toIndex);
     ...
     * @since  22
     */
    boolean intersects(BitSetReadOps set);
