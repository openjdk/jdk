...
public class Arrays {
     ...
     * @apiNote This method acts as bridge between array-based and collection-based
     ...
     * @apiNote Setting a subrange of an array, using a generator function to compute
     ...
     *                  value for that position
     * @throws NullPointerException if the generator is null
     * @apiNote Setting a subrange of an array, in parallel, using a generator function
     ...
     *                                        if {@code bFromIndex < 0 or bToIndex > b.length}
     * @throws NullPointerException           if either array is {@code null}
     * @apiNote <p>This method behaves as if (for non-{@code null} array elements):
     * <pre>{@code
     *     int i = Arrays.mismatch(a, aFromIndex, aToIndex,
     *                             b, bFromIndex, bToIndex);
     *     if (i >= 0 && i < Math.min(aToIndex - aFromIndex, bToIndex - bFromIndex))
     ...
     * This method modifies the input array in place and returns it.
     *
     * @param <T>   the type of elements in the array
     * @param array the array to be reversed
     * @return the input array with its elements reversed
