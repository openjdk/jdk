    ...
    implements Comparable<Charset>
{
    ...
    private static final Supplier<List<CharsetProvider>> EXTENDED_PROVIDERS = Supplier.ofCaching(
    ...
    private static final Supplier<Charset> defaultCharset = Supplier.ofCaching(
    ...
    @Stable
    private final Supplier<Set<String>> aliasSet = Supplier.ofCaching(
