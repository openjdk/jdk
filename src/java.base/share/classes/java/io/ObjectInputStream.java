    ...
    extends InputStream implements ObjectInput, ObjectStreamConstants
{
    ...
    private final class FieldValues extends GetField {
        ...
        public boolean get(String name, boolean val) {
            ...
            return (off >= 0) ? BigEndian.getBoolean(primValues, off) : val;
        }
        ...
        public char get(String name, char val) {
            ...
            return (off >= 0) ? BigEndian.getChar(primValues, off) : val;
        }

        public short get(String name, short val) {
            int off = getFieldOffset(name, Short.TYPE);
            return (off >= 0) ? BigEndian.getShort(primValues, off) : val;
        }

        public int get(String name, int val) {
            int off = getFieldOffset(name, Integer.TYPE);
            return (off >= 0) ? BigEndian.getInt(primValues, off) : val;
        }

        public float get(String name, float val) {
            int off = getFieldOffset(name, Float.TYPE);
            return (off >= 0) ? BigEndian.getFloat(primValues, off) : val;
        }

        public long get(String name, long val) {
            int off = getFieldOffset(name, Long.TYPE);
            return (off >= 0) ? BigEndian.getLong(primValues, off) : val;
        }

        public double get(String name, double val) {
            int off = getFieldOffset(name, Double.TYPE);
            return (off >= 0) ? BigEndian.getDouble(primValues, off) : val;
        }
        ...
        extends InputStream implements DataInput
    {
                ...
                for (;;) {
                    ...
                    switch (tc) {
                        ...
                        case TC_BLOCKDATALONG:
                            ...
                            int len = BigEndian.getInt(hbuf, 1);
                            if (len < 0) {
                                throw new StreamCorruptedException(
        ...
        public char readChar() throws IOException {
            ...
            char v = BigEndian.getChar(buf, pos);
            pos += 2;
            return v;
        }
        ...
        public short readShort() throws IOException {
            ...
            short v = BigEndian.getShort(buf, pos);
            pos += 2;
            return v;
        }
        ...
        public int readUnsignedShort() throws IOException {
            ...
            int v = BigEndian.getShort(buf, pos) & 0xFFFF;
            pos += 2;
            return v;
        }
        ...
        public int readInt() throws IOException {
            ...
            int v = BigEndian.getInt(buf, pos);
            pos += 4;
            return v;
        }
        ...
        public float readFloat() throws IOException {
            ...
            float v = BigEndian.getFloat(buf, pos);
            pos += 4;
            return v;
        }
        ...
        public long readLong() throws IOException {
            ...
            long v = BigEndian.getLong(buf, pos);
            pos += 8;
            return v;
        }
        ...
        public double readDouble() throws IOException {
            ...
            double v = BigEndian.getDouble(buf, pos);
            pos += 8;
            return v;
        }
        ...
        void readBooleans(boolean[] v, int off, int len) throws IOException {
            ...
            while (off < endoff) {
                ...
                while (off < stop) {
                    v[off++] = BigEndian.getBoolean(buf, pos++);
                }
            }
        }
        ...
        void readChars(char[] v, int off, int len) throws IOException {
            ...
            while (off < endoff) {
                ...
                while (off < stop) {
                    v[off++] = BigEndian.getChar(buf, pos);
                    pos += 2;
                }
            }
        }
        ...
        void readShorts(short[] v, int off, int len) throws IOException {
            ...
            while (off < endoff) {
                ...
                while (off < stop) {
                    v[off++] = BigEndian.getShort(buf, pos);
                    pos += 2;
                }
            }
        }
        ...
        void readInts(int[] v, int off, int len) throws IOException {
            ...
            while (off < endoff) {
                ...
                while (off < stop) {
                    v[off++] = BigEndian.getInt(buf, pos);
                    pos += 4;
                }
            }
        }
        ...
        void readFloats(float[] v, int off, int len) throws IOException {
            ...
            while (off < endoff) {
                ...
                while (off < stop) {
                    v[off++] = BigEndian.getFloat(buf, pos);
                    pos += 4;
                }
            }
        }
        ...
        void readLongs(long[] v, int off, int len) throws IOException {
            ...
            while (off < endoff) {
                ...
                while (off < stop) {
                    v[off++] = BigEndian.getLong(buf, pos);
                    pos += 8;
                }
            }
        }
        ...
        void readDoubles(double[] v, int off, int len) throws IOException {
            ...
            while (off < endoff) {
                ...
                while (off < stop) {
                    v[off++] = BigEndian.getDouble(buf, pos);
                    pos += 8;
                }
            }
        }
