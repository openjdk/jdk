...
public final class Math {
     ...
     * @return  the [sine,cosine] pair for the argument.
     */
    public static double [] sincos_v1(double a) {
        double theSin;
        double theCos;
    ...
    static final class Sincos {
        ...
        static double [] __kernel_sincos(double x, double y, int iy) {
            double k_s;
            double k_c;
        ...
        static double [] compute(double x) {
            ...
            if(ix <= 0x3fe921fb) {
                ...
                double [] k = __kernel_sincos(y[0], y[1], 1);
                double k_s = k[0], k_c = k[1];
     ...
     * @return  the [sine,cosine] pair for the argument.
     */
    public static double [] sincos_v2(double a) {
        return Sincos.compute(a);
    }
}
