...
public sealed interface CharacterRangeInfo
     ...
     * <ul>
     * <li>{@link CharacterRange#CRT_STATEMENT} Range is a Statement
     ...
     * grammar.
     * <li>{@link CharacterRange#CRT_BLOCK} Range is a Block in the
     * grammar.
     * <li>{@link CharacterRange#CRT_ASSIGNMENT} Range is an assignment
     ...
     * <li>{@link CharacterRange#CRT_FLOW_CONTROLLER} An expression
     ...
     * </pre>
     * <li>{@link CharacterRange#CRT_FLOW_TARGET} Statement or
     ...
     * </pre>
     * <li>{@link CharacterRange#CRT_INVOKE} Method invocation. For
     * example: Identifier Arguments.
     * <li>{@link CharacterRange#CRT_CREATE} New object creation. For
     * example: new Creator.
     * <li>{@link CharacterRange#CRT_BRANCH_TRUE} A condition encoded
     ...
     * <li>{@link CharacterRange#CRT_BRANCH_FALSE} A condition encoded
     * in the branch instruction immediately contained in the code range for
