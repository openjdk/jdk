...
public final class Monotonics2a {
 ...
 //    * <ul>
 //    *     <li>{@linkplain Monotonic#computeIfAbsent(MethodHandle)}</li>
 //    *     <li>{@linkplain Monotonic#computeIfAbsent(Supplier)}</li>
 //    *     <li>{@linkplain Monotonic#putIfAbsent(Object)}</li>
 //    *     <li>{@linkplain Monotonic#put(Object)}
 //    * </ul>
 //    *
...
//
 ...
 //    */
 //   public static <V> Monotonic.List<V> ofList(Class<V> backingElementType,
 //                                              int size,
...
//
 //   /**
 //    * {@return a new immutable, lazy {@linkplain Monotonic.Map } with read-only
