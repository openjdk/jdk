...
class LambdaForm {
    ...
    enum Kind {
        ...
        FIELD_ACCESS_B("fieldAccess"),
        FIELD_ACCESS_INIT_B("fieldAccessInit"),
        VOLATILE_FIELD_ACCESS_B("volatileFieldAccess"),
        VOLATILE_FIELD_ACCESS_INIT_B("volatileFieldAccessInit"),
