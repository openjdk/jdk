 ...
 * @since 1.4
 */
public final class NetworkInterface2 {
     ...
     */
    // Todo: Remove `public`
    public NetworkInterface2(String name, int index, InetAddress[] addrs) {
     ...
     * @since 1.6
     */
    public Enumeration<NetworkInterface2> getSubInterfaces() {
     ...
     * @since 9
     */
    public Stream<NetworkInterface2> subInterfaces() {
     ...
     * @since 1.6
     */
    public NetworkInterface2 getParent() {
    ...
    public boolean equals(Object obj) {
        return obj instanceof NetworkInterface2 ni && delegate.equals(ni.delegate);
    }
     ...
     */
    public static NetworkInterface2 getByInetAddress(InetAddress addr) throws SocketException {
     ...
     */
    public static Enumeration<NetworkInterface2> getNetworkInterfaces() throws SocketException {
     ...
     * @since 9
     */
    public static Stream<NetworkInterface2> networkInterfaces() throws SocketException {
    ...
    private static final class NetworkInterfaceDelegate {
         ...
         * @see #networkInterfaces()
         */
        public static Enumeration<NetworkInterface2> getNetworkInterfaces()
                throws SocketException {
            NetworkInterface2[] netifs = NativeNetworkInterface.getAll();
         ...
         * @since 9
         */
        public static Stream<NetworkInterface2> networkInterfaces()
                throws SocketException {
            NetworkInterface2[] netifs = NativeNetworkInterface.getAll();
            if (netifs != null && netifs.length > 0) {
