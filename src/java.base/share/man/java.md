...
[`-agentlib:`]{#option-agentlib}*libname*\[`=`*options*\]
...
[`-agentpath:`]{#option-agentpath}*pathname*\[`=`*options*\]
...
[`--class-path`]{#option--class-path} *classpath*, `-classpath` *classpath*, or `-cp` *classpath*
...
[`--disable-@files`]{#option--disable-@files}
...
[`--enable-native-access`]{#option--enable-native-access} *module*\[`,`*module*...\]
...
[`--enable-final-field-mutation`]{#option--enable-final-field-mutation} *module*\[,*module*...\]
...
[`--finalization=`]{#option--finalization}*value*
...
[`--module-path`]{#option--module-path} *modulepath*... or `-p` *modulepath*
...
[`--upgrade-module-path`]{#option--upgrade-module-path} *modulepath*...
...
[`--list-modules`]{#option--list-modules}
:   Lists the observable modules and then exits.

[`-d`]{#option--describe-module} *module\_name* or `--describe-module` *module\_name*
...
[`-disableassertions`]{#option-disableassertions}\[`:`\[*packagename*\]...\|`:`*classname*\] or `-da`\[`:`\[*packagename*\]...\|`:`*classname*\]
...
[`-disablesystemassertions`]{#option-disablesystemassertions} or `-dsa`
:   Disables assertions in all system classes.

[`-enableassertions`]{#option-enableassertions}\[`:`\[*packagename*\]...\|`:`*classname*\] or `-ea`\[`:`\[*packagename*\]...\|`:`*classname*\]
...
[`-enablesystemassertions`]{#option-enablesystemassertions} or `-esa`
...
[`-javaagent:`]{#option-javaagent_}*jarpath*\[`=`*options*\]
...
[`--show-module-resolution`]{#option--show-module-resolution}
:   Shows module resolution output during startup.

[`-splash:`]{#option-splash_}*imagepath*
...
[`-verbose:class`]{#option-verbose_class}
:   Displays information about each loaded class.

[`-verbose:gc`]{#option-verbose_gc}
:   Displays information about each garbage collection (GC) event.

[`-verbose:jni`]{#option-verbose_jni}
:   Displays information about the use of native methods and other Java Native
    Interface (JNI) activity.

[`-verbose:module`]{#option-verbose_module}
...
[`-Xbootclasspath/a:`]{#option-Xbootclasspath}*directories*\|*zip*\|*JAR-files*
...
[`-Xinternalversion`]{#option-Xinternalversion}
...
[`-XshowSettings`]{#option-XshowSettings}
:   Shows all settings and then continues.

[`-XshowSettings:`]{#option-XshowSettings_}*category*
...
[`--add-reads`]{#option--add-reads} *module*`=`*target-module*(`,`*target-module*)\*
...
[`--add-exports`]{#option--add-exports} *module*`/`*package*`=`*target-module*(`,`*target-module*)\*
...
[`--add-opens`]{#option--add-opens} *module*`/`*package*`=`*target-module*(`,`*target-module*)\*
:   Updates *module* to open *package* to *target-module*, regardless of module
    declaration.

[`--limit-modules`]{#option--limit-modules} *module*\[`,`*module*...\]
:   Specifies the limit of the universe of observable modules.

[`--patch-module`]{#option--patch-module} *module*`=`*file*(`;`*file*)\*
:   Overrides or augments a module with classes and resources in JAR files or
    directories.

[`--source`]{#option--source} *version*
:   Sets the version of the source in source-file mode.


[`--sun-misc-unsafe-memory-access=`]{#option--sun-misc-unsafe-memory-access} *value*
...
[`-XstartOnFirstThread`]{#option-XstartOnFirstThread}
:   Runs the `main()` method on the first (AppKit) thread.

[`-Xdock:name=`]{#option-Xdock_name}*application\_name*
:   Overrides the default application name displayed in dock.

[`-Xdock:icon=`]{#option-Xdock_icon}*path\_to\_icon\_file*
...
[`-XX:+UnlockDiagnosticVMOptions`]{#option-XX__UnlockDiagnosticVMOptions}
...
[`-XX:+UnlockExperimentalVMOptions`]{#option-XX__UnlockExperimentalVMOptions}
...
[`-XX:ActiveProcessorCount=`]{#option-XX_ActiveProcessorCount}*x*
...
[`-XX:AllocateHeapAt=`]{#option-XX_AllocateHeapAt}*path*
...
[`-XX:-CompactStrings`]{#option-XX__CompactStrings}
...
[`-XX:ErrorFile=`]{#option-XX_ErrorFile}*filename*
...
[`-XX:+ExtensiveErrorReports`]{#option-XX__ExtensiveErrorReports}
...
[`-XX:FlightRecorderOptions=`]{#option-XX_FlightRecorderOptions}*parameter*`=`*value* (or) `-XX:FlightRecorderOptions:`*parameter*`=`*value*
...
[`-XX:LargePageSizeInBytes=`]{#option-XX_LargePageSizeInBytes}*size*
...
[`-XX:MaxDirectMemorySize=`]{#option-XX_MaxDirectMemorySize}*size*
...
[`-XX:-MaxFDLimit`]{#option-XX__MaxFDLimit}
...
[`-XX:NativeMemoryTracking=`]{#option-XX_NativeMemoryTracking}*mode*
...
[`-XX:TrimNativeHeapInterval=`]{#option-XX_TrimNativeHeapInterval}*millis*
...
[`-XX:ObjectAlignmentInBytes=`]{#option-XX_ObjectAlignmentInBytes}*alignment*
...
[`-XX:OnError=`]{#option-XX_OnError}*string*
...
[`-XX:OnOutOfMemoryError=`]{#option-XX_OnOutOfMemoryError}*string*
:   Sets a custom command or a series of semicolon-separated commands to run
...
[`-XX:+PrintCommandLineFlags`]{#option-XX__PrintCommandLineFlags}
...
[`-XX:+PreserveFramePointer`]{#option-XX__PreserveFramePointer}
...
[`-XX:+PrintNMTStatistics`]{#option-XX__PrintNMTStatistics}
...
[`-XX:SharedArchiveFile=`]{#option-XX_SharedArchiveFile}*path*
:   Specifies the path and name of the class data sharing (CDS) archive file

    See [Application Class Data Sharing].

[`-XX:+VerifySharedSpaces`]{#option-XX__VerifySharedSpaces}
...
[`-XX:SharedArchiveConfigFile=`]{#option-XX_SharedArchiveConfigFile}*shared\_config\_file*
:   Specifies additional shared data added to the archive file.

[`-XX:SharedClassListFile=`]{#option-XX_SharedClassListFile}*file\_name*
...
[`-XX:+ShowCodeDetailsInExceptionMessages`]{#option-XX__ShowCodeDetailsInExceptionMessages}
...
[`-XX:+ShowMessageBoxOnError`]{#option-XX__ShowMessageBoxOnError}
...
[`-XX:StartFlightRecording:`]{#option-XX_StartFlightRecording_}*parameter*`=`*value*
...
[`-XX:ThreadStackSize=`]{#option-XX_ThreadStackSize}*size*
...
[`-XX:+UseCompactObjectHeaders`]{#option-XX__UseCompactObjectHeaders}
...
[`-XX:-UseCompressedOops`]{#option-XX__UseCompressedOops}
...
[`-XX:-UseContainerSupport`]{#option-XX__UseContainerSupport}
...
[`-XX:+AllowUserSignalHandlers`]{#option-XX__AllowUserSignalHandlers}
...
[`-XX:VMOptionsFile=`]{#option-XX_VMOptionsFile}*filename*
:   Allows user to specify VM options in a file, for example,
    `java -XX:VMOptionsFile=/var/my_vm_options HelloWorld`.

[`-XX:UseBranchProtection=`]{#option-XX_UseBranchProtection}*mode*
...
[`-XX:AllocateInstancePrefetchLines=`]{#option-XX_AllocateInstancePrefetchLines}*lines*
...
[`-XX:AllocatePrefetchDistance=`]{#option-XX_AllocatePrefetchDistance}*size*
...
[`-XX:AllocatePrefetchInstr=`]{#option-XX_AllocatePrefetchInstr}*instruction*
...
[`-XX:AllocatePrefetchLines=`]{#option-XX_AllocatePrefetchLines}*lines*
...
[`-XX:AllocatePrefetchStepSize=`]{#option-XX_AllocatePrefetchStepSize}*size*
...
[`-XX:AllocatePrefetchStyle=`]{#option-XX_AllocatePrefetchStyle}*style*
...
[`-XX:+BackgroundCompilation`]{#option-XX__BackgroundCompilation}
...
[`-XX:CICompilerCount=`]{#option-XX_CICompilerCount}*threads*
...
[`-XX:+UseDynamicNumberOfCompilerThreads`]{#option-XX__UseDynamicNumberOfCompilerThreads}
:   Dynamically create compiler thread up to the limit specified by `-XX:CICompilerCount`.
    This option is enabled by default.

[`-XX:CompileCommand=`]{#option-XX_CompileCommand}*command*`,`*method*\[`,`*option*\]
...
[`-XX:CompileCommandFile=`]{#option-XX_CompileCommandFile}*filename*
...
[`-XX:CompilerDirectivesFile=`]{#option-XX_CompilerDirectivesFile}*file*
...
[`-XX:+CompilerDirectivesPrint`]{#option-XX__CompilerDirectivesPrint}
...
[`-XX:CompileOnly=`]{#option-XX_CompileOnly}*methods*
...
[`-XX:CompileThresholdScaling=`]{#option-XX_CompileThresholdScaling}*scale*
...
[`-XX:+DoEscapeAnalysis`]{#option-XX__DoEscapeAnalysis}
...
[`-XX:InitialCodeCacheSize=`]{#option-XX_InitialCodeCacheSize}*size*
...
[`-XX:InlineSmallCode=`]{#option-XX_InlineSmallCode}*size*
...
[`-XX:+LogCompilation`]{#option-XX__LogCompilation}
...
[`-XX:FreqInlineSize=`]{#option-XX_FreqInlineSize}*size*
...
[`-XX:MaxInlineSize=`]{#option-XX_MaxInlineSize}*size*
...
[`-XX:C1MaxInlineSize=`]{#option-XX_C1MaxInlineSize}*size*
:   Sets the maximum bytecode size (in bytes) of a cold method to be inlined.
...
[`-XX:MaxTrivialSize=`]{#option-XX_MaxTrivialSize}*size*
...
[`-XX:C1MaxTrivialSize=`]{#option-XX_C1MaxTrivialSize}*size*
:   Sets the maximum bytecode size (in bytes) of a trivial method to be
...
[`-XX:MaxNodeLimit=`]{#option-XX_MaxNodeLimit}*nodes*
...
[`-XX:NonNMethodCodeHeapSize=`]{#option-XX_NonNMethodCodeHeapSize}*size*
...
[`-XX:NonProfiledCodeHeapSize=`]{#option-XX_NonProfiledCodeHeapSize}*size*
...
[`-XX:+OptimizeStringConcat`]{#option-XX__OptimizeStringConcat}
...
[`-XX:+PrintAssembly`]{#option-XX__PrintAssembly}
...
[`-XX:ProfiledCodeHeapSize=`]{#option-XX_ProfiledCodeHeapSize}*size*
:   Sets the size in bytes of the code segment containing profiled methods.
    This flag is used only if `-XX:SegmentedCodeCache` is enabled.

[`-XX:+PrintCompilation`]{#option-XX__PrintCompilation}
...
[`-XX:+PrintInlining`]{#option-XX__PrintInlining}
...
[`-XX:ReservedCodeCacheSize=`]{#option-XX_ReservedCodeCacheSize}*size*
...
[`-XX:+SegmentedCodeCache`]{#option-XX__SegmentedCodeCache}
...
[`-XX:StartAggressiveSweepingAt=`]{#option-XX_StartAggressiveSweepingAt}*percent*
...
[`-XX:-TieredCompilation`]{#option-XX__TieredCompilation}
:   Disables the use of tiered compilation. By default, this option is enabled.

[`-XX:UseSSE=`]{#option-XX_UseSSE}*version*
...
[`-XX:UseAVX=`]{#option-XX_UseAVX}*version*
:   Enables the use of AVX instruction set of a specified version.
    Is set by default to the highest supported version available (x86 only).

[`-XX:+UseAES`]{#option-XX__UseAES}
...
[`-XX:+UseAESIntrinsics`]{#option-XX__UseAESIntrinsics}
...
[`-XX:+UseAESCTRIntrinsics`]{#option-XX__UseAESCTRIntrinsics}
:   Analogous to `-XX:+UseAESIntrinsics` enables AES/CTR intrinsics.

[`-XX:+UseGHASHIntrinsics`]{#option-XX__UseGHASHIntrinsics}
...
[`-XX:+UseChaCha20Intrinsics`]{#option-XX__UseChaCha20Intrinsics}
...
[`-XX:+UsePoly1305Intrinsics`]{#option-XX__UsePoly1305Intrinsics}
...
[`-XX:+UseBASE64Intrinsics`]{#option-XX__UseBASE64Intrinsics}
...
[`-XX:+UseSHA1Intrinsics`]{#option-XX__UseSHA1Intrinsics}
...
[`-XX:+UseCMoveUnconditionally`]{#option-XX__UseCMoveUnconditionally}
:   Generates CMove (scalar and vector) instructions regardless of
    profitability analysis.

[`-XX:+UseCodeCacheFlushing`]{#option-XX__UseCodeCacheFlushing}
...
[`-XX:+UseCondCardMark`]{#option-XX__UseCondCardMark}
...
[`-XX:+UseCountedLoopSafepoints`]{#option-XX__UseCountedLoopSafepoints}
...
[`-XX:LoopStripMiningIter=`]{#option-XX_LoopStripMiningIter}*number_of_iterations*
...
[`-XX:LoopStripMiningIterShortLoop=`]{#option-XX_LoopStripMiningIterShortLoop}*number_of_iterations*
...
[`-XX:+UseSuperWord`]{#option-XX__UseSuperWord}
...
[`-XX:+DisableAttachMechanism`]{#option-XX__DisableAttachMechanism}
...
[`-XX:+DTraceAllocProbes`]{#option-XX__DTraceAllocProbes}
:   **Linux and macOS:** Enable `dtrace` tool probes for object allocation.

[`-XX:+DTraceMethodProbes`]{#option-XX__DTraceMethodProbes}
:   **Linux and macOS:** Enable `dtrace` tool probes for method-entry
    and method-exit.

[`-XX:+DTraceMonitorProbes`]{#option-XX__DTraceMonitorProbes}
:   **Linux and macOS:** Enable `dtrace` tool probes for monitor events.

[`-XX:+HeapDumpOnOutOfMemoryError`]{#option-XX__HeapDumpOnOutOfMemoryError}
...
[`-XX:HeapDumpPath=`]{#option-XX_HeapDumpPath}*path*
...
[`-XX:LogFile=`]{#option-XX_LogFile}*path*
...
[`-XX:+PrintClassHistogram`]{#option-XX__PrintClassHistogram}
...
[`-XX:+PrintConcurrentLocks`]{#option-XX__PrintConcurrentLocks}
...
[`-XX:+UsePerfData`]{#option-XX__UsePerfData}
...
[`-XX:+AlwaysPreTouch`]{#option-XX__AlwaysPreTouch}
...
[`-XX:ConcGCThreads=`]{#option-XX_ConcGCThreads}*threads*
...
[`-XX:+DisableExplicitGC`]{#option-XX__DisableExplicitGC}
...
[`-XX:+ExplicitGCInvokesConcurrent`]{#option-XX__ExplicitGCInvokesConcurrent}
...
[`-XX:G1AdaptiveIHOPNumInitialSamples=`]{#option-XX_G1AdaptiveIHOPNumInitialSamples}*number*
...
[`-XX:G1HeapRegionSize=`]{#option-XX_G1HeapRegionSize}*size*
...
[`-XX:G1HeapWastePercent=`]{#option-XX_G1HeapWastePercent}*percent*
...
[`-XX:G1MaxNewSizePercent=`]{#option-XX_G1MaxNewSizePercent}*percent*
...
[`-XX:G1MixedGCCountTarget=`]{#option-XX_G1MixedGCCountTarget}*number*
...
[`-XX:G1MixedGCLiveThresholdPercent=`]{#option-XX_G1MixedGCLiveThresholdPercent}*percent*
...
[`-XX:G1NewSizePercent=`]{#option-XX_G1NewSizePercent}*percent*
...
[`-XX:G1OldCSetRegionThresholdPercent=`]{#option-XX_G1OldCSetRegionThresholdPercent}*percent*
...
[`-XX:G1ReservePercent=`]{#option-XX_G1ReservePercent}*percent*
...
[`-XX:+G1UseAdaptiveIHOP`]{#option-XX__G1UseAdaptiveIHOP}
...
[`-XX:InitialHeapSize=`]{#option-XX_InitialHeapSize}*size*
...
[`-XX:InitialRAMPercentage=`]{#option-XX_InitialRAMPercentage}*percent*
...
[`-XX:InitialSurvivorRatio=`]{#option-XX_InitialSurvivorRatio}*ratio*
...
[`-XX:InitiatingHeapOccupancyPercent=`]{#option-XX_InitiatingHeapOccupancyPercent}*percent*
...
[`-XX:MaxGCPauseMillis=`]{#option-XX_MaxGCPauseMillis}*time*
...
[`-XX:MaxHeapSize=`]{#option-XX_MaxHeapSize}*size*
...
[`-XX:MaxHeapFreeRatio=`]{#option-XX_MaxHeapFreeRatio}*percent*
...
[`-XX:MaxMetaspaceSize=`]{#option-XX_MaxMetaspaceSize}*size*
...
[`-XX:MinRAMPercentage=`]{#option-XX_MinRAMPercentage}*percent*
:   Sets the maximum amount of memory that the JVM may use for the Java heap
    before applying ergonomics heuristics as a percentage of the maximum amount
...
[`-XX:MaxTenuringThreshold=`]{#option-XX_MaxTenuringThreshold}*threshold*
...
[`-XX:MetaspaceSize=`]{#option-XX_MetaspaceSize}*size*
...
[`-XX:MinHeapFreeRatio=`]{#option-XX_MinHeapFreeRatio}*percent*
...
[`-XX:MinHeapSize=`]{#option-XX_MinHeapSize}*size*
...
[`-XX:NewRatio=`]{#option-XX_NewRatio}*ratio*
...
[`-XX:NewSize=`]{#option-XX_NewSize}*size*
...
[`-XX:ParallelGCThreads=`]{#option-XX_ParallelGCThreads}*threads*
...
[`-XX:+PrintAdaptiveSizePolicy`]{#option-XX__PrintAdaptiveSizePolicy}
:   Enables printing of information about adaptive-generation sizing. By
    default, this option is disabled.

[`-XX:SoftRefLRUPolicyMSPerMB=`]{#option-XX_SoftRefLRUPolicyMSPerMB}*time*
...
[`-XX:-ShrinkHeapInSteps`]{#option-XX__ShrinkHeapInSteps}
...
[`-XX:StringDeduplicationAgeThreshold=`]{#option-XX_StringDeduplicationAgeThreshold}*threshold*
...
[`-XX:SurvivorRatio=`]{#option-XX_SurvivorRatio}*ratio*
...
[`-XX:TargetSurvivorRatio=`]{#option-XX_TargetSurvivorRatio}*percent*
...
[`-XX:TLABSize=`]{#option-XX_TLABSize}*size*
...
[`-XX:+UseAdaptiveSizePolicy`]{#option-XX__UseAdaptiveSizePolicy}
...
[`-XX:+UseGCOverheadLimit`]{#option-XX__UseGCOverheadLimit}
...
[`-XX:+UseParallelGC`]{#option-XX__UseParallelGC}
...
[`-XX:+UseSerialGC`]{#option-XX__UseSerialGC}
...
[`-XX:+UseStringDeduplication`]{#option-XX__UseStringDeduplication}
...
[`-XX:ZAllocationSpikeTolerance=`]{#option-XX_ZAllocationSpikeTolerance}*factor*
...
[`-XX:ZCollectionInterval=`]{#option-XX_ZCollectionInterval}*seconds*
:   Sets the maximum interval (in seconds) between two GC cycles when using
    ZGC. By default, this option is set to 0 (disabled).

[`-XX:ZFragmentationLimit=`]{#option-XX_ZFragmentationLimit}*percent*
...
[`-XX:+ZProactive`]{#option-XX__ZProactive}
...
[`-XX:+ZUncommit`]{#option-XX__ZUncommit}
...
[`-XX:ZUncommitDelay=`]{#option-XX_ZUncommitDelay}*seconds*
...
[`-XX:+UseShenandoahGC`]{#option-XX__UseShenandoahGC}
...
[`-XX:ShenandoahGCMode=`]{#option-XX_ShenandoahGCMode}*mode*
...
[`-XX:ShenandoahGCHeuristics=`]{#option-XX_ShenandoahGCHeuristics}*heuristics*
...
[`-Xloggc:`]{#option-Xloggc_}*filename*
...
[`-XX:+FlightRecorder`]{#option-XX__FlightRecorder}
...
[`-XX:+ParallelRefProcEnabled`]{#option-XX__ParallelRefProcEnabled}
...
[`-XX:MaxRAM=`]{#option-XX_MaxRAM}*size*
:   Sets the maximum amount of memory that the JVM may use for the Java heap
...
[`-XX:+NeverActAsServerClassMachine`]{#option-XX__NeverActAsServerClassMachine}
...
[`--illegal-access=`]{#option--illegal-access}*parameter*
...
[`-XX:AOTCache=`]{#option-XX_AOTCache}*cachefile*
...
[`-XX:AOTCacheOutput=`]{#option-XX_AOTCacheOutput}*cachefile*
...
[`-XX:AOTConfiguration=`]{#option-XX_AOTConfiguration}*configfile*
...
[`-XX:AOTMode=`]{#option-XX_AOTMode}*mode*
...
[`-XX:+AOTClassLinking`]{#option-XX__AOTClassLinking}
