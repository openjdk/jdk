...
public class ValueNullFree extends SumBase {
    ...
    public static class ValState_of_Int2_w2_d0 extends SizeState {
        ...
        @Setup
        public void setup() {
            arr = (ValueInt2_w2_d0[])ValueClass.newNullRestrictedAtomicArray(ValueInt2_w2_d0.class, size * 2, new ValueInt2_w2_d0(0, 0));
            for (int i = 0; i < arr.length; i++) {
    ...
    public static class ValState_of_Int2_w2_d1 extends SizeState {
        ...
        @Setup
        public void setup() {
            arr = (ValueInt2_w2_d1[])ValueClass.newNullRestrictedAtomicArray(ValueInt2_w2_d1.class, size * 4, new ValueInt2_w2_d1(0, 0));
            for (int i = 0; i < arr.length; i++) {
    ...
    public static class ValState_of_Int4_w4_d0 extends SizeState {
        ...
        @Setup
        public void setup() {
            arr = (ValueInt4_w4_d0[])ValueClass.newNullRestrictedAtomicArray(ValueInt4_w4_d0.class, size, new ValueInt4_w4_d0(0, 0, 0,  0));
            for (int i = 0; i < arr.length; i++) {
    ...
    public static class ValState_of_Int4_w4_d1 extends SizeState {
        ...
        @Setup
        public void setup() {
            arr = (ValueInt4_w4_d1[])ValueClass.newNullRestrictedAtomicArray(ValueInt4_w4_d1.class, size, new ValueInt4_w4_d1(0, 0, 0,  0));
            for (int i = 0; i < arr.length; i++) {
    ...
    public static class ValState_of_Int4_w2_d1 extends SizeState {
        ...
        @Setup
        public void setup() {
            arr = (ValueInt4_w2_d1[])ValueClass.newNullRestrictedAtomicArray(ValueInt4_w2_d1.class, size, new ValueInt4_w2_d1(0, 0, 0,  0));
            for (int i = 0; i < arr.length; i++) {
    ...
    public static class ValState_of_Int4_w2_d2 extends SizeState {
        ...
        @Setup
        public void setup() {
            arr = (ValueInt4_w2_d2[])ValueClass.newNullRestrictedAtomicArray(ValueInt4_w2_d2.class, size, new ValueInt4_w2_d2(0, 0, 0,  0));
            for (int i = 0; i < arr.length; i++) {
