...
public class LongComparison {
    ...
    @Benchmark
    public void equalLongResObj() {
        for (int i = 0; i < INVOCATIONS; i++) {
            resObject[i] = (l1[i] == l2[i]) ? ro1 : ro2;
        }
    }

    @Benchmark
    public void notEqualLongResObj() {
        for (int i = 0; i < INVOCATIONS; i++) {
            resObject[i] = (l1[i] != l2[i]) ? ro1 : ro2;
        }
    }
    ...
    @Benchmark
    public void lessEqualLongResObj() {
        for (int i = 0; i < INVOCATIONS; i++) {
            resObject[i] = (l1[i] <= l2[i]) ? ro1 : ro2;
        }
    }
    ...
    @Benchmark
    public void greaterEqualLongResObj() {
        for (int i = 0; i < INVOCATIONS; i++) {
            resObject[i] = (l1[i] >= l2[i]) ? ro1 : ro2;
        }
    }
    ...
    @Benchmark
    public void equalLongResClass() {
        for (int i = 0; i < INVOCATIONS; i++) {
            resClass[i] = (l1[i] == l2[i]) ? rc1 : rc2;
        }
    }

    @Benchmark
    public void notEqualLongResClass() {
        for (int i = 0; i < INVOCATIONS; i++) {
            resClass[i] = (l1[i] != l2[i]) ? rc1 : rc2;
        }
    }
    ...
    @Benchmark
    public void lessEqualLongResClass() {
        for (int i = 0; i < INVOCATIONS; i++) {
            resClass[i] = (l1[i] <= l2[i]) ? rc1 : rc2;
        }
    }
    ...
    @Benchmark
    public void greaterLongResClass() {
        for (int i = 0; i < INVOCATIONS; i++) {
            resClass[i] = (l1[i] > l2[i]) ? rc1 : rc2;
        }
    }
    ...
    @Benchmark
    public void greaterEqualLongResClass() {
        for (int i = 0; i < INVOCATIONS; i++) {
            resClass[i] = (l1[i] >= l2[i]) ? rc1 : rc2;
        }
    }
