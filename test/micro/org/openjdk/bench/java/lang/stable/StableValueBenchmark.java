...
public class StableValueBenchmark {
    ...
    private static final StableValue<Integer> DCL = init(StableValue.ofUnset(), VALUE);
    private static final StableValue<Integer> DCL2 = init(StableValue.ofUnset(), VALUE2);
    ...
    private final StableValue<Integer> stableNull = StableValue.ofUnset();
    private final StableValue<Integer> stableNull2 = StableValue.ofUnset();
    ...
    public void setup() {
        ...
        for (int i = 0; i < 500_000; i++) {
            ...
            sum += dclX.get();
            StableValue<Integer> stableX = StableValue.ofUnset();
            stableX.trySet(i);
    ...
    private static final class Holder {
        ...
        private final StableValue<Integer> delegate = StableValue.ofUnset();
