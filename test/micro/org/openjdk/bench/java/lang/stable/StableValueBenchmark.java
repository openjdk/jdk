...
public class StableValueBenchmark {
    ...
    private static final StableValue<Integer> DCL = init(StableValue.unset(), VALUE);
    private static final StableValue<Integer> DCL2 = init(StableValue.unset(), VALUE2);
    ...
    private final StableValue<Integer> stableNull = StableValue.unset();
    private final StableValue<Integer> stableNull2 = StableValue.unset();
    ...
    public void setup() {
        ...
        for (int i = 0; i < 500_000; i++) {
            ...
            sum += dclX.get();
            StableValue<Integer> stableX = StableValue.unset();
            stableX.trySet(i);
    ...
    private static final class Holder {
        ...
        private final StableValue<Integer> delegate = StableValue.unset();
