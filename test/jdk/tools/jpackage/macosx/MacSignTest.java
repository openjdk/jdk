...
public class MacSignTest {
    ...
    public static void testCodesignUnspecificFailure() throws IOException {
        ...
        MacSign.withKeychain(keychain -> {
            ...
            var outputVerifier = buildSignCommandErrorValidator(signingKeyOption, keychain)
                ...
                if (!opt.passThrough().orElse(false)) {
                    ...
                    switch (opt.optionName().orElseThrow()) {
                        ...
                        case KEY_IDENTITY_INSTALLER -> {
                            ...
                            builder.outputVerifiers(TKit.assertTextStream(regexp));
                        }
                    }
    ...
    private static FailedCommandErrorVerifier buildSignCommandErrorValidator(SignKeyOptionWithKeychain option) {
        return buildSignCommandErrorValidator(option.signKeyOption(), option.keychain());
    }

    private static FailedCommandErrorVerifier buildSignCommandErrorValidator(SignKeyOption option, MacSign.ResolvedKeychain keychain) {
        ...
        return new FailedCommandErrorVerifier(Pattern.compile(String.format(
