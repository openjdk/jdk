/*
 * Copyright (c) 20025, Oracle and/or its affiliates. All rights reserved.
 ...
 * @test
 * @bug     8351110
 * @summary Test verifies that writing JPEG segments over 65535 kb
 *          fails.
        ...
        try {
            ...
            for (int y = 0; y < readThumbnail.getHeight(); y++) {
                for (int x = 0; x < readThumbnail.getWidth(); x++) {
                    ...
                    int g2 = (rgb2 >> 8) & 0xff;
                    int b2 = (rgb2 >> 0) & 0xff;
                    assertTrue(Math.abs(r1 - r2) < 128, "r1 = " + r1 + " r2 = " + r2);
                    assertTrue(Math.abs(g1 - g2) < 128, "g1 = " + g1 + " g2 = " + g2);
                    assertTrue(Math.abs(b1 - b2) < 128, "b1 = " + b1 + " b2 = " + b2);
                }
            }
