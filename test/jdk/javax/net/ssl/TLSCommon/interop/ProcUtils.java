...
public class ProcUtils {
    ...
    public static OutputAnalyzer java(Path javaPath, Class<?> clazz,
        ...
        ProcessBuilder pb = createLimitedJavaTestProcessBuilder(javaPath, clazz, props);
        try {
    ...
    private static ProcessBuilder createLimitedJavaTestProcessBuilder(Path javaPath,
