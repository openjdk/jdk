 ...
 * @run main/othervm -Djdk.tls.client.protocols=TLSv1.3 -Djdk.tls.server.enableSessionTicketExtension=true -Djdk.tls.client.enableSessionTicketExtension=true MultiNSTClient
 ...
 */
        SSLSession ss2 = client1.getNewSession().getSession();
        System.out.println(ss2);
        id = ss2.getId();
        System.out.println("id = " + hex.formatHex(id));
        System.out.println("ss2.getSessionContext().getSession(id) = " + ss2.getSessionContext().getSession(id));
        if (ss2.getSessionContext().getSession(id) != null) {
            id = ss2.getSessionContext().getSession(id).getId();
            System.out.println("id = " + hex.formatHex(id));
        }
