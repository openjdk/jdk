...
public class TestMultipleStartupRecordings {
    ...
    private static void launchUnary(String options) throws Exception {
        ...
        ProcessBuilder pb = ProcessTools.createJavaTestProcessBuilder(recording1, MainClass.class.getName());
    ...
    private static void launchBinary(String options1, String options2) throws Exception {
        ...
        ProcessBuilder pb = ProcessTools.createJavaTestProcessBuilder(recording1, recording2, MainClass.class.getName());
    ...
    private static void launchTernary(String options1, String options2, String options3) throws Exception {
        ...
        ProcessBuilder pb = ProcessTools.createJavaTestProcessBuilder(recording1, recording2, recording3, MainClass.class.getName());
    ...
    private static void testWithFlightRecorderOptions() throws Exception {
        ...
        ProcessBuilder pb = ProcessTools.createJavaTestProcessBuilder(flightRecorderOptions, recording1, recording2, MainClass.class.getName());
        test(pb, "Started recording 1", "Started recording 2");
    }
