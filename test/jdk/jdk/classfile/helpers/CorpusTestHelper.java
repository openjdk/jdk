...
//        ClassPrinter.yamlPrinter(ClassPrinter.VerbosityLevel.TRACE_ALL, System.out::print).printClass(ClassModel.of(Files.readAllBytes(root.resolve(targetClassFile))));
    }
