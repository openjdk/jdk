...
public class Double512VectorTests extends AbstractVectorTest {
    ...
    static void FIRST_NONZERODouble512VectorTests(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        ...
        assertArraysEquals(a, b, r, Double512VectorTests::FIRST_NONZERO);
    }
    ...
    static void FIRST_NONZERODouble512VectorTestsMasked(IntFunction<double[]> fa, IntFunction<double[]> fb,
        ...
        assertArraysEquals(a, b, r, mask, Double512VectorTests::FIRST_NONZERO);
    }
    ...
    static void addDouble512VectorTestsBroadcastSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        ...
        assertBroadcastArraysEquals(a, b, r, Double512VectorTests::add);
    }
    ...
    static void addDouble512VectorTestsBroadcastMaskedSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb,
        ...
        assertBroadcastArraysEquals(a, b, r, mask, Double512VectorTests::add);
    }
    ...
    static void subDouble512VectorTestsBroadcastSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        ...
        assertBroadcastArraysEquals(a, b, r, Double512VectorTests::sub);
    }
    ...
    static void subDouble512VectorTestsBroadcastMaskedSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb,
        ...
        assertBroadcastArraysEquals(a, b, r, mask, Double512VectorTests::sub);
    }
    ...
    static void mulDouble512VectorTestsBroadcastSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        ...
        assertBroadcastArraysEquals(a, b, r, Double512VectorTests::mul);
    }
    ...
    static void mulDouble512VectorTestsBroadcastMaskedSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb,
        ...
        assertBroadcastArraysEquals(a, b, r, mask, Double512VectorTests::mul);
    }
    ...
    static void divDouble512VectorTestsBroadcastSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        ...
        assertBroadcastArraysEquals(a, b, r, Double512VectorTests::div);
    }
    ...
    static void divDouble512VectorTestsBroadcastMaskedSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb,
        ...
        assertBroadcastArraysEquals(a, b, r, mask, Double512VectorTests::div);
    }
    ...
    static void MINDouble512VectorTestsBroadcastSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        ...
        assertBroadcastArraysEquals(a, b, r, Double512VectorTests::MIN);
    }
    ...
    static void MAXDouble512VectorTestsBroadcastSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        ...
        assertBroadcastArraysEquals(a, b, r, Double512VectorTests::MAX);
    }
    ...
    static void sliceUnaryDouble512VectorTests(IntFunction<double[]> fa) {
        ...
        assertArraysEquals(a, r, origin, Double512VectorTests::sliceUnary);
    }
    ...
    static void sliceBinaryDouble512VectorTestsBinary(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        ...
        assertArraysEquals(a, b, r, origin, Double512VectorTests::sliceBinary);
    }
    ...
    static void unsliceUnaryDouble512VectorTests(IntFunction<double[]> fa) {
        ...
        assertArraysEquals(a, r, origin, Double512VectorTests::unsliceUnary);
    }
    ...
    static void unsliceBinaryDouble512VectorTestsBinary(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        ...
        assertArraysEquals(a, b, r, origin, part, Double512VectorTests::unsliceBinary);
    }
    ...
    IntFunction<boolean[]> fm) {
        ...
        assertArraysEquals(a, b, r, origin, part, mask, Double512VectorTests::unslice);
    }
    ...
    static void POWDouble512VectorTestsBroadcastSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        ...
        assertBroadcastArraysEqualsWithinOneUlp(a, b, r, Double512VectorTests::POW, Double512VectorTests::strictPOW);
    }
    ...
    static void FMADouble512VectorTestsBroadcastSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb, IntFunction<double[]> fc) {
        ...
        assertBroadcastArraysEquals(a, b, c, r, Double512VectorTests::FMA);
    }
    ...
    static void FMADouble512VectorTestsAltBroadcastSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb, IntFunction<double[]> fc) {
        ...
        assertAltBroadcastArraysEquals(a, b, c, r, Double512VectorTests::FMA);
    }
    ...
    static void FMADouble512VectorTestsBroadcastMaskedSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb,
        ...
        assertBroadcastArraysEquals(a, b, c, r, mask, Double512VectorTests::FMA);
    }
    ...
    static void FMADouble512VectorTestsAltBroadcastMaskedSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb,
        ...
        assertAltBroadcastArraysEquals(a, b, c, r, mask, Double512VectorTests::FMA);
    }
    ...
    static void FMADouble512VectorTestsDoubleBroadcastSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb, IntFunction<double[]> fc) {
        ...
        assertDoubleBroadcastArraysEquals(a, b, c, r, Double512VectorTests::FMA);
    }
    @Test(dataProvider = "doubleTernaryOpProvider")
    static void fmaDouble512VectorTestsDoubleBroadcastSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb, IntFunction<double[]> fc) {
        int count = INVOC_COUNT;
    ...
    static void FMADouble512VectorTestsDoubleBroadcastMaskedSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb,
        ...
        assertDoubleBroadcastArraysEquals(a, b, c, r, mask, Double512VectorTests::FMA);
    }
    ...
    static void gatherMaskedDouble512VectorTests(IntFunction<double[]> fa, BiFunction<Integer,Integer,int[]> fs, IntFunction<boolean[]> fm) {
        ...
        assertArraysEquals(a, b, r, mask, Double512VectorTests::gatherMasked);
    }
    ...
    static void scatterMaskedDouble512VectorTests(IntFunction<double[]> fa, IntFunction<double[]> fb, BiFunction<Integer,Integer,int[]> fs, IntFunction<boolean[]> fm) {
        ...
        assertArraysEquals(a, b, r, mask, Double512VectorTests::scatterMasked);
    }
