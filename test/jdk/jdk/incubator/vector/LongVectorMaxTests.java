...
public class LongVectorMaxTests extends AbstractVectorTest {
   ...
   public Object[][] longSaturatingUnaryOpMaskProvider() {
    ...
    static void maskEqualsLongVectorMaxTestsSmokeTest(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
    ...
    @Test(dataProvider = "maskCompareOpProvider")
    static void maskAndLongVectorMaxTestsSmokeTest(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "maskCompareOpProvider")
    static void maskOrLongVectorMaxTestsSmokeTest(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
    ...
    @Test(dataProvider = "maskCompareOpProvider")
    static void maskXorLongVectorMaxTestsSmokeTest(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
    ...
    @Test(dataProvider = "maskCompareOpProvider")
    static void maskAndNotLongVectorMaxTestsSmokeTest(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
    ...
    @Test(dataProvider = "maskCompareOpProvider")
    static void maskEqLongVectorMaxTestsSmokeTest(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
    ...
    @Test
    static void LongLongVectorMaxTestsSmokeTest() {
        LongVector av = LongVector.zero(SPECIES);
