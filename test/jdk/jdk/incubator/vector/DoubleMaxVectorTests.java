...
public class DoubleMaxVectorTests extends AbstractVectorTest {
    ...
    @Test(dataProvider = "maskCompareOpProvider")
    static void maskXorNotDoubleMaxVectorTestsSmokeTest(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
        ...
        assertArraysEquals(r, a, b, DoubleMaxVectorTests::bxorNot);
    }
