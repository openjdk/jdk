...
public class ByteVector512Tests extends AbstractVectorTest {
   ...
   public Object[][] byteSaturatingUnaryOpMaskProvider() {
    ...
    static void maskEqualsByteVector512TestsSmokeTest(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
    ...
    @Test(dataProvider = "maskCompareOpProvider")
    static void maskAndByteVector512TestsSmokeTest(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "maskCompareOpProvider")
    static void maskOrByteVector512TestsSmokeTest(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
    ...
    @Test(dataProvider = "maskCompareOpProvider")
    static void maskXorByteVector512TestsSmokeTest(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
    ...
    @Test(dataProvider = "maskCompareOpProvider")
    static void maskAndNotByteVector512TestsSmokeTest(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
    ...
    @Test(dataProvider = "maskCompareOpProvider")
    static void maskEqByteVector512TestsSmokeTest(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
    ...
    static void maskFromToLongByteVector512TestsSmokeTest(long inputLong) {
    ...
    @Test
    static void ByteByteVector512TestsSmokeTest() {
        ByteVector av = ByteVector.zero(SPECIES);
