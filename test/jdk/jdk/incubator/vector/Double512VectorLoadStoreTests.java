...
public class Double512VectorLoadStoreTests extends AbstractVectorLoadStoreTest {
    ...
    static void loadStoreShuffleArray(IntFunction<int[]> fa) {
        ...
        VectorShuffle<Double> shuffle = VectorShuffle.fromArray(SPECIES, a, 0);
    ...
    static void storeShuffleArrayIOOBE(IntFunction<int[]> fload,
        ...
        VectorShuffle<Double> shuffle = VectorShuffle.fromArray(SPECIES, aLoad, 0);
    ...
    static void loadStoreShuffleMemorySegment(IntFunction<int[]> fa,
        ...
        VectorShuffle<Double> memShuffle = VectorShuffle.fromMemorySegment(SPECIES, mem, 0, fbo.get());
    ...
    static void loadShuffleMemorySegmentIOOBE(IntFunction<int[]> fa,
        ...
        try {
            VectorShuffle<Double> badShuffle = VectorShuffle.fromMemorySegment(SPECIES, mem, 1, bo.get());
            Assert.fail("Expected IndexOutOfBoundsException");
        } catch (IndexOutOfBoundsException e) {
           // expected
        }
