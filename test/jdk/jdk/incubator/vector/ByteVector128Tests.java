...
public class ByteVector128Tests extends AbstractVectorTest {
   ...
   public Object[][] byteSaturatingUnaryOpMaskProvider() {
    ...
    static void maskEqualsByteVector128TestsSmokeTest(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
    ...
    @Test(dataProvider = "maskCompareOpProvider")
    static void maskAndByteVector128TestsSmokeTest(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "maskCompareOpProvider")
    static void maskOrByteVector128TestsSmokeTest(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
    ...
    @Test(dataProvider = "maskCompareOpProvider")
    static void maskXorByteVector128TestsSmokeTest(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
    ...
    @Test(dataProvider = "maskCompareOpProvider")
    static void maskAndNotByteVector128TestsSmokeTest(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
    ...
    @Test(dataProvider = "maskCompareOpProvider")
    static void maskEqByteVector128TestsSmokeTest(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
    ...
    static void maskFromToLongByteVector128TestsSmokeTest(long inputLong) {
    ...
    @Test
    static void ByteByteVector128TestsSmokeTest() {
        ByteVector av = ByteVector.zero(SPECIES);
