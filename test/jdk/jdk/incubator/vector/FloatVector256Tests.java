...
public class FloatVector256Tests extends AbstractVectorTest {
   ...
   static void assertArraysEqualsAssociative(float[] rl, float[] rr, float[] a, float[] b, float[] c, boolean[] mask, FBinOp f) {
    ...
    static void maskEqualsFloatVector256TestsSmokeTest(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
    ...
    @Test(dataProvider = "maskCompareOpProvider")
    static void maskAndFloatVector256TestsSmokeTest(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "maskCompareOpProvider")
    static void maskOrFloatVector256TestsSmokeTest(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
    ...
    @Test(dataProvider = "maskCompareOpProvider")
    static void maskXorFloatVector256TestsSmokeTest(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
    ...
    @Test(dataProvider = "maskCompareOpProvider")
    static void maskAndNotFloatVector256TestsSmokeTest(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
    ...
    @Test(dataProvider = "maskCompareOpProvider")
    static void maskEqFloatVector256TestsSmokeTest(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
    ...
    static void maskFromToLongFloatVector256TestsSmokeTest(long inputLong) {
