 ...
 *
 * @author Xuelei Fan
 * @run main/othervm IPAddressDNSIdentities TLSv1.2 MD5withRSA
 */
 ...
 *
 * @author Xuelei Fan
 * @run main/othervm IPAddressDNSIdentities TLSv1.3 SHA256withRSA
 */
...
public class IPAddressDNSIdentities extends IdentitiesBase {
    ...
    public static void main(String[] args) throws Exception {
        if (args[1].contains("MD5")) {
            System.err.println("RE-ENABLING MD5");
         ...
         * Start the tests.
         */
        new IPAddressDNSIdentities(args[0], args[1]);
    }
     ...
     */
    IPAddressDNSIdentities(String protocol, String signatureAlgo) throws Exception {
        super(protocol, signatureAlgo);
    ...
    @Override
    protected CertificateBuilder customizeServerCert(CertificateBuilder builder)
                                    throws Exception {
        return builder.addExtension(CertificateBuilder.createDNSSubjectAltNameExt(
                    true, "localhost"));
    }

    @Override
    protected CertificateBuilder customizeClientCert(CertificateBuilder builder)
                                    throws Exception {
        return builder.addExtension(CertificateBuilder.createDNSSubjectAltNameExt(
                    true, "localhost"));
    }
