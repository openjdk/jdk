 ...
 *      8301206 8303472 8317979 8306116 8174269 8333582 8357075 8358089
...
public class LocaleDataTest
{
    ...
    static boolean processLine(String key, String expectedValue, PrintWriter out,
        ...
        try {
            ...
            } else if (rbName.equals("CollationData")) {
                fullName = TEXT_RESOURCES_PACKAGE // strip ".cldr"
                        .substring(0, TEXT_RESOURCES_PACKAGE.length() - 5) + "." + rbName;
            } else {
