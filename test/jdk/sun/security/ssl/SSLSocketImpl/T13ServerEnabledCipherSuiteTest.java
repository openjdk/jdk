 ...
 * @summary  when ssl debug is enabled, verify debugging message containing correct information for TLSv1.3
 */
...
public class T13ServerEnabledCipherSuiteTest extends SSLSocketTemplate {
    private final static String protocl = "TLSv1.3";
    private final static String[] serverCipherSuites = {"TLS_CHACHA20_POLY1305_SHA256"};
    private final static String[] clientCipherSuites = {"TLS_AES_128_GCM_SHA256"};
    private final static String debugMessage = "\"Server Cipher Suites Debugging Info\":";
    ...
    T13ServerEnabledCipherSuiteTest () {
    ...
    public static void main(String[] args) throws Exception {
        if (args.length != 0) {
            ...
            try {
                new T13ServerEnabledCipherSuiteTest().run();
            }catch (Exception e){
                //do nothing
            }
        } else {
            ...
            var output = ProcessTools.executeTestJvm(testSrc, enabledDebug, "T13ServerEnabledCipherSuiteTest",
            ...
            output.shouldContain("\"enabled server cipher suites\": \"[TLS_CHACHA20_POLY1305_SHA256]\",");
