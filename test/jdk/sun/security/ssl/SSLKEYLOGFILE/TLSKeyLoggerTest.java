 ...
 * @test
 * @bug 8262880
 * @summary Add support for the NSS Key Log Format for SSL/TLS keys
 ...
 * produced.
 */
public class TLSKeyLoggerTest extends SSLContextTemplate {
    ...
    protected TLSKeyLoggerTest() throws Exception {
