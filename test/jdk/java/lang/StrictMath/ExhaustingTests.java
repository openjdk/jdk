    ...
    private static long testUnaryMethods() {
        ...
        UnaryTestCase[] testCases = {
         // new UnaryTestCase("sqrt",  FdlibmTranslit::sqrt,  StrictMath::sqrt,  DEFAULT_SHIFT),
            ...
            new UnaryTestCase("sin",   FdlibmTranslit::sin,   StrictMath::sin,   0),
            new UnaryTestCase("cos",   FdlibmTranslit::cos,   StrictMath::cos,   0),
            new UnaryTestCase("tan",   FdlibmTranslit::tan,   StrictMath::tan,   0),
