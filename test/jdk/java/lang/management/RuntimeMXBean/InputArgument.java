 ...
 * -XX:+UseFastJNIAccessors -XX:+PrintWarnings -XX:-PrintCommandLineFlags -XX:ErrorLogTimeout=100M
 */
...
public class InputArgument {
    ...
    private static void generateFlagsFile() throws Exception {
        ...
        Files.writeString(Paths.get("", "InputArgument.flags"),
            String.format("+PrintWarnings%n-PrintCommandLineFlags%nErrorLogTimeout=100M%n"));
    }
}
