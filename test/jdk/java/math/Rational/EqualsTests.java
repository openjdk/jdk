...
public class EqualsTests {
    ...
    public static void main(String argv[]) {
        ...
        Rational[][] testValues = {
            ...
            {new Rational("123456789123456789123"),
             new Rational(new BigInteger("123456789123456789123"))},
            {new Rational("123456789123456789123"),
             new Rational(new BigInteger("123456789123456789124"))},
            ...
            {new Rational(BigInteger.valueOf(2).pow(65)),
             new Rational("36893488147419103232")},
            {new Rational("36893488147419103231.81"),
             new Rational("36893488147419103231.811"),
            }
        };
