...
public class CompareToTests {
    private static int compareToTests() {
        ...
        Rational[][] testCases = {
                // Basics
                { new Rational(0), new Rational(0), ZERO }, { new Rational(0), new Rational(1), MINUS_ONE },
                { new Rational(1), new Rational(2), MINUS_ONE }, { new Rational(2), new Rational(1), ONE },
                { new Rational(10), new Rational(10), ZERO },

                // Significands would compare differently than scaled value
                { new Rational("0.2"), new Rational(2), MINUS_ONE }, { new Rational(20), new Rational(2), ONE },
                { new Rational("0.1"), new Rational(2), MINUS_ONE }, { new Rational(10), new Rational(2), ONE },
    ...
    public static void main(String argv[]) {
        ...
        if (failures > 0) {
            throw new RuntimeException("Incurred " + failures + " failures while testing compareTo.");
        }
    }
}