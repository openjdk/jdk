...
public class RootTests {
            ...
            for (int i = -10; i < 0; i++) {
                for (int j = -5; j < 5; j++) {
                    try {
                        ...
                        System.err.println("Unexpected even-degree root of negative: (" +
                                           input + ").root(" + n + ")  = " + result);
                        failures++;
    ...
    /**
     * Probe sqrt inputs with one digit of precision, 1 ... 9 and those
    ...
    private static int oneDigitSqrtTests() {
        ...
        // x, sqrt(x), sqrt(x/10)
        String[][] testCases = {
                {"1", "1",                       "0.31622776601683793319"},
                {"2", "1.4142135623730950488",   "0.44721359549995793928"},
                {"3", "1.73205080756887729352",  "0.547722557505166113456"},
                {"4", "2",                       "0.63245553203367586639"},
                ...
                {"8", "2.8284271247461900976",   "0.89442719099991587856"},
                {"9", "3",                       "0.94868329805051379959"},
        };
    ...
    /**
     * Probe cube root inputs with one digit of precision, 1 ... 9 and those
     * values scaled by 10^-1, 0.1, ... 0.9.
     */
    private static int oneDigitCbrtTests() {
        ...
        String[][] testCases = {
                ...
                {"7", "1.9129311827723891011",   "0.88790400174260070842"},
                {"8", "2",                       "0.92831776672255577848"},
    ...
    private static int squareRootTwoTests() {
        ...
        Rational highPrecisionRoot2 =
            new Rational("1.41421356237309504880168872420969807856967187537694807317667973799");
    ...
    private static int nearTen() {
        ...
        for (int i = 10; i < 23; i++) {
            ...
            failures += equal(highPrecisionRoot.round(mc),
