...
public class IntegralValueTests {
    ...
    private static final Map<String, Number> INT_VALUES =
        Map.ofEntries(

         // 2**31 - 1
         Map.entry("2147483647", Integer.MAX_VALUE),
         Map.entry("2147483647.0", Integer.MAX_VALUE),
         ...
         // -2**31
         Map.entry("-2147483648", Integer.MIN_VALUE),
         Map.entry("-2147483648.1", Integer.MIN_VALUE),
         ...
         Map.entry("10000001e1", 100000010),
         Map.entry("10000001e10", -1315576832),
         Map.entry("10000001e100", 0),
         Map.entry("10000001e1000", 0),
         Map.entry("10000001e10000", 0),
         Map.entry("10000001e100000", 0),
         Map.entry("10000001e1000000", 0),
         Map.entry("10000001e10000000", 0),

         // Increasing negative exponents
         Map.entry("10000001e-1", 1000000),
         Map.entry("10000001e-10", 0),
         Map.entry("10000001e-100", 0),
         Map.entry("10000001e-1000", 0),
         Map.entry("10000001e-10000", 0),
         Map.entry("10000001e-100000", 0),
         Map.entry("10000001e-1000000", 0),
         Map.entry("10000001e-10000000", 0),

         // Currency calculation to 4 places
         Map.entry("12345.0001", 12345),
         Map.entry("12345.9999", 12345),
         Map.entry("-12345.0001", -12345),
         Map.entry("-12345.9999", -12345));

    private static final Map<String, Number> LONG_VALUES =
        Map.ofEntries(
         // 2**63 - 1
         Map.entry("9223372036854775807", Long.MAX_VALUE),
         Map.entry("9223372036854775807.0", Long.MAX_VALUE),
         Map.entry("9223372036854775807.00", Long.MAX_VALUE),

         // 2**63 truncation to -2**63
         Map.entry("-9223372036854775808", Long.MIN_VALUE),
         Map.entry("-9223372036854775808.1", Long.MIN_VALUE),
         ...
         // truncation to -2**63
         Map.entry("1e63",  -9223372036854775808L),
         Map.entry("-1e63", -9223372036854775808L),
         ...
         // Increasing positive exponents
         Map.entry("10000001e1", 100000010L),
         Map.entry("10000001e10", 100000010000000000L),
         Map.entry("10000001e100", 0L),
         Map.entry("10000001e1000", 0L),
         Map.entry("10000001e10000", 0L),
         Map.entry("10000001e100000", 0L),
         Map.entry("10000001e1000000", 0L),
         Map.entry("10000001e10000000", 0L),

         // Increasing negative exponents
         Map.entry("10000001e-1", 1000000L),
         Map.entry("10000001e-10", 0L),
         Map.entry("10000001e-100", 0L),
         Map.entry("10000001e-1000", 0L),
         Map.entry("10000001e-10000", 0L),
         Map.entry("10000001e-100000", 0L),
         Map.entry("10000001e-1000000", 0L),
         Map.entry("10000001e-10000000", 0L),

         // Currency calculation to 4 places
         Map.entry("12345.0001", 12345L),
    ...
    private static int reportError(Rational r, Number expected, long longValue, boolean isInt) {
        System.err.format("For %s expected %d, actual %d, simple %d%n",
                          r.toString(),
