...
public class RangeTests {
    ...
    /*
     *  Test Rational.add(Rational) when values are within different ranges:
     *  1. within 32 bits
     *  2. within 64 bits
     *  3. outside 64 bits.
     */
    private static int addBoundaryTest() {
        ...
        failures += addTest(
                ...
                new Rational("-85070591730234615847396907784232501248") );
        failures += addTest(
                new Rational("147573952589676412927"),
        ...
        failures += addTest(
                new Rational("79228162514264337593543950335"),
                new Rational(999),
                new Rational("79228162514264337593543951334") );
        failures += addTest(
                new Rational("79228162514264337593543950335"),
                new Rational(Integer.MAX_VALUE/2),
        ...
        failures += addTest(
                new Rational("79228162514264337593543950335"),
                new Rational(Long.MAX_VALUE/2),
                new Rational("79228162518876023611971338238") );
        failures += addTest(
                new Rational("79228162514264337593543950335"),
                new Rational(Long.MIN_VALUE/2),
        ...
        failures += addTest(
                new Rational("-9223372036854775808"),
                Rational.ONE,
                new Rational("-9223372036854775807") );
        failures += addTest(
                new Rational("-9223372036854775808"),
                new Rational(Long.MAX_VALUE/2),
