...
public class FloatDoubleValueTests {
    ...
    static void testDoubleValue() {
        ...
        checkDouble(new Rational(Long.MIN_VALUE), (double)Long.MIN_VALUE);
        checkDouble(new Rational(Long.MAX_VALUE), (double)Long.MAX_VALUE);
    }
    ...
    private static void testSubnormalFloatPowers() {
        ...
        /*
         * Float.MIN_VALUE
         * The region ]0.5*Float.MIN_VALUE, 1.5*Float.MIN_VALUE[ should round to Float.MIN_VALUE.
         */
    ...
    /**
     * For each normal power of two, test at boundaries of
     * region that should convert to that value.
     */
