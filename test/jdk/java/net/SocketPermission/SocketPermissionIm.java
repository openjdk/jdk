 ...
 * @test
 * @bug 8243376
 * @summary SocketPermission implies(Permission p) spec allows, If the object was initialized with a single IP address and one of p's IP addresses is equal to this object's IP address. 
...
public class SocketPermissionIm {
    ...
    public static void main(String[] args) throws Exception {
	     ...
	     do{
		     if (!sp.implies(new SocketPermission(hostname, "connect,resolve"))) {
                     ...
                     addIpToHostsFile(hostname, "1.2.3."+testPass, hostsFileName, true); 
                     Thread.sleep(1000);
    ...
    private  static void addIpToHostsFile( String host,
                                               String addr,
