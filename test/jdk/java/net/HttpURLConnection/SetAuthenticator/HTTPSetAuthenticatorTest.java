 ...
 * @run main/othervm -Dhttp.auth.digest.enabledDigestAlgs=MD5 HTTPSetAuthenticatorTest DIGEST SERVER
 * @run main/othervm -Dhttp.auth.digest.enabledDigestAlgs=MD5 HTTPSetAuthenticatorTest DIGEST PROXY
 * @run main/othervm -Dhttp.auth.digest.enabledDigestAlgs=MD5 HTTPSetAuthenticatorTest DIGEST PROXY305
 * @run main/othervm -Dhttp.auth.digest.enabledDigestAlgs=MD5 HTTPSetAuthenticatorTest DIGEST SERVER307
