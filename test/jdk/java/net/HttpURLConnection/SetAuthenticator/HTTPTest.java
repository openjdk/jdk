 ...
 * @run main/othervm -Dhttp.auth.digest.enabledDigestAlgs=MD5 HTTPTest SERVER
 * @run main/othervm -Dhttp.auth.digest.enabledDigestAlgs=MD5 HTTPTest PROXY
 * @run main/othervm -Dhttp.auth.digest.enabledDigestAlgs=MD5 HTTPTest SERVER307
 * @run main/othervm -Dhttp.auth.digest.enabledDigestAlgs=MD5 HTTPTest PROXY305
 *
 * @author danielfuchs
 */
