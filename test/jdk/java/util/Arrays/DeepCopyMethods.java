...
/**
 * Methods to generate "interesting" random primitives and primitive arrays.
 * Unlike Random.nextXxx, these methods return small values and boundary values
 * (e.g., 0, -1, NaN) with greater than normal likelihood.
 */
