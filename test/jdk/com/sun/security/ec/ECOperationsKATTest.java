...
public class ECOperationsKATTest {
        ...
        public static final List<TestData> testList = new LinkedList<TestData>() {{
                ...
                "A92D8E0A1F3B90D1C43885316C29CFD6140C7F9F7CE3673934296AC75123D320", // x
                "6806A4ACCE9090D6D1696BE118F1F4840C7E538DCEDD3A67755961190842B2E9") // y
                );
                ...
                "98D7709B7CDA3941AB79DBF7138CFAA377B5C678ABF6F965D83D9C300739C50D", // x
                "7B1EB9EC61D7BF427BDB7318EDC44E4E9EC95DD835C02785C6CC4BF834857A8F") // y
                );
...
int main(){
  ...
  rc = BN_hex2bn(&k, "EFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFE"); //check(rc, "set raw key");
  rc = EC_KEY_set_group(key, ec_group);                     check(rc, "set group");
  rc = EC_KEY_set_private_key(key, k);                      check(rc, "set private key");
  rc = EC_POINT_mul(ec_group, pubkey, k, NULL, NULL, ctx);  check(rc, "mult public key");
  rc = EC_KEY_set_public_key(key, pubkey);                  check(rc, "set public key");
  rc = EC_KEY_check_key(key);                               check(rc, "check private key");
  rc = EC_POINT_get_affine_coordinates(ec_group, pubkey, x, y, ctx);   check(rc, "get affine coordinates");
