...
public final class SecurityUtils {
    ...
    /**
     * Checks whether the test run mode is operating in FIPS compliant mode.
     */
    public static boolean isFipsTest() {
        return System.getProperty("test.run.mode", "").equals("fips");
    }
