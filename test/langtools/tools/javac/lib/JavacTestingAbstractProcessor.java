...
public abstract class JavacTestingAbstractProcessor extends AbstractProcessor {
    ...
    public static abstract class AbstractAnnotationValueVisitor<R, P> extends AbstractAnnotationValueVisitorNext<R, P> {
    ...
    @SupportedSourceVersion(RELEASE_22)
    public static abstract class AbstractElementVisitor<R, P> extends AbstractElementVisitorNext<R, P> {
        /**
         * Constructor for concrete subclasses to call.
         */
    ...
    @SupportedSourceVersion(RELEASE_22)
    public static abstract class AbstractTypeVisitor<R, P> extends AbstractTypeVisitorNext<R, P> {
        /**
         * Constructor for concrete subclasses to call.
         */
    ...
    @SupportedSourceVersion(RELEASE_22)
    public static class ElementKindVisitor<R, P> extends ElementKindVisitorNext<R, P> {
        /**
    ...
    @SupportedSourceVersion(RELEASE_22)
    public static class ElementScanner<R, P> extends ElementScannerNext<R, P> {
        /**
         * Constructor for concrete subclasses; uses {@code null} for the
         * default value.
         */
    ...
    @SupportedSourceVersion(RELEASE_22)
    public static class SimpleAnnotationValueVisitor<R, P> extends SimpleAnnotationValueVisitorNext<R, P> {
        /**
         * Constructor for concrete subclasses; uses {@code null} for the
         * default value.
         */
    ...
    @SupportedSourceVersion(RELEASE_22)
    public static class SimpleElementVisitor<R, P> extends SimpleElementVisitorNext<R, P> {
        /**
         * Constructor for concrete subclasses; uses {@code null} for the
         * default value.
         */
    ...
    @SupportedSourceVersion(RELEASE_22)
    public static class SimpleTypeVisitor<R, P> extends SimpleTypeVisitorNext<R, P> {
        /**
         * Constructor for concrete subclasses; uses {@code null} for the
         * default value.
         */
    ...
    @SupportedSourceVersion(RELEASE_22)
    public static class TypeKindVisitor<R, P> extends TypeKindVisitorNext<R, P> {
        /**
