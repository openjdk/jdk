 ...
 * @compile/fail/ref=InstanceofTotalPattern-15.out --release 15 -Xlint:-options -XDrawDiagnostics InstanceofTotalPattern.java
 * @compile/fail/ref=InstanceofTotalPattern-16.out --release 16 -Xlint:-options -XDrawDiagnostics InstanceofTotalPattern.java
