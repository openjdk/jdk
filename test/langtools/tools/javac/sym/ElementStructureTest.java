 ...
 *
 *     java ElementStructureTest generate-hashes $LANGTOOLS_DIR/src/jdk.compiler/data/symbols/include.list (<classes-for-N> N)+
 *
 ...
 *
 *     java ElementStructureTest generate-output $LANGTOOLS_DIR/src/jdk.compiler/data/symbols/include.list (<classes-for-N> N <actual-output-file> <expected-output-file>)+
 *
 * For example, to get the actual and expected output for 6 in /tmp/actual and /tmp/expected, respectively:
 *
 *     java ElementStructureTest generate-output $LANGTOOLS_DIR/src/jdk.compiler/data/symbols/include.list classes-6 6 /tmp/actual /tmp/expected
 */
