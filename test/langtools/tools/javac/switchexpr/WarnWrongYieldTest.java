 ...
 * @compile/ref=WarnWrongYieldTest.out -Xlint:-options --release 13 -XDrawDiagnostics -XDshould-stop.ifError=ATTR -XDshould-stop.ifNoError=ATTR WarnWrongYieldTest.java
 */
