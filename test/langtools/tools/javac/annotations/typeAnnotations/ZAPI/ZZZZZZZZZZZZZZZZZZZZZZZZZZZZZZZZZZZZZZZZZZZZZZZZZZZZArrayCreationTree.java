...
public class ZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZArrayCreationTree {
    public static void main(String[] args) throws Exception {
	PrintWriter out = new PrintWriter(System.out, true);
        JavacTool tool = JavacTool.create();
        File testSrc   = new File(System.getProperty("test.src"));
        StandardJavaFileManager fm = tool.getStandardFileManager(null, null, null);
        Iterable<? extends JavaFileObject> f = fm.getJavaFileObjectsFromFiles(Arrays.asList(new File(testSrc, "ArrayCreationTree.java")));
