    ...
    public void test() {
        ...
        checkOutput("pkg/ClassWithStaticMembers.html", true,
                ...
                """
                    ...
                    ab1 method-summary-table-tab4" role="row" tabindex="0"><code>static void</code></div>
                    ...
                    b1 method-summary-table-tab4" role="row" tabindex="0">
    ...
    public void test2() {
        ...
        checkOutput("pkg2/Spliterator.html", true,
            """
                ...
                <div class="col-first even-row-color" role="row" tabindex="0"><code>static interface&nbsp;</code></div>
                ...
                <div class="col-first odd-row-color" role="row" tabindex="0"><code>static interface&nbsp;</code></div>
        ...
        checkOutput("allclasses-index.html", true,
                ...
                <div class="col-last even-row-color all-classes-table all-classes-table-tab2" role="row" tabindex="0">&n\
                bsp;</div>
                ...
                <div class="col-last odd-row-color all-classes-table all-classes-table-tab1" role="row" tabindex="0">&nb\
                sp;</div>
                ...
                Double</a></div>
                <div class="col-last even-row-color all-classes-table all-classes-table-tab1" role="row" tabindex="0">&n\
                bsp;</div>
                <div class="col-first odd-row-color all-classes-table all-classes-table-tab1"><a\
