...
#define INTEGER_TEST_TABLE(f) \
  ...
  f("0",                       0,            0,            0,                       0                        ) \
  f("-0",                      0,            BAD_VAL,          0,                       BAD_VAL                      ) \
  f("-1",                     -1,            BAD_VAL,         -1,                       BAD_VAL                      ) \
  f("0x1",                     1,            1,            1,                       1                        ) \
  f("-0x1",                   -1,            BAD_VAL,         -1,                       BAD_VAL                      ) \
  ...
  f("2G",                      BAD_VAL,          0x80000000,   2147483648LL,            2147483648ULL            ) \
  f("1T",                      BAD_VAL,          BAD_VAL,          1099511627776LL,         1099511627776ULL         ) \
  f("1t",                      BAD_VAL,          BAD_VAL,          1099511627776LL,         1099511627776ULL         ) \
  f("-1K",                    -1024,         BAD_VAL,         -1024,                    BAD_VAL                      ) \
  f("0x1K",                    1024,         1024,         1024,                    1024                     ) \
  f("-0x1K",                  -1024,         BAD_VAL,         -1024,                    BAD_VAL                      ) \
  f("0K",                      0,            0,            0,                       0                        ) \
  f("0x1000000k",              BAD_VAL,          BAD_VAL,          17179869184LL,           17179869184ULL           ) \
  f("0x800000m",               BAD_VAL,          BAD_VAL,          0x80000000000LL,         0x80000000000ULL         ) \
  f("0x8000g",                 BAD_VAL,          BAD_VAL,          0x200000000000LL,        0x200000000000ULL        ) \
  f("0x8000t",                 BAD_VAL,          BAD_VAL,          0x80000000000000LL,      0x80000000000000ULL      ) \
  f("-0x1000000k",             BAD_VAL,          BAD_VAL,         -17179869184LL,           BAD_VAL                      ) \
  f("-0x800000m",              BAD_VAL,          BAD_VAL,         -0x80000000000LL,         BAD_VAL                      ) \
  f("-0x8000g",                BAD_VAL,          BAD_VAL,         -0x200000000000LL,        BAD_VAL                      ) \
  f("-0x8000t",                BAD_VAL,          BAD_VAL,         -0x80000000000000LL,      BAD_VAL                      ) \
  f("0x7fffffff",              0x7fffffff,   0x7fffffff,   0x7fffffff,              0x7fffffff               ) \
  f("0xffffffff",              BAD_VAL,          0xffffffff,   0xffffffff,              0xffffffff               ) \
  f("0x80000000",              BAD_VAL,          0x80000000,   0x80000000,              0x80000000               ) \
  f("-0x7fffffff",            -2147483647,   BAD_VAL,         -2147483647LL,            BAD_VAL                      ) \
  f("-0x80000000",            -2147483648,   BAD_VAL,         -2147483648LL,            BAD_VAL                      ) \
  f("-0x80000001",             BAD_VAL,          BAD_VAL,         -2147483649LL,            BAD_VAL                      ) \
  f("0x100000000",             BAD_VAL,          BAD_VAL,          0x100000000LL,           0x100000000ULL           ) \
  f("0xcafebabe",              BAD_VAL,          0xcafebabe,   0xcafebabe,              0xcafebabe               ) \
  f("0XCAFEBABE",              BAD_VAL,          0xcafebabe,   0xcafebabe,              0xcafebabe               ) \
  f("0XCAFEbabe",              BAD_VAL,          0xcafebabe,   0xcafebabe,              0xcafebabe               ) \
  f("0xcafebabe1",             BAD_VAL,          BAD_VAL,          0xcafebabe1,             0xcafebabe1              ) \
  f("0x7fffffffffffffff",      BAD_VAL,          BAD_VAL,          max_jlong,               9223372036854775807ULL   ) \
  f("0x8000000000000000",      BAD_VAL,          BAD_VAL,          BAD_VAL,                     9223372036854775808ULL   ) \
  f("0xffffffffffffffff",      BAD_VAL,          BAD_VAL,          BAD_VAL,                     max_julong               ) \
  f("9223372036854775807",     BAD_VAL,          BAD_VAL,          9223372036854775807LL,   9223372036854775807ULL   ) \
  f("9223372036854775808",     BAD_VAL,          BAD_VAL,          BAD_VAL,                     9223372036854775808ULL   ) \
  f("-9223372036854775808",    BAD_VAL,          BAD_VAL,          min_jlong,               BAD_VAL                      ) \
  f("18446744073709551615",    BAD_VAL,          BAD_VAL,          BAD_VAL,                     max_julong               ) \
                                                                                                               \
  ...
  f("0x80000000",              BAD_VAL,          0x80000000,   0x80000000LL,            0x80000000ULL            ) \
  f("0xfffffffe",              BAD_VAL,          max_juint-1,  0xfffffffeLL,            0xfffffffeULL            ) \
  f("0xffffffff",              BAD_VAL,          max_juint,    0xffffffffLL,            0xffffffffULL            ) \
  f("0x100000000",             BAD_VAL,          BAD_VAL,          0x100000000LL,           0x100000000ULL           ) \
  f("-0x7fffffff",             min_jint+1,   BAD_VAL,         -0x7fffffffLL,            BAD_VAL                      ) \
  f("-0x80000000",             min_jint,     BAD_VAL,         -0x80000000LL,            BAD_VAL                      ) \
  f("-0x80000001",             BAD_VAL,          BAD_VAL,         -0x80000001LL,            BAD_VAL                      ) \
                                                                                                               \
  f("0x7ffffffffffffffe",      BAD_VAL,          BAD_VAL,          max_jlong-1,             0x7ffffffffffffffeULL    ) \
  f("0x7fffffffffffffff",      BAD_VAL,          BAD_VAL,          max_jlong,               0x7fffffffffffffffULL    ) \
  f("0x8000000000000000",      BAD_VAL,          BAD_VAL,          BAD_VAL,                     0x8000000000000000ULL    ) \
  f("0xfffffffffffffffe",      BAD_VAL,          BAD_VAL,          BAD_VAL,                     max_julong-1             ) \
  f("0xffffffffffffffff",      BAD_VAL,          BAD_VAL,          BAD_VAL,                     max_julong               ) \
  f("0x10000000000000000",     BAD_VAL,          BAD_VAL,          BAD_VAL,                     BAD_VAL                      ) \
  f("-0x7fffffffffffffff",     BAD_VAL,          BAD_VAL,          min_jlong+1,             BAD_VAL                      ) \
  f("-0x8000000000000000",     BAD_VAL,          BAD_VAL,          min_jlong,               BAD_VAL                      ) \
  f("-0x8000000000000001",     BAD_VAL,          BAD_VAL,          BAD_VAL,                     BAD_VAL                      ) \
                                                                                                               \
  ...
  f("0x200000k",               BAD_VAL,          0x200000U * k,0x200000LL * k,          0x200000ULL * k          ) \
  f("0x3ffffek",               BAD_VAL,          0x3ffffeU * k,0x3ffffeLL * k,          0x3ffffeULL * k          ) \
  f("0x3fffffk",               BAD_VAL,          0x3fffffU * k,0x3fffffLL * k,          0x3fffffULL * k          ) \
  f("0x400000k",               BAD_VAL,          BAD_VAL,          0x400000LL * k,          0x400000ULL * k          ) \
  f("-0x1fffffk",             -0x1fffff * k, BAD_VAL,         -0x1fffffLL * k,          BAD_VAL                      ) \
  f("-0x200000k",             -0x200000 * k, BAD_VAL,         -0x200000LL * k,          BAD_VAL                      ) \
  f("-0x200001k",              BAD_VAL,          BAD_VAL,         -0x200001LL * k,          BAD_VAL                      ) \
                                                                                                               \
  f("0x1ffffffffffffek",       BAD_VAL,          BAD_VAL,          0x1ffffffffffffeLL * k,  0x1ffffffffffffeULL * k  ) \
  f("0x1fffffffffffffk",       BAD_VAL,          BAD_VAL,          0x1fffffffffffffLL * k,  0x1fffffffffffffULL * k  ) \
  f("0x20000000000000k",       BAD_VAL,          BAD_VAL,          BAD_VAL,                     0x20000000000000ULL * k  ) \
  f("0x3ffffffffffffek",       BAD_VAL,          BAD_VAL,          BAD_VAL,                     0x3ffffffffffffeULL * k  ) \
  f("0x3fffffffffffffk",       BAD_VAL,          BAD_VAL,          BAD_VAL,                     0x3fffffffffffffULL * k  ) \
  f("0x40000000000000k",       BAD_VAL,          BAD_VAL,          BAD_VAL,                     BAD_VAL                      ) \
  f("-0x1fffffffffffffk",      BAD_VAL,          BAD_VAL,         -0x1fffffffffffffLL * k,  BAD_VAL                      ) \
  f("-0x20000000000000k",      BAD_VAL,          BAD_VAL,         -0x20000000000000LL * k,  BAD_VAL                      ) \
  f("-0x20000000000001k",      BAD_VAL,          BAD_VAL,          BAD_VAL,                     BAD_VAL                      ) \
                                                                                                               \
  /* edge cases for suffix: M */                                                                               \
  f("0x7fem",                  0x7fe * m,    0x7feU * m,   0x7feLL * m,             0x7feULL * m             ) \
  f("0x7ffm",                  0x7ff * m,    0x7ffU * m,   0x7ffLL * m,             0x7ffULL * m             ) \
  f("0x800m",                  BAD_VAL,          0x800U * m,   0x800LL * m,             0x800ULL * m             ) \
  f("0xffem",                  BAD_VAL,          0xffeU * m,   0xffeLL * m,             0xffeULL * m             ) \
  f("0xfffm",                  BAD_VAL,          0xfffU * m,   0xfffLL * m,             0xfffULL * m             ) \
  f("0x1000m",                 BAD_VAL,          BAD_VAL,          0x1000LL * m,            0x1000ULL * m            ) \
  f("-0x7ffm",                -0x7ff * m,    BAD_VAL,         -0x7ffLL * m,             BAD_VAL                      ) \
  f("-0x800m",                -0x800 * m,    BAD_VAL,         -0x800LL * m,             BAD_VAL                      ) \
  f("-0x801m",                 BAD_VAL,          BAD_VAL,         -0x801LL * m,             BAD_VAL                      ) \
                                                                                                               \
  f("0x7fffffffffem",          BAD_VAL,          BAD_VAL,          0x7fffffffffeLL * m,     0x7fffffffffeULL * m     ) \
  f("0x7ffffffffffm",          BAD_VAL,          BAD_VAL,          0x7ffffffffffLL * m,     0x7ffffffffffULL * m     ) \
  f("0x80000000000m",          BAD_VAL,          BAD_VAL,          BAD_VAL,                     0x80000000000ULL * m     ) \
  f("0xffffffffffem",          BAD_VAL,          BAD_VAL,          BAD_VAL,                     0xffffffffffeULL * m     ) \
  f("0xfffffffffffm",          BAD_VAL,          BAD_VAL,          BAD_VAL,                     0xfffffffffffULL * m     ) \
  f("0x100000000000m",         BAD_VAL,          BAD_VAL,          BAD_VAL,                     BAD_VAL                      ) \
  f("-0x7ffffffffffm",         BAD_VAL,          BAD_VAL,         -0x7ffffffffffLL * m,     BAD_VAL                      ) \
  f("-0x80000000000m",         BAD_VAL,          BAD_VAL,         -0x80000000000LL * m,     BAD_VAL                      ) \
  f("-0x80000000001m",         BAD_VAL,          BAD_VAL,          BAD_VAL,                     BAD_VAL                      ) \
                                                                                                               \
  /* edge cases for suffix: G */                                                                               \
  f("0x0g",                    0x0 * g,      0x0U * g,     0x0LL * g,               0x0ULL * g               ) \
  f("0x1g",                    0x1 * g,      0x1U * g,     0x1LL * g,               0x1ULL * g               ) \
  f("0x2g",                    BAD_VAL,          0x2U * g,     0x2LL * g,               0x2ULL * g               ) \
  f("0x3g",                    BAD_VAL,          0x3U * g,     0x3LL * g,               0x3ULL * g               ) \
  f("0x4g",                    BAD_VAL,          BAD_VAL,          0x4LL * g,               0x4ULL * g               ) \
  f("-0x1g",                  -0x1 * g,      BAD_VAL,         -0x1LL * g,               BAD_VAL                      ) \
  f("-0x2g",                  -0x2 * g,      BAD_VAL,         -0x2LL * g,               BAD_VAL                      ) \
  f("-0x3g",                   BAD_VAL,          BAD_VAL,         -0x3LL * g,               BAD_VAL                      ) \
                                                                                                               \
  f("0x1fffffffeg",            BAD_VAL,          BAD_VAL,          0x1fffffffeLL * g,       0x1fffffffeULL * g       ) \
  f("0x1ffffffffg",            BAD_VAL,          BAD_VAL,          0x1ffffffffLL * g,       0x1ffffffffULL * g       ) \
  f("0x200000000g",            BAD_VAL,          BAD_VAL,          BAD_VAL,                     0x200000000ULL * g       ) \
  f("0x3fffffffeg",            BAD_VAL,          BAD_VAL,          BAD_VAL,                     0x3fffffffeULL * g       ) \
  f("0x3ffffffffg",            BAD_VAL,          BAD_VAL,          BAD_VAL,                     0x3ffffffffULL * g       ) \
  f("0x400000000g",            BAD_VAL,          BAD_VAL,          BAD_VAL,                     BAD_VAL                      ) \
  f("-0x1ffffffffg",           BAD_VAL,          BAD_VAL,         -0x1ffffffffLL * g,       BAD_VAL                      ) \
  f("-0x200000000g",           BAD_VAL,          BAD_VAL,         -0x200000000LL * g,       BAD_VAL                      ) \
  f("-0x200000001g",           BAD_VAL,          BAD_VAL,          BAD_VAL,                     BAD_VAL                      ) \
                                                                                                               \
  /* edge cases for suffix: T */                                                                               \
  f("0x7ffffet",               BAD_VAL,          BAD_VAL,          0x7ffffeLL * t,          0x7ffffeULL * t          ) \
  f("0x7ffffft",               BAD_VAL,          BAD_VAL,          0x7fffffLL * t,          0x7fffffULL * t          ) \
  f("0x800000t",               BAD_VAL,          BAD_VAL,          BAD_VAL,                     0x800000ULL * t          ) \
  f("0xfffffet",               BAD_VAL,          BAD_VAL,          BAD_VAL,                     0xfffffeULL * t          ) \
  f("0xfffffft",               BAD_VAL,          BAD_VAL,          BAD_VAL,                     0xffffffULL * t          ) \
  f("0x1000000t",              BAD_VAL,          BAD_VAL,          BAD_VAL,                     BAD_VAL                      ) \
  f("-0x7ffffft",              BAD_VAL,          BAD_VAL,         -0x7fffffLL * t,          BAD_VAL                      ) \
  f("-0x800000t",              BAD_VAL,          BAD_VAL,         -0x800000LL * t,          BAD_VAL                      ) \
  f("-0x800001t",              BAD_VAL,          BAD_VAL,          BAD_VAL,                     BAD_VAL                      )
