...
public class CheckReservedInitialCodeCacheSizeArgOrder {
    public static void main(String[] args) throws Exception {
        ...
        pb1 = ProcessTools.createLimitedJavaTestProcessBuilder("-XX:InitialCodeCacheSize=4m", "-XX:ReservedCodeCacheSize=8m", "-version");
        pb2 = ProcessTools.createLimitedJavaTestProcessBuilder("-XX:ReservedCodeCacheSize=8m", "-XX:InitialCodeCacheSize=4m", "-version");
