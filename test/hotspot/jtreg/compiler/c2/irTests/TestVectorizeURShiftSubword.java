...
public class TestVectorizeURShiftSubword {
    ...
    @Test
    @IR(counts = {IRNode.LOAD_VB, ">0", IRNode.RSHIFT_VB, ">0", IRNode.STORE_VECTOR, ">0"})
    ...
    @Test
    @IR(failOn = {IRNode.LOAD_VB, IRNode.RSHIFT_VB, IRNode.STORE_VECTOR})
    ...
    @Test
    @IR(counts = {IRNode.LOAD_VS, ">0", IRNode.RSHIFT_VS, ">0", IRNode.STORE_VECTOR, ">0"})
    ...
    @Test
    @IR(failOn = {IRNode.LOAD_VS, IRNode.RSHIFT_VS, IRNode.STORE_VECTOR})
