...
public class TestJtreg {
    ...
    public static void primitiveConTest() {
        ...
        long v0 = primitiveConTest_compiled(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
        long v1 = primitiveConTest_reference(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
        if (v0 != v1) {
    ...
    public static long primitiveConTest_compiled(int arg0, float arg1, float arg2, float arg3, long arg4, long arg5, int arg6) {
        arg5 = (long)Math.min(Math.max(arg5, 8796093022205L), -3297683376527800628L);
        arg5 = (long)((arg5 & 1541862882599486797L) | -4294967288L);
        return Long.compress(arg5, Integer.toUnsignedLong(arg6));
    }

    public static long primitiveConTest_reference(int arg0, float arg1, float arg2, float arg3, long arg4, long arg5, int arg6) {
        arg5 = (long)Math.min(Math.max(arg5, 8796093022205L), -3297683376527800628L);
        arg5 = (long)((arg5 & 1541862882599486797L) | -4294967288L);
        return Long.compress(arg5, Integer.toUnsignedLong(arg6));
    }
