...
public class TestOnSpinWaitAArch64DefaultFlags {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (isCPUModelNeoverseN1(cpuModel)) {
            checkFinalFlagsEqualTo(ProcessTools.createLimitedJavaTestProcessBuilder("-XX:+UnlockDiagnosticVMOptions", "-XX:+PrintFlagsFinal", "-version"),
                "isb", "1");
            checkFinalFlagsEqualTo(ProcessTools.createLimitedJavaTestProcessBuilder("-XX:+UnlockDiagnosticVMOptions", "-XX:OnSpinWaitInstCount=2", "-XX:+PrintFlagsFinal", "-version"),
                "isb", "2");
        } else {
