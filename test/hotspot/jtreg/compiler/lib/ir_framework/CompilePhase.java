...
public enum CompilePhase {
    ...
    AFTER_LOOP_PREDICATION("After loop predication"),
    BEFORE_PARTIAL_PEEL("Before partial peeling"),
    AFTER_PARTIAL_PEEL("After partial peeling"),
    BEFORE_LOOP_PEEL("Before loop peeling"),
    AFTER_LOOP_PEEL("After loop peeling"),
    BEFORE_LOOP_UNSWITCH("Before loop unswitching"),
    AFTER_LOOP_UNSWITCH("After loop unswitching"),
    BEFORE_RANGE_CHECK_ELIMINATION("Before range check elimination"),
    AFTER_RANGE_CHECK_ELIMINATION("After range check elimination"),
    BEFORE_PRE_POST_LOOPS("Before pre/post loops"),
    AFTER_PRE_POST_LOOPS("After pre/post loops"),
