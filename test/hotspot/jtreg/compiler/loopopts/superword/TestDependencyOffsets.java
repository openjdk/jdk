...
public class TestDependencyOffsets {
    ...
    @IR(counts = {IRNode.LOAD_VI, "> 0", IRNode.MUL_VI, "> 0", IRNode.STORE_VECTOR, "> 0"},
    ...
    @IR(failOn = {IRNode.LOAD_VI, IRNode.MUL_VI, IRNode.STORE_VECTOR},
    ...
    @IR(counts = {IRNode.LOAD_VL, "> 0", IRNode.ADD_VL, "> 0", IRNode.STORE_VECTOR, "> 0"},
    ...
    @IR(counts = {IRNode.LOAD_VL, "> 0", IRNode.ADD_VL, "> 0", IRNode.STORE_VECTOR, "> 0"},
        ...
        applyIfCPUFeatureAnd = {"sse4.1", "true", "avx2", "false"})
    //   Strict alignment not possible.
    @IR(failOn = {IRNode.LOAD_VL, IRNode.ADD_VL, IRNode.STORE_VECTOR},
        applyIf = {"AlignVector", "true"},
        applyIfCPUFeatureAnd = {"sse4.1", "true", "avx2", "false"})
    // CPU: avx2 -> vector_width: 32 -> elements in vector: 4
    @IR(counts = {IRNode.LOAD_VL, "> 0", IRNode.ADD_VL, "> 0", IRNode.STORE_VECTOR, "> 0"},
    ...
    @IR(counts = {IRNode.LOAD_VS, "> 0", IRNode.MUL_VS, "> 0", IRNode.STORE_VECTOR, "> 0"},
    ...
    @IR(counts = {IRNode.LOAD_VS, "> 0", IRNode.MUL_VS, "> 0", IRNode.STORE_VECTOR, "> 0"},
        ...
        applyIfCPUFeatureAnd = {"sse4.1", "true", "avx2", "false"})
    //   Strict alignment not possible.
    @IR(failOn = {IRNode.LOAD_VS, IRNode.MUL_VS, IRNode.STORE_VECTOR},
        applyIf = {"AlignVector", "true"},
        applyIfCPUFeatureAnd = {"sse4.1", "true", "avx2", "false"})
    // CPU: avx2 to avx512 without avx512bw -> vector_width: 32 -> elements in vector: 16
    @IR(counts = {IRNode.LOAD_VS, "> 0", IRNode.MUL_VS, "> 0", IRNode.STORE_VECTOR, "> 0"},
    ...
    @Test
    // CPU: sse4.1 to avx -> vector_width: 16 -> elements in vector: 8
    @IR(counts = {IRNode.LOAD_VC, "> 0", IRNode.MUL_VS, "> 0", IRNode.STORE_VECTOR, "> 0"},
        applyIfAnd = {"AlignVector", "false", "MaxVectorSize", ">= 4"},
        applyIfCPUFeatureAnd = {"sse4.1", "true", "avx2", "false"})
    // CPU: avx2 to avx512 without avx512bw -> vector_width: 32 -> elements in vector: 16
    @IR(counts = {IRNode.LOAD_VC, "> 0", IRNode.MUL_VS, "> 0", IRNode.STORE_VECTOR, "> 0"},
    ...
    @IR(counts = {IRNode.LOAD_VC, "> 0", IRNode.MUL_VS, "> 0", IRNode.STORE_VECTOR, "> 0"},
        ...
        applyIfCPUFeatureAnd = {"sse4.1", "true", "avx2", "false"})
    //   Strict alignment not possible.
    @IR(failOn = {IRNode.LOAD_VC, IRNode.MUL_VS, IRNode.STORE_VECTOR},
        applyIf = {"AlignVector", "true"},
        applyIfCPUFeatureAnd = {"sse4.1", "true", "avx2", "false"})
    // CPU: avx2 to avx512 without avx512bw -> vector_width: 32 -> elements in vector: 16
    @IR(counts = {IRNode.LOAD_VC, "> 0", IRNode.MUL_VS, "> 0", IRNode.STORE_VECTOR, "> 0"},
    ...
    @IR(counts = {IRNode.LOAD_VB, "> 0", IRNode.MUL_VB, "> 0", IRNode.STORE_VECTOR, "> 0"},
        applyIfAnd = {"AlignVector", "false", "MaxVectorSize", ">= 4"},
        applyIfCPUFeatureAnd = {"sse4.1", "true", "avx2", "false"})
    ...
    @IR(counts = {IRNode.LOAD_VB, "> 0", IRNode.MUL_VB, "> 0", IRNode.STORE_VECTOR, "> 0"},
        ...
        applyIfCPUFeatureAnd = {"sse4.1", "true", "avx2", "false"})
    //   Strict alignment not possible.
    @IR(failOn = {IRNode.LOAD_VB, IRNode.MUL_VB, IRNode.STORE_VECTOR},
        applyIf = {"AlignVector", "true"},
        applyIfCPUFeatureAnd = {"sse4.1", "true", "avx2", "false"})
    // CPU: avx2 to avx512 without avx512bw -> vector_width: 32 -> elements in vector: 32
    @IR(counts = {IRNode.LOAD_VB, "> 0", IRNode.MUL_VB, "> 0", IRNode.STORE_VECTOR, "> 0"},
    ...
    @IR(counts = {IRNode.LOAD_VF, "> 0", IRNode.MUL_VF, "> 0", IRNode.STORE_VECTOR, "> 0"},
        applyIfAnd = {"AlignVector", "false", "MaxVectorSize", ">= 8"},
    ...
    @IR(counts = {IRNode.LOAD_VF, "> 0", IRNode.MUL_VF, "> 0", IRNode.STORE_VECTOR, "> 0"},
        ...
        applyIfCPUFeatureAnd = {"sse4.1", "true", "avx", "false"})
    //   Strict alignment not possible.
    @IR(failOn = {IRNode.LOAD_VF, IRNode.MUL_VF, IRNode.STORE_VECTOR},
        applyIf = {"AlignVector", "true"},
        applyIfCPUFeatureAnd = {"sse4.1", "true", "avx", "false"})
    // CPU: avx and avx2 -> vector_width: 32 -> elements in vector: 8
    @IR(counts = {IRNode.LOAD_VF, "> 0", IRNode.MUL_VF, "> 0", IRNode.STORE_VECTOR, "> 0"},
    ...
    @IR(counts = {IRNode.LOAD_VD, "> 0", IRNode.MUL_VD, "> 0", IRNode.STORE_VECTOR, "> 0"},
        applyIfAnd = {"AlignVector", "false", "MaxVectorSize", ">= 16"},
        applyIfCPUFeatureAnd = {"sse4.1", "true", "avx", "false"})
    ...
    @IR(counts = {IRNode.LOAD_VD, "> 0", IRNode.MUL_VD, "> 0", IRNode.STORE_VECTOR, "> 0"},
        ...
        applyIfCPUFeatureAnd = {"sse4.1", "true", "avx", "false"})
    //   Strict alignment not possible.
    @IR(failOn = {IRNode.LOAD_VD, IRNode.MUL_VD, IRNode.STORE_VECTOR},
        applyIf = {"AlignVector", "true"},
        applyIfCPUFeatureAnd = {"sse4.1", "true", "avx", "false"})
    // CPU: avx and avx2 -> vector_width: 32 -> elements in vector: 4
    @IR(counts = {IRNode.LOAD_VD, "> 0", IRNode.MUL_VD, "> 0", IRNode.STORE_VECTOR, "> 0"},
