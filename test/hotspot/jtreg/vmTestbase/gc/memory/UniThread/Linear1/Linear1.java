 ...
 * @key stress
 *
 * @summary converted from VM Testbase gc/memory/UniThread/Linear1.
 ...
 *
 * The test simply creates a series of singly
 ...
 * of lists is large.
 */
public class Linear1 extends GCTestBase {
        ...
        public Linear1(int objectSize, int circularitySize) {
                ...
                try {
                        while (stresser.iteration()) {
                                ...
                                for (int i = 0; i < arraySize && stresser.continueExecution(); ++i) {
                                        memoryArray[i] = Memory.makeLinearList(circularitySize, objectSize);
                                }
                        }
                } finally {
                        stresser.finish();
