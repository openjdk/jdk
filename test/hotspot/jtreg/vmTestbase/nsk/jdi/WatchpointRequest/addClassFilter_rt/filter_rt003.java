 ...
 * <code>com.sun.jdi.WatchpointRequest.addClassFilter(ReferenceType)</code> <BR>
...
public class filter_rt003 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new filter_rt003().runThis(argv, out);
    ...
    private String testedClassName1 =
      "nsk.jdi.WatchpointRequest.addClassFilter_rt.filter_rt003aTestClass10";
            ...
            switch (i) {
              ...
              case 0:
                     ...
                     try {
                         ...
                         ((AccessWatchpointRequest)eventRequest1).addClassFilter(testClassReference);
