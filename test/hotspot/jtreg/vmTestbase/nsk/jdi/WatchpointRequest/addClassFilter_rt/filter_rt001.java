...
public class filter_rt001 extends TestDebuggerType1 {
    ...
    public static int run (String argv[], PrintStream out) {
        debuggeeName = "nsk.jdi.WatchpointRequest.addClassFilter_rt.filter_rt001a";
        return new filter_rt001().runThis(argv, out);
    }

    String className1 = "nsk.jdi.WatchpointRequest.addClassFilter_rt.TestClass10";
    String className2 = "nsk.jdi.WatchpointRequest.addClassFilter_rt.TestClass11";
