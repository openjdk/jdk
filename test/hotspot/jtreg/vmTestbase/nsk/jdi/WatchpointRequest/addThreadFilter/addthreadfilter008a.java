...
/**
 * This class is used as debuggee application for the addthreadfilter008 JDI test.
 */

public class addthreadfilter008a {
    ...
    static addthreadfilter008aTestClass objTC = new addthreadfilter008aTestClass();
    ...
    static class Threadaddthreadfilter008a extends NamedTask {

        int tNumber;

        public Threadaddthreadfilter008a(String threadName) {
            super(threadName);
            tNumber = number;
            number++;
...
class addthreadfilter008aTestClass {
