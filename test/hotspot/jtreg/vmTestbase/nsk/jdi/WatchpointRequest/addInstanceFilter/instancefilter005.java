 ...
 * This request is AccessWatchpointRequest.                     <BR>
 * <BR>
 ...
 *   a WatchpointRequest and if addInstanceFilter() is not supported,   <BR>
...
public class instancefilter005 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new instancefilter005().runThis(argv, out);
    ...
    private String testedClassName =
      "nsk.jdi.WatchpointRequest.addInstanceFilter.instancefilter005aTestClass";
