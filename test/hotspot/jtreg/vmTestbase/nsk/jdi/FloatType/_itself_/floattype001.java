...
package nsk.jdi.FloatType._itself_;
 ...
 * FloatType.                                                   <BR>
 *                                                              <BR>
 * The test checks that for a mirror of a float value the casts <BR>
 * from Type to FloatType and from PrimitiveType to FloatType   <BR>
 * don't throw ClassCastException.                              <BR>
 * <BR>
 ...
 * <BR>
 * In second phase to check the casts,                                  <BR>
 ...
 * - The debuggee prepares a float field and invokes                    <BR>
 ...
 *   the debugger performs the checks.                                  <BR>
...
public class floattype001 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new floattype001().runThis(argv, out);
