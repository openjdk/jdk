...
//    static TestClass obj = new TestClass();
    ...
    //------------------------------------------------------  section tested
                ...
                case 0:
                         ...
                         label:
                         synchronized (Threadnewinstance002a.lockingObject) {
                             synchronized (Threadnewinstance002a.waitnotifyObj) {
                                 ...
                                 try {
                                     ...
                                     Threadnewinstance002a.waitnotifyObj.wait();
