 ...
 * The cases to check include event set containing three more   <BR>
 * VMDeathRequests with suspendPolicies                         <BR>
 *      SUSPEND_ALL, SUSPEND_NONE, and SUSPEND_EVENT_THREAD.    <BR>
 * <BR>
...
public class suspendpolicy017 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new suspendpolicy017().runThis(argv, out);
    ...
    */
    ...
    //------------------------------------------------------  testing section
        ...
        policyToCheck = policyExpected[6];
        mainThread.resume();
