 ...
 * <BR>
 * The test checks that for a MethodExitEvent set,              <BR>
...
public class suspendpolicy007 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new suspendpolicy007().runThis(argv, out);
        ...
        for (int i = 0; ; i++) {
            ...
            switch (i) {
              ...
              case 3:
                      eventRequest1 = settingMethodExitRequest (mainThread,
                                             testClassReference,
                                             SUSPEND_NONE, "MethodExitRequest4");
                      eventRequest1.enable();
                      eventRequest2 = settingMethodExitRequest (mainThread,
                                             testClassReference,
                                             SUSPEND_THREAD, "MethodExitRequest5");
                      eventRequest2.enable();
                      break;
              ...
              case 4:
                      eventRequest1 = settingMethodExitRequest (mainThread,
                                             testClassReference,
                                             SUSPEND_NONE, "MethodExitRequest6");
                      eventRequest1.enable();
                      eventRequest3 = settingMethodExitRequest (mainThread,
                                             testClassReference,
                                             SUSPEND_ALL, "MethodExitRequest7");
                      eventRequest3.enable();
                      break;
              ...
              case 5:
                      eventRequest2 = settingMethodExitRequest (mainThread,
                                             testClassReference,
                                             SUSPEND_THREAD, "MethodExitRequest8");
                      eventRequest2.enable();
                      eventRequest3 = settingMethodExitRequest (mainThread,
                                             testClassReference,
              ...
              case 6:
                      ...
                      eventRequest2 = settingMethodExitRequest (mainThread,
                                             testClassReference,
                                             SUSPEND_THREAD, "MethodExitRequest11");
                      eventRequest2.enable();
                      eventRequest3 = settingMethodExitRequest (mainThread,
                                             testClassReference,
                                             SUSPEND_ALL, "MethodExitRequest12");
                      eventRequest3.enable();
                      break;
            ...
            if ( !( newEvent instanceof MethodExitEvent)) {
                ...
                log2("       Event is instanceof MethodExitEvent");
