 ...
 * <code>com.sun.jdi.MethodEntryRequest.addClassExclusionFilter()</code> <BR>
 ...
 *   - creates an MethodEntryRequest and enables it,                    <BR>
 *   - invokes the method addClassExclusionFilter() on the request      <BR>
 *     expecting to catch InvalidRequestStateException,                 <BR>
 *   - disables the request and invokes the method addClassExclusionFilter()    <BR>
...
public class filter002 {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new filter002().runThis(argv, out);
    ...
    //------------------------------------------------------  testing section
        ...
        for (int i = 0; ; i++) {
            ...
            switch (i) {
              ...
              case 0:
                     eventRequest1 = setting23MethodEntryRequest(null, testedClassName1,
                                              EventRequest.SUSPEND_NONE, property1);

                     eventRequest1.enable();

                     try {
                         log2("......eventRequest1.addClassFilter(testedClassName1);");
                         log2("        InvalidRequestStateException expected");
                         ((MethodEntryRequest)eventRequest1).addClassFilter(testedClassName1);
...
//            log2("       eventIterator = eventSet.eventIterator;");
    ...
    private MethodEntryRequest setting23MethodEntryRequest ( ThreadReference thread,
        ...
        try {
            ...
            menr.addClassExclusionFilter(testedClass);
            menr.setSuspendPolicy(suspendPolicy);
            menr.addCountFilter(1);
