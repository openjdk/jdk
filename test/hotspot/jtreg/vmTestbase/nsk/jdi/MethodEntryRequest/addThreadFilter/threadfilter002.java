 ...
 * <code>com.sun.jdi.MethodEntryRequest.addThreadFilter()</code><BR>
...
public class threadfilter002 {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new threadfilter002().runThis(argv, out);
    ...
    private String testedClassName =
      "nsk.jdi.MethodEntryRequest.addThreadFilter.threadfilter002aTestClass";
