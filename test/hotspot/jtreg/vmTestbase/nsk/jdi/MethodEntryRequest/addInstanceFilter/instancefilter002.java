 ...
 * MethodEntryRequest.                                          <BR>
 *                                                              <BR>
 * The test checks that results of the method                   <BR>
 * <code>com.sun.jdi.MethodEntryRequest.addInstanceFilter()</code><BR>
 ...
 * - The debuggee creates new thread, thread1, and invokes              <BR>
 ...
 *   - creates a MethodEntryRequest and enables it,                     <BR>
 *   - invokes the method addInstanceFilter() on the request expecting  <BR>
 *     to catch InvalidRequestStateException,                           <BR>
 *   - disables the request and invokes the method addInstanceFilter()  <BR>
 *     expecting to catch no InvalidRequestStateException,              <BR>
 *   - deletes the request and invokes the method addInstanceFilter()   <BR>
...
public class instancefilter002 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new instancefilter002().runThis(argv, out);
    ...
    private String testedClassName =
        "nsk.jdi.MethodEntryRequest.addInstanceFilter.instancefilter002aTestClass";
    ...
    */
    ...
    private void testRun()
        ...
        if ( !vm.canUseInstanceFilters() ) {
            log2("......vm.canUseInstanceFilters == false :: test cancelled");
            vm.exit(PASS_BASE);
            return;
        }
        ...
        for (int i = 0; ; i++) {
            ...
            switch (i) {
              ...
              case 0:
                      ...
                      eventRequest1 = setting2MethodEntryRequest (null,
                                             testClassReference,
