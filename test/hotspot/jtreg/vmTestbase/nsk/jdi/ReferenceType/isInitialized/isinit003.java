...
public class isinit003 {
    ...
    private final static String prefix = "nsk.jdi.ReferenceType.isInitialized.";
    private final static String className = "isinit003";
    ...
    private static void check (String fieldName) {
        try {
            ...
            if (checkedClass.isInitialized()) {
                display("ReferenceType.isInitialized() returned expected true for type: " + className);
            } else {
                complain("ReferenceType.isInitialized() returned unexpected false for type: " + className);
                exitStatus = Consts.TEST_FAILED;
            }
