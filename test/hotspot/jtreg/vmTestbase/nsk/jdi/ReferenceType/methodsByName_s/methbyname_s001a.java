...
//                ("**> methbyname_s001a: load class: Throwable thrown = " + thrown.toString());
        ...
        System.err.println("!!**> methbyname_s001a: FAILED!");
        System.exit(2/*STATUS_FAILED*/ + 95/*STATUS_TEMP*/);
    }
}

abstract class methbyname_s001aClassForCheck extends methbyname_s001aSuperClassForCheck implements methbyname_s001aInterfaceForCheck {
...
abstract class methbyname_s001aSuperClassForCheck  {
...
interface methbyname_s001aInterfaceForCheck {
