...
//        package_prefix = "";    //  for DEBUG without package
    ...
    public static void main (String argv[]) {
        ...
        System.err.println("!!**> fieldbyname002a: FAILED!");
 ...
 */
class fieldbyname002aClassLoader extends ClassLoader {

    private String classPath;
    public static Class loadedClass;

    public fieldbyname002aClassLoader(String classPath, String className) {
        super(fieldbyname002aClassLoader.class.getClassLoader());
