...
public class visibmethod006t {
    ...
    public static int run(String args[]) {
        ...
        pipe.println(visibmethod006.COMMAND_READY);
        String cmd = pipe.readln();
        if (cmd.equals(visibmethod006.COMMAND_QUIT)) {
            System.err.println("Debuggee: exiting due to the command: "
                + cmd);
            return Consts.TEST_PASSED;
        }

        int stopMeHere = 0; // visibmethod006.DEBUGGEE_STOPATLINE
