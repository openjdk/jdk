...
/**
 * This class is used as debugee application for the methods002 JDI test.
 */
...
//        package_prefix = "";    //  for DEBUG without package
    ...
    public static void main (String argv[]) {
        ...
        System.err.println("!!**> methods002a: FAILED!");
 ...
 */
class methods002aClassLoader extends ClassLoader {

    private String classPath;
    public static Class loadedClass;

    public methods002aClassLoader(String classPath, String className) {
        super(methods002aClassLoader.class.getClassLoader());
