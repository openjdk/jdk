...
//        package_prefix = "";    //  for DEBUG without package
    ...
    public static void main (String argv[]) {
        ...
        System.err.println("!!**> visibfield002a: FAILED!");
 ...
 */
class visibfield002aClassLoader extends ClassLoader {

    private String classPath;
    public static Class loadedClass;

    public visibfield002aClassLoader(String classPath, String className) {
        super(visibfield002aClassLoader.class.getClassLoader());
