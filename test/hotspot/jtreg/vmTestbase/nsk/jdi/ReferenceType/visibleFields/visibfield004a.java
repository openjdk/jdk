...
public class visibfield004a {
    ...
    public static void main (String argv[]) {
        ...
        System.err.println("##> visibfield004a: FAILED!");
        System.exit(2/*STATUS_FAILED*/ + 95/*STATUS_TEMP*/);
    }
}

class visibfield004aClassForCheck extends visibfield004aSuperClassForCheck
    implements visibfield004aInterfaceForCheck {}

class visibfield004aSuperClassForCheck  {

    int    ambiguous_prim_field;
    Class  ambiguous_ref_field;
