...
public class visibfield005t {
    ...
    public static int run(String args[]) {
        ...
        pipe.println(visibfield005.COMMAND_READY);
        String cmd = pipe.readln();
        if (cmd.equals(visibfield005.COMMAND_QUIT)) {
            System.err.println("Debuggee: exiting due to the command: "
                + cmd);
            return Consts.TEST_PASSED;
        }

        int stopMeHere = 0; // visibfield005.DEBUGGEE_STOPATLINE
