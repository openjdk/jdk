...
public class allfields001a {
    ...
    public static void main (String argv[]) {
        ...
        System.err.println("!!**> allfields001a: FAILED!");
        System.exit(2/*STATUS_FAILED*/ + 95/*STATUS_TEMP*/);
    }
}

class allfields001aClassForCheck extends allfields001aSuperClassForCheck implements allfields001aInterfaceForCheck {
    ...
    static long    i_super_hidden_prim_field;
    static Object  i_super_hidden_ref_field;

    static long    s_interf_hidden_prim_field;
    static Object  s_interf_hidden_ref_field;

}

class allfields001aSuperClassForCheck  {
...
interface allfields001aInterfaceForCheck {
