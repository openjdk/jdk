...
public class getvalue002a {
    ...
    //------------------------------------------------------  section tested
                ...
                case 0:
                         ...
                         label:
                         synchronized (Threadgetvalue002a.lockingObject) {
                             synchronized (Threadgetvalue002a.waitnotifyObj) {
                                 ...
                                 try {
                                     ...
                                     Threadgetvalue002a.waitnotifyObj.wait();
...
class Threadgetvalue002a extends NamedTask {

    public Threadgetvalue002a(String threadName) {
        super(threadName);
    }
    ...
    public static final int breakpointLineNumber2 = 9;
