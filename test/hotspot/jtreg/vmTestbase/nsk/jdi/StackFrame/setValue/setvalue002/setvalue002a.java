...
public class setvalue002a {
    ...
    //------------------------------------------------------  section tested
                ...
                case 0:
                         ...
                         label:
                         synchronized (Threadsetvalue002a.lockingObject) {
                             synchronized (Threadsetvalue002a.waitnotifyObj) {
                                 ...
                                 try {
                                     ...
                                     Threadsetvalue002a.waitnotifyObj.wait();
...
class Threadsetvalue002a extends NamedTask {
    ...
    public void runt1() {
        ...
        Thread locThread = setvalue002a.test_thread;
