   ...
   //----------------------------------------------------   main method
    ...
    //------------------------------------------------------  section tested
                ...
                case 0:
                         ...
                         label:
                         synchronized (Threadsetvalue001a.lockingObject) {
                             synchronized (Threadsetvalue001a.waitnotifyObj) {
                                 ...
                                 try {
                                     ...
                                     Threadsetvalue001a.waitnotifyObj.wait();
...
class Threadsetvalue001a extends NamedTask {

    public Threadsetvalue001a(String threadName) {
        super(threadName);
    }
    ...
    public void runt1() {
        ...
        log("1    : db2 = " + db2 + "  " + Double.doubleToRawLongBits(db2) );
        log("method 'runt1' enter");
        log("method 'runt1' body");
        log("2    : db1 = " + db1 + "  " + Double.doubleToRawLongBits(db1) );
