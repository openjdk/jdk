...
/**
 * This class is used as debuggee application for the visiblevarbyname002 JDI test.
 */

public class visiblevarbyname002a {
    ...
    //------------------------------------------------------  section tested
                ...
                case 0:
                         ...
                         label:
                         synchronized (Threadvisiblevarbyname002a.lockingObject) {
                             synchronized (Threadvisiblevarbyname002a.waitnotifyObj) {
                                 ...
                                 try {
                                     ...
                                     Threadvisiblevarbyname002a.waitnotifyObj.wait();
...
//    public static final int breakpointLineNumber3 = 7;
    ...
    static void log(String str) {
        visiblevarbyname002a.log2("thread2: " + str);
    }
