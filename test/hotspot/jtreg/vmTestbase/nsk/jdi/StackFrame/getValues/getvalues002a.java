...
/**
 * This class is used as debuggee application for the getvalues002 JDI test.
 */
...
public class getvalues002a {
    ...
    //------------------------------------------------------  section tested
                ...
                case 0:
                         ...
                         label:
                         synchronized (Threadgetvalues002a.lockingObject) {
                             synchronized (Threadgetvalues002a.waitnotifyObj) {
                                 ...
                                 try {
                                     ...
                                     Threadgetvalues002a.waitnotifyObj.wait();
...
class Threadgetvalues002a extends NamedTask {

    public Threadgetvalues002a(String threadName) {
        super(threadName);
    }
...
//    public static final int breakpointLineNumber3 = 7;
    ...
    void log(String str) {
        getvalues002a.log2("thread2: " + str);
    }
}
