...
/**
 * This class is used as debuggee application for the issuspended003 JDI test.
 */

public class issuspended003a {
    ...
    //------------------------------------------------------  section tested
                ...
                case 0:
                         ...
                         label:
                         synchronized (Threadissuspended003a.lockingObject) {
                             synchronized (Threadissuspended003a.waitnotifyObj) {
                                 ...
                                 try {
                                     ...
                                     Threadissuspended003a.waitnotifyObj.wait();
...
class Threadissuspended003a extends NamedTask {

    public Threadissuspended003a(String threadName) {
        super(threadName);
    }
    ...
    void log(String str) {
        issuspended003a.log2("thread2: " + str);
    }
}
