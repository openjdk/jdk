...
/**
 * This class is used as debuggee application for the frames_ii001 JDI test.
 */

public class frames_ii001a {
    ...
    //------------------------------------------------------  section tested
                ...
                case 0:
                         ...
                         label:
                         synchronized (Threadframes_ii001a.lockingObject) {
                             synchronized (Threadframes_ii001a.waitnotifyObj) {
                                 ...
                                 try {
                                     ...
                                     Threadframes_ii001a.waitnotifyObj.wait();
...
class Threadframes_ii001a extends NamedTask {
    ...
    public static final int breakpointLineNumber0 = 9;
    ...
    void log(String str) {
        frames_ii001a.log2("thread2: " + str);
    }
