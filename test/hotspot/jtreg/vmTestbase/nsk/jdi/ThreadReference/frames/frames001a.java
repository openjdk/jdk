...
/**
 * This class is used as debuggee application for the frames001 JDI test.
 */
...
public class frames001a {
    ...
    //------------------------------------------------------  section tested
                ...
                case 0:
                         ...
                         label:
                         synchronized (Threadframes001a.lockingObject) {
                             synchronized (Threadframes001a.waitnotifyObj) {
                                 ...
                                 try {
                                     ...
                                     Threadframes001a.waitnotifyObj.wait();
...
class Threadframes001a extends Thread {

    public Threadframes001a(String threadName) {
        super(threadName);
    }
