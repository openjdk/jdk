 ...
 * <code>com.sun.jdi.ExceptionRequest.addClassFilter(String)</code> <BR>
 ...
 * - The debuggee creates a TestClass10 object, to use as filter,       <BR>
 ...
 *   - creates an ExceptionRequest and enables it,                      <BR>
...
public class filter_s002 {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new filter_s002().runThis(argv, out);
            ...
            switch (i) {
              ...
              case 0:
                     ...
                     try {
                         ...
                         ((ExceptionRequest)eventRequest1).addClassFilter(testedClassName1);
