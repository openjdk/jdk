 ...
 *   - sets up an ExceptionRequest within the method
 *     in the class TestClass which will be calling by both threads,
 *   - restricts the exception event only for thread1,
...
public class threadfilter001 extends TestDebuggerType1 {
    ...
    public static int run (String argv[], PrintStream out) {
        debuggeeName = "nsk.jdi.ExceptionRequest.addThreadFilter.threadfilter001a";
        return new threadfilter001().runThis(argv, out);
    }

    private String testedClassName =
      "nsk.jdi.ExceptionRequest.addThreadFilter.threadfilter001aTestClass";
        ...
        for (int i = 0; ; i++) {
            ...
            switch (i) {
                ...
                eventRequest1 = setting2ExceptionRequest (thread1,
                                       testClassReference,
                                       EventRequest.SUSPEND_ALL, "ExceptionRequest1");
