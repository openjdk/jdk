...
package nsk.jdi.EventRequestManager.createMethodExitRequest;
 ...
 * <code>com.sun.jdi.EventRequestManager.createMethodExitRequest()</code> <BR>
 * complies with its spec.                                      <BR>
 * <BR>
 * The test checks up on the following assertion:               <BR>
 *  - Creates a new disabled MethodExitRequest.                 <BR>
 * <BR>
...
public class mexreg001 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new mexreg001().runThis(argv, out);
    ...
    */
    ...
    //------------------------------------------------------  testing section
        ...
        MethodExitRequest mexRequest1 = null;
        ...
        for (int i = 0; ; i++) {
            ...
            log2("......creating: mexRequest1 = eventRManager.createMethodExitRequest();");
            mexRequest1 = eventRManager.createMethodExitRequest();
            log2("      checking up on if request is disabled");
            if (mexRequest1.isEnabled()) {
                testExitCode = FAILED;
