 ...
 * <code>com.sun.jdi.EventRequestManager.methodEntryRequests()</code> <BR>
 * complies with its spec.                                      <BR>
 * <BR>
 * The test checks up on the following assertion:                       <BR>
 * - The list is unmodifiable.                                          <BR>
 * - The list of the enabled and disabled method entry requests.        <BR>
...
public class methentreq002 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new methentreq002().runThis(argv, out);
    ...
    */
    ...
    //------------------------------------------------------  testing section
        ...
        MethodEntryRequest meRequests[] = { null, null, null, null, null,
        ...
        for (int i = 0; ; i++) {
            ...
            log2("......creating MethodEntryRequests");
            for (int i1 = 0; i1 < meRequests.length; i1++) {
                meRequests[i1] = eventRManager.createMethodEntryRequest();
                meRequests[i1].putProperty("number", String.valueOf(i1));

                log2("......checking up on returned List after creating new MethodEntryRequest");
                requests = eventRManager.methodEntryRequests();
                ...
                while (li.hasNext()) {
                    request = (MethodEntryRequest) li.next();
                ...
                log2("      enabling created MethodEntryRequest");
            ...
            log2("......deleting MethodEntryRequests");
