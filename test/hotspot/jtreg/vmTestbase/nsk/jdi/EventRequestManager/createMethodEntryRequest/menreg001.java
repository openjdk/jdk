 ...
 * <code>com.sun.jdi.EventRequestManager.createMethodEntryRequest()</code> <BR>
 * complies with its spec.                                      <BR>
 * <BR>
 * The test checks up on the following assertion:               <BR>
 *  - Creates a new disabled MethodEntryRequest.                <BR>
 * <BR>
...
public class menreg001 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new menreg001().runThis(argv, out);
    ...
    */
    ...
    //------------------------------------------------------  testing section
        ...
        for (int i = 0; ; i++) {
            ...
            log2("......creating: menRequest1 = eventRManager.createMethodEntryRequest();");
            menRequest1 = eventRManager.createMethodEntryRequest();
            log2("      checking up on if request is disabled");
            if (menRequest1.isEnabled()) {
                testExitCode = FAILED;
