...
public class equals003a {
    public static void main (String argv[]) {
        ...
        SameClass1 sc1 = new SameClass1();
        SameClass2 sc2 = new SameClass2();
        OverridenClass rc = new OverridenClass();
...
class SameClass1 extends MainClass {
    // All fields are the same as in MainClass
}

class SameClass2 extends MainClass {
    // All fields are the same as in MainClass
}

class OverridenClass extends MainClass {
    // All fields are redefined
