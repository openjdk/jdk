 ...
 * <code>com.sun.jdi.PrimitiveValue.longValue()</code>          <BR>
 ...
 *                                                      <BR>
 *      pvbl1.longValue() == 1                          <BR>
 *      pvbl0.longValue() == 0                          <BR>
 *      pvbt1.longValue() == (long) Byte.MAX_VALUE      <BR>
 *      pvbt0.longValue() == 0                          <BR>
 *      pvch1.longValue() == (long) Character.MAX_VALUE <BR>
 *      pvch0.longValue() == 0                          <BR>
 *<BR>
 *<BR>
 *      pvfl1.longValue() == (long) Float.MAX_VALUE     <BR>
 *      pvfl0.longValue() == 0                          <BR>
 *      pvin1.longValue() == (long) Integer.MAX_VALUE   <BR>
 *      pvin0.longValue() == 0                          <BR>
 *      pvln1.longValue() == Long.MAX_VALUE     <BR>
 *      pvln0.longValue() == 0                          <BR>
 *      pvsh1.longValue() == (long) Short.MAX_VALUE     <BR>
 *      pvsh0.longValue() == 0                          <BR>
 * <BR>
 */

public class longvalue001 {
    ...
    public static int run (String argv[], PrintStream out) {
        return new longvalue001().runThis(argv, out);
    }
    ...
    private int runThis (String argv[], PrintStream out) {
        ...
        log2("longvalue001a debuggee launched");
        debuggee.resume();
    ...
    //------------------------------------------------------  testing section
        ...
        for (int i = 0; ; i++) {
            ...
            for (i2 = 0; ; i2++) {
                ...
                case 0:
                        log2("......checks for: pvbl1.longValue() == 1  and  pvbl0.longValue() == 0");
                        if (pvbl1.longValue() != 1 || pvbl0.longValue() != 0) {
                            log3("ERROR: pvbl1.longValue() != 1 || pvbl0.longValue() != 0");
                            expresult = 1;
                        }
                        break;

                case 1:
                        log2("......checks for: pvbt1.longValue() == (long) Byte.MAX_VALUE  and  pvbt0.longValue() == 0");
                        if (pvbt1.longValue() != (long) Byte.MAX_VALUE || pvbt0.longValue() != 0) {
                            log3("ERROR: pvbt1.longValue() != (long) Byte.MAX_VALUE || pvbt0.longValue() != 0");
                            expresult = 1;
                        }
                        break;

                case 2:
                        log2("......checks for: pvch1.longValue() == (long) Character.MAX_VALUE  and  pvch0.longValue() == 0");
                        if (pvch1.longValue() != (long) Character.MAX_VALUE || pvch0.longValue() != 0) {
                            log3("ERROR: pvch1.longValue() != (long) Character.MAX_VALUE || pvch0.longValue() != 0");
                            expresult = 1;
                        }
                        break;
                ...
                case 4:
                        log2("......checks for: pvfl1.longValue() == (long) Float.MAX_VALUE  and  pvfl0.longValue() ==0");
                        if (pvfl1.longValue() != (long) Float.MAX_VALUE || pvfl0.longValue() !=0 ) {
                            log3("ERROR: pvfl1.longValue() != (long) Float.MAX_VALUE || pvfl0.longValue() !=0");
                            expresult = 1;
                        }
                        break;

                case 5:
                        log2("......checks for: pvin1.longValue() == (long) Integer.MAX_VALUE  and  pvin0.longValue() == 0");
                        if (pvin1.longValue() != (long) Integer.MAX_VALUE || pvin0.longValue() != 0) {
                            log3("ERROR: pvin1.longValue() != (long) Integer.MAX_VALUE || pvin0.longValue() != 0");
                            expresult = 1;
                        }
                        break;

                case 6:
                        log2("......checks for: pvln1.longValue() == Long.MAX_VALUE  and  pvln0.longValue() == 0");
                        if (pvln1.longValue() != Long.MAX_VALUE || pvln0.longValue() != 0) {
                            log3("ERROR: pvln1.longValue() != Long.MAX_VALUE || pvln0.longValue() != 0");
                            expresult = 1;
                        }
                        break;

                case 7:
                        log2("......checks for: pvsh1.longValue() == (long) Short.MAX_VALUE  and  pvsh0.longValue() == 0");
                        if (pvsh1.longValue() != (long) Short.MAX_VALUE || pvsh0.longValue() != 0) {
                            log3("ERROR: pvsh1.longValue() != (long) Short.MAX_VALUE || pvsh0.longValue() != 0");
                            expresult = 1;
                        }
                        break;
