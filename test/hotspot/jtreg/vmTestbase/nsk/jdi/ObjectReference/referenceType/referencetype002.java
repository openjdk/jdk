 ...
 * complies with its spec when ObjectReference is StringReference.<BR>
 * <BR>
...
public class referencetype002 {
    ...
    public static int run (String argv[], PrintStream out) {
        return new referencetype002().runThis(argv, out);
    }
    ...
    private String testedClassName = "java.lang.String";
    ...
    //------------------------------------------------------  testing section
        ...
        for (int i = 0; ; i++) {
            ...
            if (!testedClass1.equals(testedClass)) {
                ...
                log3("ERROR: ReferenceType testedClass is of the type : " + testedClass);
                log3("ERROR: performing statement: !str.referenceType().equals(testedClass)");
