...
public class referencetype007 {
    ...
    public static int run (String argv[], PrintStream out) {
        return new referencetype007().runThis(argv, out);
    }
    ...
    private String testedClassName = "boolean[][]";
    ...
    //------------------------------------------------------  testing section
        ...
        for (int i = 0; ; i++) {
            ...
            List listOftestedClasses = vm.classesByName(mName + ".referencetype007aTestClass");
