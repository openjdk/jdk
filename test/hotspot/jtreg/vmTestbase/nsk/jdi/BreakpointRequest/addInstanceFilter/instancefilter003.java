 ...
 * <code>com.sun.jdi.BreakpointRequest.addInstanceFilter()</code><BR>
 * complies with its spec.                                      <BR>
 * <BR>
 * The test checks up on the following assertion:               <BR>
 *   Throws: UnsupportedOperationException - if the target      <BR>
 *           virtual machine does not support this operation.   <BR>
 * <BR>
 ...
 *   a BreakpointRequest and if addInstanceFilter() is not supported,   <BR>
 *   invokes the method on the request expecting                        <BR>
...
public class instancefilter003 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new instancefilter003().runThis(argv, out);
