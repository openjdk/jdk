...
public class decltype005 {
    ...
    private final static String className = "decltype005";
    private final static String debugerName = prefix + className;
    private final static String debugeeName = debugerName + "a";
    private final static String mainClassName = prefix + "decltype005aMainClass";
    private final static String sameClassName = prefix + "decltype005aSameClass";
    private final static String mainInterName = prefix + "decltype005aMainInter";
    ...
    public static int run(String argv[], PrintStream out) {
        ...
        for (int i = 0; i < METHOD_NAME_CLASS.length; i++) {
            ...
            try {
                listOfMethods = sameClass.methodsByName(METHOD_NAME_CLASS[i]);
            } catch (Exception e) {
        ...
        // Check all methods from SameInter
        ...
        for (int i = 0; i < METHOD_NAME_INTER.length; i++) {
            ...
            try {
                listOfMethods = sameInter.methodsByName(METHOD_NAME_INTER[i]);
            } catch (Exception e) {
