...
public class isstatic003 {
    private static Log log;
    private final static String prefix = "nsk.jdi.TypeComponent.isStatic.";
    private final static String className = "isstatic003";
        ...
        for (int i = 0; methodsIterator.hasNext(); i++) {
            ...
            if (method.isConstructor() || method.isStaticInitializer()) {
                try {
                    ...
                    log.complain("debuger FAILURE 1> Cannot get isStatic from "
                               + "method " + name + " in " + decTypeName);
                    testFailed = true;
                    continue;
                }
                log.display("debuger> " + i + " method (" + name + "), "
                          + "isStatic = " + isStatic + " read in "
                          + decTypeName);
            }
        }
