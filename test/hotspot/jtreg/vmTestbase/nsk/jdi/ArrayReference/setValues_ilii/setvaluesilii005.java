...
public class setvaluesilii005 {
    ...
    private final static String className = "setvaluesilii005";
        ...
        for (int i = 0; i < FIELD_NAME.length; i++) {
            ...
            try {
                ...
                log.complain("debuger FAILURE 5> " + i + " field: list of "
                           ...
                           + (listToSet.size() + 1) + " set from index 1.");
                testFailed = true;
            } catch (ObjectCollectedException e) {
