 ...
 * <code>com.sun.jdi.ByteValue.value()</code>                   <BR>
 * complies with its spec.                                       <BR>
 * <BR>
 * The cases for testing are as follows :               <BR>
 *                                                      <BR>
 * when a gebuggee executes the following :             <BR>
 *      public static byte smallest =  Byte.MIN_VALUE;  <BR>
 *      public static byte zero     =  0;               <BR>
 *      public static byte largest  =  Byte.MAX_VALUE;  <BR>
 *                                                      <BR>
 * which a debugger mirros as :                         <BR>
 *                                                      <BR>
 *      ByteValue bvsmallest;                           <BR>
 *      ByteValue bvzero;                               <BR>
 *      ByteValue bvlargest;                            <BR>
 *                                                      <BR>
 * the following is true:                               <BR>
 *                                                      <BR>
 *      bvsmallest.value() == Byte.MIN_VALUE            <BR>
 *      bvzero.value()     == 0                         <BR>
 *      bvlargest.value()  == Byte.MAX_VALUE            <BR>
 * <BR>
 */
...
public class value001 {
    ...
    //------------------------------------------------------  testing section
        ...
        for (int i = 0; ; i++) {
            ...
            Field fbsmallest = execClass.fieldByName("smallest");
            Field fbzero     = execClass.fieldByName("zero");
            Field fblargest  = execClass.fieldByName("largest");

            ByteValue bvsmallest = (ByteValue) execClass.getValue(fbsmallest);
            ByteValue bvzero     = (ByteValue) execClass.getValue(fbzero);
            ByteValue bvlargest  = (ByteValue) execClass.getValue(fblargest);
            ...
            for (i2 = 0; ; i2++) {
                ...
                case 0: if (bvsmallest.value() != Byte.MIN_VALUE)
                            expresult = 1;
                        break;

                case 1: if (bvzero.value() != 0)
                            expresult = 1;
                        break;
