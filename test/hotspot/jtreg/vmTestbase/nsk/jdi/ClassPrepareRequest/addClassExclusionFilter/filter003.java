 ...
 * ClassPrepareRequest.                                         <BR>
 *                                                              <BR>
 * The test checks that results of the method                           <BR>
 * <code>com.sun.jdi.ClassPrepareRequest.addClassExclusionFilter()</code> <BR>
...
public class filter003 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new filter003().runThis(argv, out);
            ...
            switch (i) {
              ...
              case 0:
                     ...
                     try {
                         ...
                         ((ClassPrepareRequest)eventRequest1).addClassFilter(testedClassName1);
