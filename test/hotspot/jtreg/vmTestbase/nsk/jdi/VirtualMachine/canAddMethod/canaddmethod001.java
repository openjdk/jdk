...
package nsk.jdi.VirtualMachine.canAddMethod;
 ...
 * <code>com.sun.jdi.VirtualMachine.canAddMethod()</code>       <BR>
...
public class canaddmethod001 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new canaddmethod001().runThis(argv, out);
    ...
    */
    ...
    //------------------------------------------------------  testing section
        ...
        for (int i = 0; ; i++) {
            ...
            log2("...... vm.canAddMethod()");
            if ( vm.canAddMethod() )
                log2("      vm.canAddMethod() == true");
            else
                log2("      vm.canAddMethod() == false");
