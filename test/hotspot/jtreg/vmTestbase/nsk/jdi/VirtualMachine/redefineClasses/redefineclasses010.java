 ...
 *    attempting to delete constructor will throw
 *    <code>UnsupportedOperationException</code> exception"
 *
 * The test consists of the following files:                                    <br>
 *     <code>redefineclasses010.java</code>             - debugger              <br>
 *     <code>redefineclasses010a.java</code>            - initial debuggee      <br>
 *     <code>newclassXX/redefineclasses010a.java</code> - redefining debuggees  <br>
 *
 * This test performs the following cases:                                <br>
 *    1.newclass01 - deleting <public> constructor                        <br>
 *    2.newclass02 - deleting <protected> constructor                     <br>
 *    3.newclass03 - deleting <private> constructor                       <br>
 *    4.newclass04 - deleting <private package> constructor               <br>
...
public class redefineclasses010 {
    ...
    private final static String debuggerName = prefix + "redefineclasses010";
    private final static String debugeeName = debuggerName + "a";

    private final static String[][] subDirs = {
            {"newclass01","deleting <public> constructor"},
            {"newclass02","deleting <protected> constructor"},
            {"newclass03","deleting <private> constructor"},
            {"newclass04","deleting <private package> constructor"}
    };

    private final static String newClassFile = File.separator
                    + prefix.replace('.',File.separatorChar)
                    + "redefineclasses010a.class";
    ...
    public static int run(String argv[], PrintStream out) {
        ...
        redefineclasses010 thisTest = new redefineclasses010();
    ...
    private void execTest() throws TestBug {
        ...
        BreakpointRequest brkp = debugee.setBreakpoint(testedClass,
                                                    redefineclasses010a.brkpMethodName,
                                                    redefineclasses010a.brkpLineNumber);
        debugee.resume();
        debugee.sendSignal("continue");
