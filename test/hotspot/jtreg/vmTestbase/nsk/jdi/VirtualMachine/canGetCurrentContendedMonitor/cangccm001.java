 ...
 * <code>com.sun.jdi.VirtualMachine.canGetCurrentContendedMonitor()</code> <BR>
 ...
 * the method    VirtualMachine.canGetCurrentContendedMonitor()         <BR>
 *                                                                      <BR>
 * Then if the value is true the debugger checks up that call to        <BR>
 * the method mainThread.currentContendedMonitor() doesn't throw        <BR>
 *    UnsupportedOperationException.                                    <BR>
 * If the value is false the debugger checks up that call to the        <BR>
 * the method mainThread.currentContendedMonitor() does throw           <BR>
 *    UnsupportedOperationException.                                    <BR>
 */

public class cangccm001 {
    ...
    public static int run (String argv[], PrintStream out) {
        return new cangccm001().runThis(argv, out);
    }
    ...
    private String testedClassName =
        "nsk.jdi.VirtualMachine.canGetCurrentContendedMonitor.Threadcangccm001a";

    //String mName = "nsk.jdi.VirtualMachine.canGetCurrentContendedMonitor";
        ...
        for (int i = 0; ; i++) {
            ...
            label1: {
                ...
                if (vm.canGetCurrentContendedMonitor()) {
                    ...
                    log2(".......vm.canGetCurrentContendedMonitor() == false");
