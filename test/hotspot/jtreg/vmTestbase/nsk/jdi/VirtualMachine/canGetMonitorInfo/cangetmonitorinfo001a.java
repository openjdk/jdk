...
public class cangetmonitorinfo001a {
                ...
                case 0:
                     ...
                     label: {
                         synchronized (Threadcangetmonitorinfo001a.lockingObject) {
                             synchronized (Threadcangetmonitorinfo001a.waitnotifyObj) {
                                 ...
                                 try {
                                     ...
                                     Threadcangetmonitorinfo001a.waitnotifyObj.wait();
...
class Threadcangetmonitorinfo001a extends NamedTask {
