 ...
 * <code>com.sun.jdi.MethodExitRequest.addThreadFilter()</code> <BR>
 ...
 *   - creates MethodExitRequest1 and                                   <BR>
 *     invokes the method addThreadFilter(tread1) on the request1,      <BR>
 *   - creates MethodExitRequest2,                                      <BR>
 *     resumes the debuggee to get the thread1 started, and             <BR>
 *     invokes the method addThreadFilter(thread) on the request2,      <BR>
 *   - creates MethodExitRequest3, waits the thread1 to die, and        <BR>
...
public class threadfilter003 extends JDIBase {
    ...
    private String testedClassName =
      "nsk.jdi.MethodExitRequest.addThreadFilter.threadfilter003aTestClass";
    ...
    */
    ...
    //------------------------------------------------------  testing section
        ...
        String property3 = "MethodExitRequest3";
        ...
        for (int i = 0; ; i++) {
            ...
            switch (i) {
              case 0:
                     ...
                     eventRequest1 = setting2MethodExitRequest (null,
                                             testClassReference,
              ...
              case 1:
                     eventRequest2 = setting2MethodExitRequest (null,
                                             testClassReference,
                     ...
                     try {
                         ...
                         log2("        no Exception expected");
                         ((MethodExitRequest)eventRequest2).addThreadFilter(thread1);
                     } catch ( Exception e ) {
                         log3("ERROR: Exception : " + e);
                         testExitCode = FAILED;
                     }
              ...
              case 2:
                     eventRequest3 = setting2MethodExitRequest (null,
                                             testClassReference,
                     ...
                     try {
                         ...
                         log2("        no Exception expected");
                         ((MethodExitRequest)eventRequest3).addThreadFilter(thread1);
                     } catch ( Exception e ) {
                         log3("ERROR: Exception : " + e);
                         testExitCode = FAILED;
                     }
