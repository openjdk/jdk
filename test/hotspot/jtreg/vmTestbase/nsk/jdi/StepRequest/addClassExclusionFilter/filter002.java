 ...
 * <code>com.sun.jdi.StepRequest.addClassExclusionFilter()</code> <BR>
 ...
 *   - creates an StepRequest and enables it,                           <BR>
...
public class filter002 {
    ...
    private String testedClassName1 =
      "nsk.jdi.StepRequest.addClassExclusionFilter.TestClass10";
    ...
    //------------------------------------------------------  testing section
        ...
        for (int i = 0; ; i++) {
            ...
            switch (i) {
              ...
              case 0:
                     ThreadReference thread1 = threadByName("main");
                     ...
                     try {
                         log2("......eventRequest1.addClassExclusionFilter(testedClassName1);");
                         log2("        InvalidRequestStateException expected");
                         ((StepRequest)eventRequest1).addClassExclusionFilter(testedClassName1);
...
//            log2("       eventIterator = eventSet.eventIterator;");
    ...
    private void breakpointForCommunication()
        ...
        log3("Didn't get expected BreakpointEvent, events are:");
        while(true) {
            log3("    event = " + evt);
            if (!eventIterator.hasNext()) {
                break;
            }
            evt = eventIterator.nextEvent();
        }
