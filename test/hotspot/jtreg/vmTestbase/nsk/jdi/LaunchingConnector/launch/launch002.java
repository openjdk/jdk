...
public class launch002 {
    ...
    public static int run (String args[], PrintStream out) {
        return new launch002(args,out).run();
    }

    private launch002 (String args[], PrintStream out) {
        this.out  = out;
...
//                a.setValue(argHandler.getLaunchOptions() + " -showversion");
     ...
     * connector found supported by the tested JDI implementation. Print
     * caution and also return <code>null</code>, if there is more than one
     * launching connector of such kind.
     */
