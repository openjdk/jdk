...
public class launch003 {
    ...
    public static int run(String args[], PrintStream out) {
        return new launch003(args,out).run();
    }

    private launch003(String args[], PrintStream out) {
        this.out  = out;
...
// on this platform
    ...
    private Map<String,? extends com.sun.jdi.connect.Connector.Argument> setupConnectorArguments(
        LaunchingConnector lc, String host, String port) {

        String java = argHandler.getLaunchExecPath()
                          + " " + argHandler.getLaunchOptions();
        Map<String,? extends com.sun.jdi.connect.Connector.Argument> carg = lc.defaultArguments();
