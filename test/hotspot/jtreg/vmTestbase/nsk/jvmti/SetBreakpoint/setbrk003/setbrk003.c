...
#ifdef STATIC_BUILD
JNIEXPORT jint JNICALL Agent_OnLoad_setbrk003(JavaVM *jvm, char *options, void *reserved) {
    return Agent_Initialize(jvm, options, reserved);
}
JNIEXPORT jint JNICALL Agent_OnAttach_setbrk003(JavaVM *jvm, char *options, void *reserved) {
    return Agent_Initialize(jvm, options, reserved);
}
JNIEXPORT jint JNI_OnLoad_setbrk003(JavaVM *jvm, char *options, void *reserved) {
...
Java_nsk_jvmti_SetBreakpoint_setbrk003_check(JNIEnv *env, jclass cls) {
    jvmtiError err;
    jmethodID mid;
