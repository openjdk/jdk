 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jvmti/GetImplementedInterfaces/getintrf006.
 * VM Testbase keywords: [quick, jpda, jvmti, noras]
 * VM Testbase readme:
 * DESCRIPTION
 *     The test exercises JVMTI function
 *         GetImplementedInterfaces(clazz, interfaceCountPtr, interfacesPtr).
 *     The test checks if the function returns empty interface list
