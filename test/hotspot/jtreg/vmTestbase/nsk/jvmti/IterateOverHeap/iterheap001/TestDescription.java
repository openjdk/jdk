 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jvmti/IterateOverHeap/iterheap001.
 * VM Testbase keywords: [quick, jpda, jvmti, noras]
 * VM Testbase readme:
 * DESCRIPTION
 *     This JVMTI test exercises JVMTI heap function IterateOverHeap().
 *     This test checks that IterateOverHeap() function with
 *     JVMTI_HEAP_OBJECT_EITHER filter iterates over all tagged and untagged
 *     objects in the heap even is they are not reachable;
 ...
 *         info=[none|all|objref|stackref|heaproot|heapobj|tagged]
