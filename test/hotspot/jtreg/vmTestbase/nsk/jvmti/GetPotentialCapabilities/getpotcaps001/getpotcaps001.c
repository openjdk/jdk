...
/**
 * Check potentially available capabilities.
...
#ifdef STATIC_BUILD
JNIEXPORT jint JNICALL Agent_OnLoad_getpotcaps001(JavaVM *jvm, char *options, void *reserved) {
    return Agent_Initialize(jvm, options, reserved);
}
JNIEXPORT jint JNICALL Agent_OnAttach_getpotcaps001(JavaVM *jvm, char *options, void *reserved) {
    return Agent_Initialize(jvm, options, reserved);
}
JNIEXPORT jint JNI_OnLoad_getpotcaps001(JavaVM *jvm, char *options, void *reserved) {
