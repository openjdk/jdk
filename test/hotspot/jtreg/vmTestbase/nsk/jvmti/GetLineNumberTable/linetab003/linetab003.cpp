...
#ifdef STATIC_BUILD
JNIEXPORT jint JNICALL Agent_OnLoad_linetab003(JavaVM *jvm, char *options, void *reserved) {
    return Agent_Initialize(jvm, options, reserved);
}
JNIEXPORT jint JNICALL Agent_OnAttach_linetab003(JavaVM *jvm, char *options, void *reserved) {
    return Agent_Initialize(jvm, options, reserved);
}
JNIEXPORT jint JNI_OnLoad_linetab003(JavaVM *jvm, char *options, void *reserved) {
...
Java_nsk_jvmti_GetLineNumberTable_linetab003_check(JNIEnv *env, jclass cls) {
    jvmtiError err;
    jmethodID mid;
    jint entryCount;
    ...
    if (printdump == JNI_TRUE) {
        printf(">>> source does not include line nubmers check ...\n");
    }
