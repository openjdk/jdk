 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jvmti/GetLineNumberTable/linetab002.
 * VM Testbase keywords: [quick, jpda, jvmti, noras]
 * VM Testbase readme:
 * DESCRIPTION
 *     The test exercises JVMTI function
 *         GetLineNumberTable(method, entryCountPtr, tablePtr).
 ...
 * @run main/othervm/native -agentlib:linetab002 nsk.jvmti.GetLineNumberTable.linetab002
 */
