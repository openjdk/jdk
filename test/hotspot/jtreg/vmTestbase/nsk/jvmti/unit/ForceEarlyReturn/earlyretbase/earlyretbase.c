...
Java_nsk_jvmti_unit_ForceEarlyReturn_earlyretbase_suspThread(JNIEnv *env,
    ...
    if ((err = ((*jvmti)->SuspendThread(jvmti, earlyretThr)))
                                         != JVMTI_ERROR_NONE) {
...
Java_nsk_jvmti_unit_ForceEarlyReturn_earlyretbase_resThread(JNIEnv *env,
    ...
    if ((err = ((*jvmti)->ResumeThread(jvmti, earlyretThr)))
                                        != JVMTI_ERROR_NONE) {
...
Java_nsk_jvmti_unit_ForceEarlyReturn_earlyretbase_doForceEarlyReturn(JNIEnv *env,
    ...
    err = (*jvmti)->NotifyFramePop(jvmti, earlyretThr, 0);
    ...
    if ((err = ((*jvmti)->ForceEarlyReturnLong(jvmti, earlyretThr, valToRet)))
                                                          != JVMTI_ERROR_NONE) {
