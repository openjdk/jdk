...
#ifdef STATIC_BUILD
JNIEXPORT jint JNICALL Agent_OnLoad_crrawmon001(JavaVM *jvm, char *options, void *reserved) {
    return Agent_Initialize(jvm, options, reserved);
}
JNIEXPORT jint JNICALL Agent_OnAttach_crrawmon001(JavaVM *jvm, char *options, void *reserved) {
    return Agent_Initialize(jvm, options, reserved);
}
JNIEXPORT jint JNI_OnLoad_crrawmon001(JavaVM *jvm, char *options, void *reserved) {
...
JNIEXPORT jint JNICALL Java_nsk_jvmti_CreateRawMonitor_crrawmon001_check(JNIEnv *env, jclass cls) {
    return result;
}
