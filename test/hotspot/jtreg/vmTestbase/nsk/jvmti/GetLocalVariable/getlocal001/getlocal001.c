...
void check1(jvmtiEnv *jvmti_env, jthread thr, jint depth,
    ...
    for (i = 0; i < count; i++) {
        if (strcmp(table[i].name, "l") == 0) {
            err = (*jvmti_env)->GetLocalLong(jvmti_env, thr, depth, table[i].slot, &l);
            ...
            err = (*jvmti_env)->GetLocalFloat(jvmti_env, thr, depth, table[i].slot, &f);
            if (err != JVMTI_ERROR_NONE) {
            ...
            err = (*jvmti_env)->GetLocalDouble(jvmti_env, thr, depth, table[i].slot, &d);
            if (err != JVMTI_ERROR_NONE) {
...
void check2(jvmtiEnv *jvmti_env, jthread thr, jint depth,
    ...
    for (i = 0; i < count; i++) {
        if (strcmp(table[i].name, "i1") == 0) {
            err = (*jvmti_env)->GetLocalInt(jvmti_env, thr, depth, table[i].slot, &i1);
            if (err != JVMTI_ERROR_NONE) {
            ...
            err = (*jvmti_env)->GetLocalInt(jvmti_env, thr, depth, table[i].slot, &i2);
            if (err != JVMTI_ERROR_NONE) {
            ...
            err = (*jvmti_env)->GetLocalInt(jvmti_env, thr, depth, table[i].slot, &i3);
            if (err != JVMTI_ERROR_NONE) {
            ...
            err = (*jvmti_env)->GetLocalInt(jvmti_env, thr, depth, table[i].slot, &i4);
            if (err != JVMTI_ERROR_NONE) {
            ...
            err = (*jvmti_env)->GetLocalInt(jvmti_env, thr, depth, table[i].slot, &i5);
            if (err != JVMTI_ERROR_NONE) {
...
void check3(jvmtiEnv *jvmti_env, JNIEnv *env, jthread thr, jint depth,
    ...
    for (i = 0; i < count; i++) {
        if (strcmp(table[i].name, "ob1") == 0) {
            err = (*jvmti_env)->GetLocalObject(jvmti_env, thr, depth,
                table[i].slot, &ob1);
            if (err != JVMTI_ERROR_NONE) {
            ...
            JNI_ENV_PTR(env)->GetIntArrayRegion(JNI_ENV_ARG(env, ob2),
                0, 10, arr);
        }
    }
...
void check4(jvmtiEnv *jvmti_env, jthread thr, jint depth,
    ...
    for (i = 0; i < count; i++) {
        if (strcmp(table[i].name, "i1") == 0) {
            ...
            err = (*jvmti_env)->GetLocalInt(jvmti_env, thr, depth, table[i].slot, &b);
            if (err != JVMTI_ERROR_NONE) {
