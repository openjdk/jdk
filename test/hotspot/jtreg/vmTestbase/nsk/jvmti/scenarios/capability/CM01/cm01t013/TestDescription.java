 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jvmti/scenarios/capability/CM01/cm01t013.
 * VM Testbase keywords: [quick, jpda, jvmti, noras, redefine]
 * VM Testbase readme:
 * DESCRIPTION
 *     The test is for CM01 scenario of "capability management".
 *     This test checks capability can_get_line_number
 ...
 *       with one of the new capability can_get_line_number
 ...
 *      -agentlib:cm01t013=-waittime=5
 *      nsk.jvmti.scenarios.capability.CM01.cm01t013
 */
