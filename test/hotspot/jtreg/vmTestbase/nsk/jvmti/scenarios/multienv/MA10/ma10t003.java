...
public class ma10t003 extends DebugeeClass {
    ...
    public static int run(String argv[], PrintStream out) {
        return new ma10t003().runIt(argv, out);
    }
    ...
    // tested thread
    ma10t003Thread testedThread = null;
    ...
    public int runIt(String argv[], PrintStream out) {
        ...
        testedThread = new ma10t003Thread("Debuggee Thread");
        testedThread.start();
...
class ma10t003Thread extends ThreadWrapper {
    Wicket startingBarrier = new Wicket();
    Wicket waitingBarrier = new Wicket();

    public ma10t003Thread(String name) {
        super(name);
    }
