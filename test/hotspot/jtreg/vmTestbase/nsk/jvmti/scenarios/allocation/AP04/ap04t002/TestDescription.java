 ...
 * @test
 *
 * @summary converted from VM Testbase nsk/jvmti/scenarios/allocation/AP04/ap04t002.
 ...
 *   The test class 'ap04t002' contains self-typed array field
 ...
 *   test application assignes new value to int field 'modified'
 *   in a 'while' cycle until completion of heap iteration.
 *   The test agent sets enables FieldModification event. The test
 *   fails if any FieldModification event was received during heap
 *   iteration.
 * COMMENTS
