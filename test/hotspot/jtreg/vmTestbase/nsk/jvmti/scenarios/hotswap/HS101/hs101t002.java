...
public class hs101t002 extends DebugeeClass {
    ...
    public static int run(String argv[], PrintStream out) {
        return new hs101t002().runIt(argv, out);
    }
    ...
    public int runIt(String argv[], PrintStream out) {
        ...
        thread = new hs101t002Thread("Debuggee Thread", EXPECTED.length);
...
class hs101t002Thread extends ThreadWrapper {
    ...
    public hs101t002Thread(String name, int n) {
        super(name);
        numbers = new long[n];
    }
