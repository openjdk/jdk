    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length > 0) {
            ...
            if (args[0].equals("xshare-off")) {
                ...
                ProcessBuilder pb = ProcessTools.createLimitedJavaTestProcessBuilder(offCommand);
                ...
                ProcessBuilder pb = ProcessTools.createLimitedJavaTestProcessBuilder(onCommand);
                new OutputAnalyzer(pb.start())
