...
public class MaxMetaspaceSizeEnvVarTest {
    ...
    public static void main(String... args) throws Exception {
        ...
        pb = ProcessTools.createLimitedJavaTestProcessBuilder(flag, main, max);
        ...
        for (String envVar :  envVars) {
            ...
            pb = ProcessTools.createLimitedJavaTestProcessBuilder(main, max);
        ...
        pw.println(flagRaw);
        pw.close();
        pb = ProcessTools.createLimitedJavaTestProcessBuilder(rcFileFlag, main, max);
        output = new OutputAnalyzer(pb.start());
        output.shouldHaveExitValue(0);
        output.reportDiagnosticSummary();
        report("------ end Test " + test);
