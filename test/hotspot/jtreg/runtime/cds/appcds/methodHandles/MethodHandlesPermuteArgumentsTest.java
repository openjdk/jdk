...
/*
 * @test id=aot-retrain
 * @summary Run the MethodHandlesPermuteArgumentsTest.java test in CDSAppTester::AOT-Retrain workflow.
 * @requires vm.cds & vm.compMode != "Xcomp"
 * @requires vm.cds.supports.aot.class.linking
 * @comment work around JDK-8345635
 * @comment Some of the tests run excessively slowly with -Xcomp. The original
 ...
 *        ../../../../../../jdk/java/lang/invoke/remote/RemoteExample.java
 *        ../../../../../../jdk/java/lang/invoke/common/test/java/lang/invoke/lib/CodeCacheOverflowProcessor.java
 * @run junit/othervm/timeout=480 -Dcds.app.tester.workflow=AOT-Retrain MethodHandlesPermuteArgumentsTest
 */
/*
 * @test id=aot-retrain2
 * @summary Run the MethodHandlesPermuteArgumentsTest.java test in CDSAppTester::AOT-Retrain2 workflow.
 * @requires vm.cds & vm.compMode != "Xcomp"
 * @requires vm.cds.supports.aot.class.linking
 * @comment work around JDK-8345635
 * @comment Some of the tests run excessively slowly with -Xcomp. The original
 ...
 *        ../../../../../../jdk/java/lang/invoke/remote/RemoteExample.java
 *        ../../../../../../jdk/java/lang/invoke/common/test/java/lang/invoke/lib/CodeCacheOverflowProcessor.java
 * @run junit/othervm/timeout=480 -Dcds.app.tester.workflow=AOT-Retrain2 MethodHandlesPermuteArgumentsTest
 */
/*
 * @test id=dynamic
