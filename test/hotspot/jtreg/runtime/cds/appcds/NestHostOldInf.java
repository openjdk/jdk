...
public class NestHostOldInf {
    ...
    public static void main(String[] args) throws Exception {
        ...
        TestCommon.checkExecReturn(output, 0,
                                   true,
                                   "Excluding old class OldInf: has been regenerated", "OldInf ** generated");
        ...
        TestCommon.run(
          ...
          .assertNormalExit(out -> {
              out.shouldNotContain("Verifying class OldInf with old format")
                 .shouldNotContain("Verifying class ChildOldInf with new format")
              ...
              if (!dynamicMode) {
                  ...
                  out.shouldContain("OldInf source: shared objects file (top)")
                     .shouldContain("ChildOldInf source: shared objects file (top)");
              }
          });
    }
}
