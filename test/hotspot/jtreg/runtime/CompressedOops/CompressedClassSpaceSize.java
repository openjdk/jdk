...
public class CompressedClassSpaceSize {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Minimum size is 1MB
        pb = ProcessTools.createLimitedJavaTestProcessBuilder("-XX:CompressedClassSpaceSize=0",
                                                   "-version");
        ...
        pb = ProcessTools.createLimitedJavaTestProcessBuilder("-XX:CompressedClassSpaceSize=-1",
                                                   "-version");
        output = new OutputAnalyzer(pb.start());
        ...
        // Maximum size is 3GB
        pb = ProcessTools.createLimitedJavaTestProcessBuilder("-XX:CompressedClassSpaceSize=4g",
                                                   "-version");
        output = new OutputAnalyzer(pb.start());
        output.shouldContain("outside the allowed range")
              .shouldHaveExitValue(1);
        ...
        pb = ProcessTools.createLimitedJavaTestProcessBuilder("-XX:+UnlockDiagnosticVMOptions",
        ...
        pb = ProcessTools.createLimitedJavaTestProcessBuilder("-XX:-UseCompressedClassPointers",
                                                   "-XX:CompressedClassSpaceSize=1m",
                                                   "-version");
        output = new OutputAnalyzer(pb.start());
