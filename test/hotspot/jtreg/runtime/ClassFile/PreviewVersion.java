...
public class PreviewVersion {
    ...
    public static void main(String args[]) throws Throwable {
        ...
        pb = ProcessTools.createLimitedJavaTestProcessBuilder("--enable-preview",
            "-cp", "." + File.pathSeparator + System.getProperty("test.classes"), "PVTest");
        ...
        pb = ProcessTools.createLimitedJavaTestProcessBuilder("--enable-preview", "-Xlog:class+preview",
            "-cp", "." + File.pathSeparator + System.getProperty("test.classes"), "PVTest");
        oa = new OutputAnalyzer(pb.start());
