...
public class ClassResolutionTest {
    ...
    public static void main(String... args) throws Exception {
        ...
        ProcessBuilder pb = ProcessTools.createLimitedJavaTestProcessBuilder("-Xlog:class+resolve=debug",
        ...
        pb = ProcessTools.createLimitedJavaTestProcessBuilder("-Xlog:class+resolve=debug",
