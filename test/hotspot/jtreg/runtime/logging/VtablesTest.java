...
public class VtablesTest {
    public static void main(String[] args) throws Exception {
        ProcessBuilder pb = ProcessTools.createLimitedJavaTestProcessBuilder("-Xlog:vtables=trace", "ClassB");
        ...
        pb = ProcessTools.createLimitedJavaTestProcessBuilder("-Xlog:vtables=trace", "p1/C");
