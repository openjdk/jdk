...
public class ProtectionDomainVerificationTest {
    ...
    public static void main(String... args) throws Exception {
        ...
        ProcessBuilder pb = ProcessTools.createLimitedJavaTestProcessBuilder("-Xlog:protectiondomain=trace",
                                                                  "-Xmx128m",
        ...
        pb = ProcessTools.createLimitedJavaTestProcessBuilder("-Xlog:protectiondomain=debug",
                                                                  "-Xmx128m",
                                                                  "-Djava.security.manager=allow",
                                                                  Hello.class.getName(), "security_manager");
        new OutputAnalyzer(pb.start())
        ...
        // -Xlog:protectiondomain=debug
        pb = ProcessTools.createLimitedJavaTestProcessBuilder("-Xlog:protectiondomain=trace",
                                                   "-Xmx128m",
