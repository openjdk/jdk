...
public class CondyIndyTest {
    public static void main(String... args) throws Exception {
        ...
        ProcessBuilder pb = ProcessTools.createLimitedJavaTestProcessBuilder("-Xlog:methodhandles",
                                                                  "CondyIndy");
        ...
        pb = ProcessTools.createLimitedJavaTestProcessBuilder("-Xlog:methodhandles+condy=debug",
                                                   "CondyIndy");
        ...
        pb = ProcessTools.createLimitedJavaTestProcessBuilder("-Xlog:methodhandles+indy=debug",
                                                   "CondyIndy");
        o = new OutputAnalyzer(pb.start());
        o.shouldHaveExitValue(0);
        o.shouldNotContain("[info ][methodhandles");
        ...
        pb = ProcessTools.createLimitedJavaTestProcessBuilder("-Xlog:methodhandles=info",
