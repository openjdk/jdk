...
public class ItablesTest {
    public static void main(String[] args) throws Exception {
        ProcessBuilder pb = ProcessTools.createLimitedJavaTestProcessBuilder("-Xlog:itables=trace", "ClassB");
        ...
        pb = ProcessTools.createLimitedJavaTestProcessBuilder("-Xlog:itables=trace", "ItablesVtableTest");
