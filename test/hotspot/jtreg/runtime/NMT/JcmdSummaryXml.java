...
public class JcmdSummaryXml {
    ...
    public static void main(String args[]) throws Exception {
        ...
        File tmpFile = File.createTempFile("nmt_summary", ".xml");
        ...
        NMTXmlUtils xmlAnalyzer = new NMTXmlUtils(tmpFile);
        xmlAnalyzer.shouldBeReportType("Summary");
        xmlAnalyzer.shouldExistClasses();
        xmlAnalyzer.shouldExistInstanceClasses();
        xmlAnalyzer.shouldExistArrayClasses();
    }
}
