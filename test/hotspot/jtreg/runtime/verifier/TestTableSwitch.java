...
public class TestTableSwitch {
    ...
    public static void main(String[] args) throws Exception {
        if (args.length == 1) {
           ...
           ProcessBuilder pb = ProcessTools.createJavaTestProcessBuilder("TestTableSwitch", "runTable");
           OutputAnalyzer output = new OutputAnalyzer(pb.start());
           output.shouldContain("java.lang.VerifyError: Bad instruction");
           output.shouldHaveExitValue(1);

           pb = ProcessTools.createJavaTestProcessBuilder("TestTableSwitch", "runLookup");
