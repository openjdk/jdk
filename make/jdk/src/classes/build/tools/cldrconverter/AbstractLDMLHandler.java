...
abstract class AbstractLDMLHandler<V> extends DefaultHandler {
    ...
    void pushStringListElement(String qName, Attributes attributes, int index, String key, String spaceRepl) {
        if (!pushIfIgnored(qName, attributes)) {
            currentContainer = new StringListElement(qName, currentContainer, index, key, spaceRepl);
        }
    }
